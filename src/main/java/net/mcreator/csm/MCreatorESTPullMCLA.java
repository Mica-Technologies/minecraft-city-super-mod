...
public class MCreatorESTPullMCLA extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:estpullmcla")
	public static final Block block = null;

	public MCreatorESTPullMCLA(Elementscsm instance) {
		super(instance, 315);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityestpullmcla");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:estpullmcla", "inventory"));
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("estpullmcla");
			setUnlocalizedName("estpullmcla");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.estpullmcla";
		}
