...
public class MCreatorDSLFR extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:dslfr")
	public static final Block block = null;

	public MCreatorDSLFR(Elementscsm instance) {
		super(instance, 729);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:dslfr", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("dslfr");
			setUnlocalizedName("dslfr");
