...
public class MCreatorMt13red extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:mt13red")
	public static final Block block = null;

	public MCreatorMt13red(Elementscsm instance) {
		super(instance,49);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarmASCode3.executeProcedure($_dependencies);
