...
public class MCreatorGEEL extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:geel")
	public static final Block block = null;

	public MCreatorGEEL(Elementscsm instance) {
		super(instance, 288);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:geel", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("geel");
			setUnlocalizedName("geel");
