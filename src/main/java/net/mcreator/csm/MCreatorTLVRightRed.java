...
public class MCreatorTLVRightRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvrightred")
	public static final Block block = null;

	public MCreatorTLVRightRed(Elementscsm instance) {
		super(instance, 378);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvrightred", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvrightred");
			setUnlocalizedName("tlvrightred");
