...
public class MCreatorTLVARightRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvarightred")
	public static final Block block = null;

	public MCreatorTLVARightRed(Elementscsm instance) {
		super(instance, 512);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvarightred", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvarightred");
			setUnlocalizedName("tlvarightred");
