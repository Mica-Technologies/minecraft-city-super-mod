...
public class MCreatorTLHLeftYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhleftyellow")
	public static final Block block = null;

	public MCreatorTLHLeftYellow(Elementscsm instance) {
		super(instance, 373);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhleftyellow", "inventory"));
	}
