...
public class MCreatorSigncurve15 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signcurve15")
	public static final Block block = null;

	public MCreatorSigncurve15(Elementscsm instance) {
		super(instance, 379);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signcurve15");
			setUnlocalizedName("signcurve15");
