...
public class MCreatorTLVUturnRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvuturnredflash")
	public static final Block block = null;

	public MCreatorTLVUturnRedFlash(Elementscsm instance) {
		super(instance, 445);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvuturnredflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvuturnredflash");
			setUnlocalizedName("tlvuturnredflash");
