...
public class MCreatorKiddesmoke extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:kiddesmoke")
	public static final Block block = null;

	public MCreatorKiddesmoke(Elementscsm instance) {
		super(instance,46);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorSmokeDetector.executeProcedure($_dependencies);
