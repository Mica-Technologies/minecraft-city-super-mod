...
public class MCreatorTL4VFLAY extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vflay")
	public static final Block block = null;

	public MCreatorTL4VFLAY(Elementscsm instance) {
		super(instance, 755);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vflay", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vflay");
			setUnlocalizedName("tl4vflay");
