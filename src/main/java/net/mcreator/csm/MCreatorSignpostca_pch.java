...
public class MCreatorSignpostca_pch extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signpostca_pch")
	public static final Block block = null;

	public MCreatorSignpostca_pch(Elementscsm instance) {
		super(instance, 267);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signpostca_pch");
			setUnlocalizedName("signpostca_pch");
