...
public class MCreatorLTGCJ extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:ltgcj")
	public static final Block block = null;

	public MCreatorLTGCJ(Elementscsm instance) {
		super(instance, 565);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ltgcj", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("ltgcj");
			setUnlocalizedName("ltgcj");
