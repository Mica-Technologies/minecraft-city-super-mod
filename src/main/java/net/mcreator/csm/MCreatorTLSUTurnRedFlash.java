...
public class MCreatorTLSUTurnRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsuturnredflash")
	public static final Block block = null;

	public MCreatorTLSUTurnRedFlash(Elementscsm instance) {
		super(instance, 447);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsuturnredflash",
				"inventory"));
	}
