...
public class MCreatorTLVLeftYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvleftyellow")
	public static final Block block = null;

	public MCreatorTLVLeftYellow(Elementscsm instance) {
		super(instance, 372);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvleftyellow", "inventory"));
	}
