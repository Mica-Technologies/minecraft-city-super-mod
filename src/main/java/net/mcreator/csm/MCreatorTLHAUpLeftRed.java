...
public class MCreatorTLHAUpLeftRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhaupleftred")
	public static final Block block = null;

	public MCreatorTLHAUpLeftRed(Elementscsm instance) {
		super(instance, 518);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhaupleftred", "inventory"));
	}
