...
public class MCreatorTL4VGLG extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vglg")
	public static final Block block = null;

	public MCreatorTL4VGLG(Elementscsm instance) {
		super(instance, 752);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vglg", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vglg");
			setUnlocalizedName("tl4vglg");
