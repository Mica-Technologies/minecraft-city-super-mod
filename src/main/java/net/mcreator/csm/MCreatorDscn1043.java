...
public class MCreatorDscn1043 extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:dscn1043")
	public static final Block block = null;

	public MCreatorDscn1043(Elementscsm instance) {
		super(instance,20);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarm2901.executeProcedure($_dependencies);
