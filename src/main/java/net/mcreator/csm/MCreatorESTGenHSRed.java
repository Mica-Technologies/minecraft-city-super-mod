...
public class MCreatorESTGenHSRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:estgenhsred")
	public static final Block block = null;

	public MCreatorESTGenHSRed(Elementscsm instance) {
		super(instance,21);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarmESTGenesis.executeProcedure($_dependencies);
