...
public class MCreatorTLVTransitFlashRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvtransitflashred")
	public static final Block block = null;

	public MCreatorTLVTransitFlashRed(Elementscsm instance) {
		super(instance, 506);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvtransitflashred",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvtransitflashred");
			setUnlocalizedName("tlvtransitflashred");
