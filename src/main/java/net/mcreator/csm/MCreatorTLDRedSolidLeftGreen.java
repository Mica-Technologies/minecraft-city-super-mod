...
public class MCreatorTLDRedSolidLeftGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldredsolidleftgreen")
	public static final Block block = null;

	public MCreatorTLDRedSolidLeftGreen(Elementscsm instance) {
		super(instance, 472);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldredsolidleftgreen",
				"inventory"));
	}
