...
public class MCreatorTLVFlashUpLEftRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvflashupleftred")
	public static final Block block = null;

	public MCreatorTLVFlashUpLEftRed(Elementscsm instance) {
		super(instance, 526);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvflashupleftred",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvflashupleftred");
			setUnlocalizedName("tlvflashupleftred");
