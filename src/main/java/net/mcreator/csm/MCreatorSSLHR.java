...
public class MCreatorSSLHR extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:sslhr")
	public static final Block block = null;

	public MCreatorSSLHR(Elementscsm instance) {
		super(instance, 739);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslhr", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslhr");
			setUnlocalizedName("sslhr");
