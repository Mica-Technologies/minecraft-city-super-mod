...
public class MCreatorTLSRightYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsrightyellow")
	public static final Block block = null;

	public MCreatorTLSRightYellow(Elementscsm instance) {
		super(instance, 384);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsrightyellow",
				"inventory"));
	}
