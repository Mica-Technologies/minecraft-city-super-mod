...
public class MCreatorDSLH extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:dslh")
	public static final Block block = null;

	public MCreatorDSLH(Elementscsm instance) {
		super(instance, 730);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:dslh", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("dslh");
			setUnlocalizedName("dslh");
