...
public class MCreatorMtwb extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:mtwb")
	public static final Block block = null;

	public MCreatorMtwb(Elementscsm instance) {
		super(instance,105);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarmMTCode3.executeProcedure($_dependencies);
