...
public class MCreatorTLVUturnRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvuturnred")
	public static final Block block = null;

	public MCreatorTLVUturnRed(Elementscsm instance) {
		super(instance, 406);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvuturnred", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvuturnred");
			setUnlocalizedName("tlvuturnred");
