...
public class MCreatorWhiteMetalSlab extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:whitemetalslab")
	public static final Block block = null;

	public MCreatorWhiteMetalSlab(Elementscsm instance) {
		super(instance, 732);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:whitemetalslab", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("whitemetalslab");
