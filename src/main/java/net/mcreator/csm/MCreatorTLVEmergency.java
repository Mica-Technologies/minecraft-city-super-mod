...
public class MCreatorTLVEmergency extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvemergency")
	public static final Block block = null;

	public MCreatorTLVEmergency(Elementscsm instance) {
		super(instance, 381);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvemergency", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvemergency");
			setUnlocalizedName("tlvemergency");
