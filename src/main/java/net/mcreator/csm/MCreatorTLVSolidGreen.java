...
public class MCreatorTLVSolidGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvsolidgreen")
	public static final Block block = null;

	public MCreatorTLVSolidGreen(Elementscsm instance) {
		super(instance, 362);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvsolidgreen", "inventory"));
	}
