...
public class MCreatorTLSRightGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsrightgreen")
	public static final Block block = null;

	public MCreatorTLSRightGreen(Elementscsm instance) {
		super(instance, 387);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlsrightgreen", "inventory"));
	}
