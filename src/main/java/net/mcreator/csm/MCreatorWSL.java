...
public class MCreatorWSL extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:wsl")
	public static final Block block = null;

	public MCreatorWSL(Elementscsm instance) {
		super(instance, 742);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:wsl", "inventory"));
	}
