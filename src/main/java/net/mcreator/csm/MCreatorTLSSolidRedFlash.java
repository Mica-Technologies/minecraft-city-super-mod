...
public class MCreatorTLSSolidRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlssolidredflash")
	public static final Block block = null;

	public MCreatorTLSSolidRedFlash(Elementscsm instance) {
		super(instance, 420);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlssolidredflash",
				"inventory"));
	}
