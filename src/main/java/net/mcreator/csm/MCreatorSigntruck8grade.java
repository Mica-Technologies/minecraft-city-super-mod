...
public class MCreatorSigntruck8grade extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signtruck8grade")
	public static final Block block = null;

	public MCreatorSigntruck8grade(Elementscsm instance) {
		super(instance, 475);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signtruck8grade");
			setUnlocalizedName("signtruck8grade");
