...
public class MCreatorTLDGreenSolidRightYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldgreensolidrightyellow")
	public static final Block block = null;

	public MCreatorTLDGreenSolidRightYellow(Elementscsm instance) {
		super(instance, 477);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldgreensolidrightyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setLightLevel(0F);
			setLightOpacity(0);
			setCreativeTab(MCreatorTrafficSignalsDoghouse.tab);
