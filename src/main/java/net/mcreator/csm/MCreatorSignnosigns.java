...
public class MCreatorSignnosigns extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signnosigns")
	public static final Block block = null;

	public MCreatorSignnosigns(Elementscsm instance) {
		super(instance, 521);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signnosigns");
			setUnlocalizedName("signnosigns");
