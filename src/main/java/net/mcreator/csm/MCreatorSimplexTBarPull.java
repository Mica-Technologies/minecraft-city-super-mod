...
public class MCreatorSimplexTBarPull extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:simplextbarpull")
	public static final Block block = null;

	public MCreatorSimplexTBarPull(Elementscsm instance) {
		super(instance, 317);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysimplextbarpull");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:simplextbarpull",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("simplextbarpull");
			setUnlocalizedName("simplextbarpull");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.simplextbarpull";
		}
