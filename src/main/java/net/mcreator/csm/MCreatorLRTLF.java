...
public class MCreatorLRTLF extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:lrtlf")
	public static final Block block = null;

	public MCreatorLRTLF(Elementscsm instance) {
		super(instance, 734);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:lrtlf", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("lrtlf");
			setUnlocalizedName("lrtlf");
