...
public class MCreatorTLDRedSolidLeftYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldredsolidleftyellow")
	public static final Block block = null;

	public MCreatorTLDRedSolidLeftYellow(Elementscsm instance) {
		super(instance, 473);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldredsolidleftyellow",
				"inventory"));
	}
