...
public class MCreatorTLSRightYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsrightyellowflash")
	public static final Block block = null;

	public MCreatorTLSRightYellowFlash(Elementscsm instance) {
		super(instance, 438);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsrightyellowflash",
				"inventory"));
	}
