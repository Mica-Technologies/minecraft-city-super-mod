...
public class MCreatorSslssswclsve extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:sslssswclsve")
	public static final Block block = null;

	public MCreatorSslssswclsve(Elementscsm instance) {
		super(instance, 591);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslssswclsve", "inventory"));
	}
