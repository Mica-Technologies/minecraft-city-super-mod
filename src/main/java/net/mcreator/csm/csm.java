 ...
 *
 *    Keep the Elementscsm object in this class and all calls to this object
...
@Mod(modid = csm.MODID, version = csm.VERSION)
public class csm {
	public static final String MODID = "csm";
	public static final String VERSION = "2020.3.1";
	public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("csm:a");
	@SidedProxy(clientSide = "net.mcreator.csm.ClientProxycsm", serverSide = "net.mcreator.csm.ServerProxycsm")
	public static IProxycsm proxy;
	@Mod.Instance(MODID)
	public static csm instance;
	public Elementscsm elements = new Elementscsm();
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new Elementscsm.GuiHandler());
