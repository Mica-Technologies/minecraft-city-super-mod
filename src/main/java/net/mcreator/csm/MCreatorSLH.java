...
public class MCreatorSLH extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:slh")
	public static final Block block = null;

	public MCreatorSLH(Elementscsm instance) {
		super(instance, 741);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:slh", "inventory"));
	}
