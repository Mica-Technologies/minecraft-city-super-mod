...
public class MCreatorTLVUTurnYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvuturnyellowflash")
	public static final Block block = null;

	public MCreatorTLVUTurnYellowFlash(Elementscsm instance) {
		super(instance, 448);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvuturnyellowflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvuturnyellowflash");
			setUnlocalizedName("tlvuturnyellowflash");
