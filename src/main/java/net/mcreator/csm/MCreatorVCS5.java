...
public class MCreatorVCS5 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:vcs5")
	public static final Block block = null;

	public MCreatorVCS5(Elementscsm instance) {
		super(instance, 785);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:vcs5", "inventory"));
	}
