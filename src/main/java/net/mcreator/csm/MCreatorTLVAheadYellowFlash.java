...
public class MCreatorTLVAheadYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvaheadyellowflash")
	public static final Block block = null;

	public MCreatorTLVAheadYellowFlash(Elementscsm instance) {
		super(instance, 454);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaheadyellowflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvaheadyellowflash");
			setUnlocalizedName("tlvaheadyellowflash");
