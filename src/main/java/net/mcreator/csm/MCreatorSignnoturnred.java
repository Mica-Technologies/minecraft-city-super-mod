...
public class MCreatorSignnoturnred extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signnoturnred")
	public static final Block block = null;

	public MCreatorSignnoturnred(Elementscsm instance) {
		super(instance, 313);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signnoturnred");
			setUnlocalizedName("signnoturnred");
