...
public class MCreatorESTGenHSWhite extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:estgenhswhite")
	public static final Block block = null;

	public MCreatorESTGenHSWhite(Elementscsm instance) {
		super(instance,22);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:estgenhswhite", "inventory"));
	}
