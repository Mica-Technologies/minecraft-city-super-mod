...
public class MCreatorLtgcm extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:ltgcm")
	public static final Block block = null;

	public MCreatorLtgcm(Elementscsm instance) {
		super(instance, 565);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ltgcm", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("ltgcm");
			setUnlocalizedName("ltgcm");
