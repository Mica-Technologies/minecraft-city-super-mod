...
public class MCreatorTL4VRRG extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vrrg")
	public static final Block block = null;

	public MCreatorTL4VRRG(Elementscsm instance) {
		super(instance, 753);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vrrg", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vrrg");
			setUnlocalizedName("tl4vrrg");
