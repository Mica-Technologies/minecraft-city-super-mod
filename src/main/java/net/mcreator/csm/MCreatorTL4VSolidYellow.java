...
public class MCreatorTL4VSolidYellow extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vsolidyellow")
	public static final Block block = null;

	public MCreatorTL4VSolidYellow(Elementscsm instance) {
		super(instance, 748);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vsolidyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vsolidyellow");
			setUnlocalizedName("tl4vsolidyellow");
