...
public class MCreatorLGTLF extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:lgtlf")
	public static final Block block = null;

	public MCreatorLGTLF(Elementscsm instance) {
		super(instance, 732);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:lgtlf", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("lgtlf");
			setUnlocalizedName("lgtlf");
