...
public class MCreatorTLVUpLeftGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvupleftgreen")
	public static final Block block = null;

	public MCreatorTLVUpLeftGreen(Elementscsm instance) {
		super(instance, 525);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvupleftgreen",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvupleftgreen");
			setUnlocalizedName("tlvupleftgreen");
