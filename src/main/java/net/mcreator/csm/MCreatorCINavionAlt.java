...
public class MCreatorCINavionAlt extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:cinavionalt")
	public static final Block block = null;

	public MCreatorCINavionAlt(Elementscsm instance) {
		super(instance, 1069);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:cinavionalt", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("cinavionalt");
			setUnlocalizedName("cinavionalt");
