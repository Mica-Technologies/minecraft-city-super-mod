...
public class MCreatorFJS1 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:fjs1")
	public static final Block block = null;

	public MCreatorFJS1(Elementscsm instance) {
		super(instance, 790);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:fjs1", "inventory"));
	}
