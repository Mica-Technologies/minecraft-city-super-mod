...
public class MCreatorTLSBikeYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsbikeyellow")
	public static final Block block = null;

	public MCreatorTLSBikeYellow(Elementscsm instance) {
		super(instance, 402);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlsbikeyellow", "inventory"));
	}
