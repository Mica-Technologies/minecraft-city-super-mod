...
public class MCreatorTL4VSolidRed extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vsolidred")
	public static final Block block = null;

	public MCreatorTL4VSolidRed(Elementscsm instance) {
		super(instance, 747);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vsolidred", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vsolidred");
			setUnlocalizedName("tl4vsolidred");
