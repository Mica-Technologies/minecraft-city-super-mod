...
public class MCreatorTLVAheadRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvaheadred")
	public static final Block block = null;

	public MCreatorTLVAheadRed(Elementscsm instance) {
		super(instance, 388);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaheadred", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvaheadred");
			setUnlocalizedName("tlvaheadred");
