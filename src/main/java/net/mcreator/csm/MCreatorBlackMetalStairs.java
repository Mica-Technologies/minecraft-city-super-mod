...
public class MCreatorBlackMetalStairs extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:blackmetalstairs")
	public static final Block block = null;

	public MCreatorBlackMetalStairs(Elementscsm instance) {
		super(instance, 745);
	}
	...
	public static class BlockCustom extends BlockStairs {
		public BlockCustom() {
			...
			setRegistryName("blackmetalstairs");
