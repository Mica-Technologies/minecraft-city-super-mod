...
public class MCreatorTLVRightRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvrightredflash")
	public static final Block block = null;

	public MCreatorTLVRightRedFlash(Elementscsm instance) {
		super(instance, 433);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvrightredflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvrightredflash");
			setUnlocalizedName("tlvrightredflash");
