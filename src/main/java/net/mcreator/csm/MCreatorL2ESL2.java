...
public class MCreatorL2ESL2 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:l2esl2")
	public static final Block block = null;

	public MCreatorL2ESL2(Elementscsm instance) {
		super(instance, 726);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:l2esl2", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("l2esl2");
			setUnlocalizedName("l2esl2");
