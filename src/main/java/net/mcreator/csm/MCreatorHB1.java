...
public class MCreatorHB1 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:hb1")
	public static final Block block = null;

	public MCreatorHB1(Elementscsm instance) {
		super(instance, 743);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:hb1", "inventory"));
	}
