...
public class MCreatorGEESSN extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:geessn")
	public static final Block block = null;

	public MCreatorGEESSN(Elementscsm instance) {
		super(instance, 1073);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:geessn", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("geessn");
			setUnlocalizedName("geessn");
