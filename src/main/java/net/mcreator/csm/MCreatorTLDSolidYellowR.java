...
public class MCreatorTLDSolidYellowR extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldsolidyellowr")
	public static final Block block = null;

	public MCreatorTLDSolidYellowR(Elementscsm instance) {
		super(instance, 467);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldsolidyellowr",
				"inventory"));
	}
