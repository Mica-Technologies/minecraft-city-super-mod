...
public class MCreatorNostandingsign extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:nostandingsign")
	public static final Block block = null;

	public MCreatorNostandingsign(Elementscsm instance) {
		super(instance, 546);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("nostandingsign");
			setUnlocalizedName("nostandingsign");
