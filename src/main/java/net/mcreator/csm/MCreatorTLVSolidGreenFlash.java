...
public class MCreatorTLVSolidGreenFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvsolidgreenflash")
	public static final Block block = null;

	public MCreatorTLVSolidGreenFlash(Elementscsm instance) {
		super(instance, 424);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidgreenflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvsolidgreenflash");
			setUnlocalizedName("tlvsolidgreenflash");
