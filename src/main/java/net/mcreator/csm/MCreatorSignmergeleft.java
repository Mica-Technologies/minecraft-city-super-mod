...
public class MCreatorSignmergeleft extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signmergeleft")
	public static final Block block = null;

	public MCreatorSignmergeleft(Elementscsm instance) {
		super(instance, 299);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signmergeleft");
			setUnlocalizedName("signmergeleft");
