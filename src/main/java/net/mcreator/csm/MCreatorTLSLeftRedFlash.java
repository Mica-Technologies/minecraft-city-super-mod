...
public class MCreatorTLSLeftRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsleftredflash")
	public static final Block block = null;

	public MCreatorTLSLeftRedFlash(Elementscsm instance) {
		super(instance, 429);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsleftredflash",
				"inventory"));
	}
