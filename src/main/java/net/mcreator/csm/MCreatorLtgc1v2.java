...
public class MCreatorLtgc1v2 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:ltgc1v2")
	public static final Block block = null;

	public MCreatorLtgc1v2(Elementscsm instance) {
		super(instance, 293);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ltgc1v2", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("ltgc1v2");
			setUnlocalizedName("ltgc1v2");
