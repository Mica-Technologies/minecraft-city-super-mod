...
public class MCreatorDSLF extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:dslf")
	public static final Block block = null;

	public MCreatorDSLF(Elementscsm instance) {
		super(instance, 728);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:dslf", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("dslf");
			setUnlocalizedName("dslf");
