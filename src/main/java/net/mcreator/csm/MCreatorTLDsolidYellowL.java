...
public class MCreatorTLDsolidYellowL extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldsolidyellowl")
	public static final Block block = null;

	public MCreatorTLDsolidYellowL(Elementscsm instance) {
		super(instance, 466);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldsolidyellowl",
				"inventory"));
	}
