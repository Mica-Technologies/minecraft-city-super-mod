...
public class MCreatorTLHLeftGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhleftgreen")
	public static final Block block = null;

	public MCreatorTLHLeftGreen(Elementscsm instance) {
		super(instance, 376);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhleftgreen", "inventory"));
	}
