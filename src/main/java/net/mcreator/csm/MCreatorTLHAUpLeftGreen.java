...
public class MCreatorTLHAUpLeftGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhaupleftgreen")
	public static final Block block = null;

	public MCreatorTLHAUpLeftGreen(Elementscsm instance) {
		super(instance, 520);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaupleftgreen",
				"inventory"));
	}
