...
public class MCreatorTLHUturnGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhuturngreen")
	public static final Block block = null;

	public MCreatorTLHUturnGreen(Elementscsm instance) {
		super(instance, 413);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhuturngreen", "inventory"));
	}
