...
public class MCreatorTLDGreenSolidRightGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldgreensolidrightgreen")
	public static final Block block = null;

	public MCreatorTLDGreenSolidRightGreen(Elementscsm instance) {
		super(instance, 476);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldgreensolidrightgreen",
				"inventory"));
	}
