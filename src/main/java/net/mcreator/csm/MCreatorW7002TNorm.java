...
public class MCreatorW7002TNorm extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:w7002tnorm")
	public static final Block block = null;

	public MCreatorW7002TNorm(Elementscsm instance) {
		super(instance, 320);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFA7002Med.executeProcedure($_dependencies);
