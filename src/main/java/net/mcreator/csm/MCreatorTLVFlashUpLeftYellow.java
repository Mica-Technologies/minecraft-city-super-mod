...
public class MCreatorTLVFlashUpLeftYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvflashupleftyellow")
	public static final Block block = null;

	public MCreatorTLVFlashUpLeftYellow(Elementscsm instance) {
		super(instance, 527);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvflashupleftyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvflashupleftyellow");
			setUnlocalizedName("tlvflashupleftyellow");
