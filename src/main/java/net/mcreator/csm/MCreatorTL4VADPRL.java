...
public class MCreatorTL4VADPRL extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vadprl")
	public static final Block block = null;

	public MCreatorTL4VADPRL(Elementscsm instance) {
		super(instance, 756);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vadprl", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vadprl");
			setUnlocalizedName("tl4vadprl");
