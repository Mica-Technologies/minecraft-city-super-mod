...
public class MCreatorTLYV_SRBroken extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tlyv_srbroken")
	public static final Block block = null;

	public MCreatorTLYV_SRBroken(Elementscsm instance) {
		super(instance, 670);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlyv_srbroken", "inventory"));
	}
