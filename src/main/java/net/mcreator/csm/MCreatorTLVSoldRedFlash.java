...
public class MCreatorTLVSoldRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvsoldredflash")
	public static final Block block = null;

	public MCreatorTLVSoldRedFlash(Elementscsm instance) {
		super(instance, 418);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsoldredflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvsoldredflash");
			setUnlocalizedName("tlvsoldredflash");
