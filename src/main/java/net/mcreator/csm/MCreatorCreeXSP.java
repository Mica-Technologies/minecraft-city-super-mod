...
public class MCreatorCreeXSP extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:creexsp")
	public static final Block block = null;

	public MCreatorCreeXSP(Elementscsm instance) {
		super(instance, 291);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:creexsp", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("creexsp");
			setUnlocalizedName("creexsp");
