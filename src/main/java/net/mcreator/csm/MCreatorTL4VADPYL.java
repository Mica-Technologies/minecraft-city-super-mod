...
public class MCreatorTL4VADPYL extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vadpyl")
	public static final Block block = null;

	public MCreatorTL4VADPYL(Elementscsm instance) {
		super(instance, 757);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vadpyl", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vadpyl");
			setUnlocalizedName("tl4vadpyl");
