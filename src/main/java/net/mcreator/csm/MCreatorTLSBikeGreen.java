...
public class MCreatorTLSBikeGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsbikegreen")
	public static final Block block = null;

	public MCreatorTLSBikeGreen(Elementscsm instance) {
		super(instance, 405);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsbikegreen", "inventory"));
	}
