...
public class MCreatorCreeledwaysmall extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:creeledwaysmall")
	public static final Block block = null;

	public MCreatorCreeledwaysmall(Elementscsm instance) {
		super(instance, 294);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:creeledwaysmall",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("creeledwaysmall");
			setUnlocalizedName("creeledwaysmall");
