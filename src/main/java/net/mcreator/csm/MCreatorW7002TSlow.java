...
public class MCreatorW7002TSlow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:w7002tslow")
	public static final Block block = null;

	public MCreatorW7002TSlow(Elementscsm instance) {
		super(instance, 322);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFA7002Slow.executeProcedure($_dependencies);
