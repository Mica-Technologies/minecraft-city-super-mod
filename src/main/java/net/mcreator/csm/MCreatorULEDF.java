...
public class MCreatorULEDF extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:uledf")
	public static final Block block = null;

	public MCreatorULEDF(Elementscsm instance) {
		super(instance, 745);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:uledf", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("uledf");
			setUnlocalizedName("uledf");
