...
public class MCreatorSssahsw extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:sssahsw")
	public static final Block block = null;

	public MCreatorSssahsw(Elementscsm instance) {
		super(instance, 77);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarmAdvance.executeProcedure($_dependencies);
