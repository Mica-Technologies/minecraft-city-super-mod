...
public class MCreatorTLDRedSolidRightGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldredsolidrightgreen")
	public static final Block block = null;

	public MCreatorTLDRedSolidRightGreen(Elementscsm instance) {
		super(instance, 470);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldredsolidrightgreen",
				"inventory"));
	}
