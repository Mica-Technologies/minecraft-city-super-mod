...
public class MCreatorTLHUTurnYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhuturnyellowflash")
	public static final Block block = null;

	public MCreatorTLHUTurnYellowFlash(Elementscsm instance) {
		super(instance, 449);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhuturnyellowflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhuturnyellowflash");
			setUnlocalizedName("tlhuturnyellowflash");
