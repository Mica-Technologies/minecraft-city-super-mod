...
public class MCreatorTLHAFlashUpLeftRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhaflashupleftred")
	public static final Block block = null;

	public MCreatorTLHAFlashUpLeftRed(Elementscsm instance) {
		super(instance, 521);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaflashupleftred",
				"inventory"));
	}
