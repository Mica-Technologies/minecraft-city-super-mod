...
public class MCreatorTLVAheadGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvaheadgreen")
	public static final Block block = null;

	public MCreatorTLVAheadGreen(Elementscsm instance) {
		super(instance, 394);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvaheadgreen", "inventory"));
	}
