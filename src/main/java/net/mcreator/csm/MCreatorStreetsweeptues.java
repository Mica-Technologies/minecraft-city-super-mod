...
public class MCreatorStreetsweeptues extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:streetsweeptues")
	public static final Block block = null;

	public MCreatorStreetsweeptues(Elementscsm instance) {
		super(instance, 1080);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("streetsweeptues");
			setUnlocalizedName("streetsweeptues");
