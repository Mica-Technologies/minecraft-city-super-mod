...
public class MCreatorSignspeed65 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signspeed65")
	public static final Block block = null;

	public MCreatorSignspeed65(Elementscsm instance) {
		super(instance, 392);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signspeed65");
			setUnlocalizedName("signspeed65");
