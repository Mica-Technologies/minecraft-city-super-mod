...
public class MCreatorTLVYTFY extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvytfy")
	public static final Block block = null;

	public MCreatorTLVYTFY(Elementscsm instance) {
		super(instance, 759);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvytfy", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvytfy");
			setUnlocalizedName("tlvytfy");
