...
public class MCreatorSignleftcurve extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signleftcurve")
	public static final Block block = null;

	public MCreatorSignleftcurve(Elementscsm instance) {
		super(instance, 285);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signleftcurve");
			setUnlocalizedName("signleftcurve");
