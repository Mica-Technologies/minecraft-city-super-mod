...
public class MCreatorTrafficStreetNameSign extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:trafficstreetnamesign")
	public static final Block block = null;

	public MCreatorTrafficStreetNameSign(Elementscsm instance) {
		super(instance, 560);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:trafficstreetnamesign",
				"inventory"));
	}
