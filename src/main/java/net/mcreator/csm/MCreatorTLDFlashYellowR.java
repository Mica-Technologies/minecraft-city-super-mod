...
public class MCreatorTLDFlashYellowR extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldflashyellowr")
	public static final Block block = null;

	public MCreatorTLDFlashYellowR(Elementscsm instance) {
		super(instance, 480);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldflashyellowr",
				"inventory"));
	}
