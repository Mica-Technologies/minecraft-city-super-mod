...
public class MCreatorSignpost50min30 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signpost50min30")
	public static final Block block = null;

	public MCreatorSignpost50min30(Elementscsm instance) {
		super(instance, 272);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signpost50min30");
			setUnlocalizedName("signpost50min30");
