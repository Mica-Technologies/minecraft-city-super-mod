...
public class MCreatorTLSSolidYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlssolidyellow")
	public static final Block block = null;

	public MCreatorTLSSolidYellow(Elementscsm instance) {
		super(instance, 361);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlssolidyellow",
				"inventory"));
	}
