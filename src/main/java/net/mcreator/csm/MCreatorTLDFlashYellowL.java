...
public class MCreatorTLDFlashYellowL extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldflashyellowl")
	public static final Block block = null;

	public MCreatorTLDFlashYellowL(Elementscsm instance) {
		super(instance, 479);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldflashyellowl",
				"inventory"));
	}
