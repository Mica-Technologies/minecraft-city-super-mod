...
public class MCreatorTLSSolidGreenFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlssolidgreenflash")
	public static final Block block = null;

	public MCreatorTLSSolidGreenFlash(Elementscsm instance) {
		super(instance, 426);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlssolidgreenflash",
				"inventory"));
	}
