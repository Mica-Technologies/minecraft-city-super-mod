...
public class MCreatorSignramp25 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signramp25")
	public static final Block block = null;

	public MCreatorSignramp25(Elementscsm instance) {
		super(instance, 383);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signramp25");
			setUnlocalizedName("signramp25");
