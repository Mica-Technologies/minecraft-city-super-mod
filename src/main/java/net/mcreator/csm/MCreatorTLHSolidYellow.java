...
public class MCreatorTLHSolidYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhsolidyellow")
	public static final Block block = null;

	public MCreatorTLHSolidYellow(Elementscsm instance) {
		super(instance, 360);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhsolidyellow",
				"inventory"));
	}
