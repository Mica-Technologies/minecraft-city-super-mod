...
public class MCreatorTLVTransitRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvtransitred")
	public static final Block block = null;

	public MCreatorTLVTransitRed(Elementscsm instance) {
		super(instance, 503);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvtransitred", "inventory"));
	}
