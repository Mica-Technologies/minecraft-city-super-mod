...
public class MCreatorFLBG6 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:flbg6")
	public static final Block block = null;

	public MCreatorFLBG6(Elementscsm instance) {
		super(instance, 323);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityflbg6");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:flbg6", "inventory"));
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("flbg6");
			setUnlocalizedName("flbg6");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.flbg6";
		}
