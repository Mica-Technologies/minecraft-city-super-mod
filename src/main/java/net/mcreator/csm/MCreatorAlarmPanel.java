...
public class MCreatorAlarmPanel extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:alarmpanel")
	public static final Block block = null;

	public MCreatorAlarmPanel(Elementscsm instance) {
		super(instance, 278);
	}
				...
				if (bsc.getValue(BlockLever.POWERED)) {
					...
					if (mcserv != null)
						mcserv.getPlayerList().sendMessage(
								new TextComponentString("Fire alarm panel at [" + x + "," + y + "," + z + "] has been activated!"));
				} else {
