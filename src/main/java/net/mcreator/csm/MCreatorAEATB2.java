...
public class MCreatorAEATB2 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:aeatb2")
	public static final Block block = null;

	public MCreatorAEATB2(Elementscsm instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:aeatb2", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("aeatb2");
			setUnlocalizedName("aeatb2");
