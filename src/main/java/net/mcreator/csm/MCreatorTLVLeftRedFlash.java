...
public class MCreatorTLVLeftRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvleftredflash")
	public static final Block block = null;

	public MCreatorTLVLeftRedFlash(Elementscsm instance) {
		super(instance, 427);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvleftredflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvleftredflash");
			setUnlocalizedName("tlvleftredflash");
