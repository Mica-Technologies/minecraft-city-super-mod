...
public class MCreatorTLVARightYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvarightyellow")
	public static final Block block = null;

	public MCreatorTLVARightYellow(Elementscsm instance) {
		super(instance, 513);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvarightyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvarightyellow");
			setUnlocalizedName("tlvarightyellow");
