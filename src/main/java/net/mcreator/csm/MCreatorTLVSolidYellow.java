...
public class MCreatorTLVSolidYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvsolidyellow")
	public static final Block block = null;

	public MCreatorTLVSolidYellow(Elementscsm instance) {
		super(instance, 359);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvsolidyellow");
			setUnlocalizedName("tlvsolidyellow");
