...
public class MCreatorWheelockWhiteET70SS extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:wheelockwhiteet70ss")
	public static final Block block = null;

	public MCreatorWheelockWhiteET70SS(Elementscsm instance) {
		super(instance, 303);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:wheelockwhiteet70ss",
				"inventory"));
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarmLMSVoiceEvac.executeProcedure($_dependencies);
