...
public class BlockWe70w extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:we70w")
	public static final Block block = null;
	public BlockWe70w(ElementsCitySuperMod instance) {
		super(instance, 95);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywe70w");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:we70w", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("we70w");
			setUnlocalizedName("we70w");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.we70w";
		}
