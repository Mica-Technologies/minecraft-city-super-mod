...
public class BlockTLHAheadYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaheadyellow")
	public static final Block block = null;
	public BlockTLHAheadYellow(ElementsCitySuperMod instance) {
		super(instance, 392);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaheadyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaheadyellow");
			setUnlocalizedName("tlhaheadyellow");
