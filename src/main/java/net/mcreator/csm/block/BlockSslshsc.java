...
public class BlockSslshsc extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sslshsc")
	public static final Block block = null;
	public BlockSslshsc(ElementsCitySuperMod instance) {
		super(instance, 120);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysslshsc");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslshsc", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslshsc");
			setUnlocalizedName("sslshsc");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sslshsc";
		}
