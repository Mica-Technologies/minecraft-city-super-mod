...
public class BlockTLVFlashUpLeftYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvflashupleftyellow")
	public static final Block block = null;
	public BlockTLVFlashUpLeftYellow(ElementsCitySuperMod instance) {
		super(instance, 527);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvflashupleftyellow", "inventory"));
	}
