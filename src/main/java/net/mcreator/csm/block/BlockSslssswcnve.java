...
public class BlockSslssswcnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sslssswcnve")
	public static final Block block = null;
	public BlockSslssswcnve(ElementsCitySuperMod instance) {
		super(instance, 612);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysslssswcnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslssswcnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslssswcnve");
			setUnlocalizedName("sslssswcnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sslssswcnve";
		}
