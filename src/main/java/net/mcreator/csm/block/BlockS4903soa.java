...
public class BlockS4903soa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:s4903soa")
	public static final Block block = null;
	public BlockS4903soa(ElementsCitySuperMod instance) {
		super(instance, 629);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitys4903soa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s4903soa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("s4903soa");
			setUnlocalizedName("s4903soa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.s4903soa";
		}
