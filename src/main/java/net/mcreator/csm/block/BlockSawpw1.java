...
public class BlockSawpw1 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sawpw1")
	public static final Block block = null;
	public BlockSawpw1(ElementsCitySuperMod instance) {
		super(instance, 79);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysawpw1");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sawpw1", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sawpw1");
			setUnlocalizedName("sawpw1");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sawpw1";
		}
