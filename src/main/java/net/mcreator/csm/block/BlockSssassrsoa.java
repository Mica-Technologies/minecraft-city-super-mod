...
public class BlockSssassrsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sssassrsoa")
	public static final Block block = null;
	public BlockSssassrsoa(ElementsCitySuperMod instance) {
		super(instance, 628);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysssassrsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sssassrsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sssassrsoa");
			setUnlocalizedName("sssassrsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sssassrsoa";
		}
