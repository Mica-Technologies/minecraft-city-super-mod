...
public class BlockEt70rnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:et70rnve")
	public static final Block block = null;
	public BlockEt70rnve(ElementsCitySuperMod instance) {
		super(instance, 640);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityet70rnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:et70rnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("et70rnve");
			setUnlocalizedName("et70rnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.et70rnve";
		}
