...
public class BlockTLHRightGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhrightgreen")
	public static final Block block = null;
	public BlockTLHRightGreen(ElementsCitySuperMod instance) {
		super(instance, 386);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhrightgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhrightgreen");
			setUnlocalizedName("tlhrightgreen");
