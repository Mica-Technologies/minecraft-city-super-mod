...
public class BlockMtr extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mtr")
	public static final Block block = null;
	public BlockMtr(ElementsCitySuperMod instance) {
		super(instance, 103);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitymtr");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:mtr", "inventory"));
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.mtr";
		}
