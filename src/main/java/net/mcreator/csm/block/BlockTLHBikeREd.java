...
public class BlockTLHBikeREd extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhbikered")
	public static final Block block = null;
	public BlockTLHBikeREd(ElementsCitySuperMod instance) {
		super(instance, 398);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhbikered", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhbikered");
			setUnlocalizedName("tlhbikered");
