...
public class BlockMtw extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mtw")
	public static final Block block = null;
	public BlockMtw(ElementsCitySuperMod instance) {
		super(instance, 104);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitymtw");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:mtw", "inventory"));
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.mtw";
		}
