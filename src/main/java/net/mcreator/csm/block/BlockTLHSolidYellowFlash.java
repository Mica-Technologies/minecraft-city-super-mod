...
public class BlockTLHSolidYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhsolidyellowflash")
	public static final Block block = null;
	public BlockTLHSolidYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 422);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhsolidyellowflash", "inventory"));
	}
