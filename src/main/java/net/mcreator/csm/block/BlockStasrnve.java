...
public class BlockStasrnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:stasrnve")
	public static final Block block = null;
	public BlockStasrnve(ElementsCitySuperMod instance) {
		super(instance, 615);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitystasrnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:stasrnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("stasrnve");
			setUnlocalizedName("stasrnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.stasrnve";
		}
