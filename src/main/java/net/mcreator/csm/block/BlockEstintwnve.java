...
public class BlockEstintwnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:estintwnve")
	public static final Block block = null;
	public BlockEstintwnve(ElementsCitySuperMod instance) {
		super(instance, 608);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityestintwnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:estintwnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("estintwnve");
			setUnlocalizedName("estintwnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.estintwnve";
		}
