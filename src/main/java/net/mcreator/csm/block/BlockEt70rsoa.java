...
public class BlockEt70rsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:et70rsoa")
	public static final Block block = null;
	public BlockEt70rsoa(ElementsCitySuperMod instance) {
		super(instance, 641);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityet70rsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:et70rsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("et70rsoa");
			setUnlocalizedName("et70rsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.et70rsoa";
		}
