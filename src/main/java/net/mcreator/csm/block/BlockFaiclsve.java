...
public class BlockFaiclsve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:faiclsve")
	public static final Block block = null;
	public BlockFaiclsve(ElementsCitySuperMod instance) {
		super(instance, 593);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityfaiclsve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:faiclsve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("faiclsve");
			setUnlocalizedName("faiclsve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.faiclsve";
		}
