...
public class BlockTLHSolidGreenFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhsolidgreenflash")
	public static final Block block = null;
	public BlockTLHSolidGreenFlash(ElementsCitySuperMod instance) {
		super(instance, 425);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhsolidgreenflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhsolidgreenflash");
			setUnlocalizedName("tlhsolidgreenflash");
