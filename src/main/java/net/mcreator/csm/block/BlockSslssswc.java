...
public class BlockSslssswc extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sslssswc")
	public static final Block block = null;
	public BlockSslssswc(ElementsCitySuperMod instance) {
		super(instance, 75);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysslssswc");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslssswc", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslssswc");
			setUnlocalizedName("sslssswc");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sslssswc";
		}
