...
public class BlockTLHAUpLeftRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaupleftred")
	public static final Block block = null;
	public BlockTLHAUpLeftRed(ElementsCitySuperMod instance) {
		super(instance, 518);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaupleftred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaupleftred");
			setUnlocalizedName("tlhaupleftred");
