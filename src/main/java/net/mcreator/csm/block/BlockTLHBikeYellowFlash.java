...
public class BlockTLHBikeYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhbikeyellowflash")
	public static final Block block = null;
	public BlockTLHBikeYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 443);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhbikeyellowflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhbikeyellowflash");
			setUnlocalizedName("tlhbikeyellowflash");
