...
public class BlockControlBoxLargeTan extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:controlboxlargetan")
	public static final Block block = null;
	public BlockControlBoxLargeTan(ElementsCitySuperMod instance) {
		super(instance, 1171);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("controlboxlargetan"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:controlboxlargetan", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("controlboxlargetan");
