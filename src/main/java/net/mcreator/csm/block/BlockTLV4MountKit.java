...
public class BlockTLV4MountKit extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlv4mountkit")
	public static final Block block = null;
	public BlockTLV4MountKit(ElementsCitySuperMod instance) {
		super(instance, 910);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlv4mountkit"));
