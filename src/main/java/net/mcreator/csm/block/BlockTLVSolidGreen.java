...
public class BlockTLVSolidGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvsolidgreen")
	public static final Block block = null;
	public BlockTLVSolidGreen(ElementsCitySuperMod instance) {
		super(instance, 362);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvsolidgreen");
			setUnlocalizedName("tlvsolidgreen");
