...
public class BlockTLVTransitRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvtransitred")
	public static final Block block = null;
	public BlockTLVTransitRed(ElementsCitySuperMod instance) {
		super(instance, 503);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvtransitred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvtransitred");
			setUnlocalizedName("tlvtransitred");
