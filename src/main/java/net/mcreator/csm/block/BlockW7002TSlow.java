...
import net.mcreator.csm.procedure.ProcedureFA7002Slow;
...
public class BlockW7002TSlow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:w7002tslow")
	public static final Block block = null;
	public BlockW7002TSlow(ElementsCitySuperMod instance) {
		super(instance, 322);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityw7002tslow");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:w7002tslow", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("w7002tslow");
			setUnlocalizedName("w7002tslow");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFA7002Slow.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.w7002tslow";
		}
