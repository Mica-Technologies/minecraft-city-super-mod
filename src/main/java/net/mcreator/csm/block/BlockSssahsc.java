...
import net.mcreator.csm.procedure.ProcedureFireAlarmAdvance;
...
public class BlockSssahsc extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sssahsc")
	public static final Block block = null;
	public BlockSssahsc(ElementsCitySuperMod instance) {
		super(instance, 119);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysssahsc");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sssahsc", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sssahsc");
			setUnlocalizedName("sssahsc");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFireAlarmAdvance.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sssahsc";
		}
