...
public class BlockTLVUpLeftYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvupleftyellow")
	public static final Block block = null;
	public BlockTLVUpLeftYellow(ElementsCitySuperMod instance) {
		super(instance, 524);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvupleftyellow", "inventory"));
	}
