...
import net.mcreator.csm.procedure.ProcedureFireAlarmASCode3;
...
public class BlockMt13red extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mt13red")
	public static final Block block = null;
	public BlockMt13red(ElementsCitySuperMod instance) {
		super(instance, 49);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitymt13red");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:mt13red", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("mt13red");
			setUnlocalizedName("mt13red");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFireAlarmASCode3.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.mt13red";
		}
