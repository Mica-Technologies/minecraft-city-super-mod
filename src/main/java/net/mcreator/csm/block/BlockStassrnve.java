...
public class BlockStassrnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:stassrnve")
	public static final Block block = null;
	public BlockStassrnve(ElementsCitySuperMod instance) {
		super(instance, 616);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitystassrnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:stassrnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("stassrnve");
			setUnlocalizedName("stassrnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.stassrnve";
		}
