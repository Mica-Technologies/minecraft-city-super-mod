...
public class BlockFaicnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:faicnve")
	public static final Block block = null;
	public BlockFaicnve(ElementsCitySuperMod instance) {
		super(instance, 614);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityfaicnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:faicnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("faicnve");
			setUnlocalizedName("faicnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.faicnve";
		}
