...
public class BlockCWOffRight extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:cwoffright")
	public static final Block block = null;
	public BlockCWOffRight(ElementsCitySuperMod instance) {
		super(instance, 371);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:cwoffright", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("cwoffright");
			setUnlocalizedName("cwoffright");
