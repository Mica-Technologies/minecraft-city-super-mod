...
public class BlockSslsswcsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sslsswcsoa")
	public static final Block block = null;
	public BlockSslsswcsoa(ElementsCitySuperMod instance) {
		super(instance, 632);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysslsswcsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslsswcsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslsswcsoa");
			setUnlocalizedName("sslsswcsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sslsswcsoa";
		}
