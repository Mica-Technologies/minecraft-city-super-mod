...
public class BlockEt70wnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:et70wnve")
	public static final Block block = null;
	public BlockEt70wnve(ElementsCitySuperMod instance) {
		super(instance, 643);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityet70wnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:et70wnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("et70wnve");
			setUnlocalizedName("et70wnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.et70wnve";
		}
