...
public class BlockSslsswc extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sslsswc")
	public static final Block block = null;
	public BlockSslsswc(ElementsCitySuperMod instance) {
		super(instance, 74);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysslsswc");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslsswc", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslsswc");
			setUnlocalizedName("sslsswc");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sslsswc";
		}
