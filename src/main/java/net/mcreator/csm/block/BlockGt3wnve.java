...
public class BlockGt3wnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:gt3wnve")
	public static final Block block = null;
	public BlockGt3wnve(ElementsCitySuperMod instance) {
		super(instance, 619);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitygt3wnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:gt3wnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("gt3wnve");
			setUnlocalizedName("gt3wnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.gt3wnve";
		}
