...
public class BlockTLVUturnGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvuturngreen")
	public static final Block block = null;
	public BlockTLVUturnGreen(ElementsCitySuperMod instance) {
		super(instance, 412);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvuturngreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvuturngreen");
			setUnlocalizedName("tlvuturngreen");
