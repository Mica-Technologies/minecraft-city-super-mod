...
public class BlockSssahsr extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sssahsr")
	public static final Block block = null;
	public BlockSssahsr(ElementsCitySuperMod instance) {
		super(instance, 76);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysssahsr");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sssahsr", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sssahsr");
			setUnlocalizedName("sssahsr");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sssahsr";
		}
