...
public class BlockSawpr extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sawpr")
	public static final Block block = null;
	public BlockSawpr(ElementsCitySuperMod instance) {
		super(instance, 78);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysawpr");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sawpr", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sawpr");
			setUnlocalizedName("sawpr");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sawpr";
		}
