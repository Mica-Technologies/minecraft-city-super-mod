...
import net.mcreator.csm.procedure.ProcedureFA7002Reg;
...
public class BlockW7002TFast extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:w7002tfast")
	public static final Block block = null;
	public BlockW7002TFast(ElementsCitySuperMod instance) {
		super(instance, 321);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityw7002tfast");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:w7002tfast", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("w7002tfast");
			setUnlocalizedName("w7002tfast");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFA7002Reg.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.w7002tfast";
		}
