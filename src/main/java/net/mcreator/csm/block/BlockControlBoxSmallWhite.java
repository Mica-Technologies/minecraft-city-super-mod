...
public class BlockControlBoxSmallWhite extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:controlboxsmallwhite")
	public static final Block block = null;
	public BlockControlBoxSmallWhite(ElementsCitySuperMod instance) {
		super(instance, 1166);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("controlboxsmallwhite"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:controlboxsmallwhite", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("controlboxsmallwhite");
