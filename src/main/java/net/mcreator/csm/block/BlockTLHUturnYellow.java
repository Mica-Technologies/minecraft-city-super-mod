...
public class BlockTLHUturnYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhuturnyellow")
	public static final Block block = null;
	public BlockTLHUturnYellow(ElementsCitySuperMod instance) {
		super(instance, 410);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhuturnyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhuturnyellow");
			setUnlocalizedName("tlhuturnyellow");
