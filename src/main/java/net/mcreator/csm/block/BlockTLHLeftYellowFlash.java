...
public class BlockTLHLeftYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhleftyellowflash")
	public static final Block block = null;
	public BlockTLHLeftYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 431);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhleftyellowflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhleftyellowflash");
			setUnlocalizedName("tlhleftyellowflash");
