...
public class BlockTLHAFlashUpLeftRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaflashupleftred")
	public static final Block block = null;
	public BlockTLHAFlashUpLeftRed(ElementsCitySuperMod instance) {
		super(instance, 521);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaflashupleftred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaflashupleftred");
			setUnlocalizedName("tlhaflashupleftred");
