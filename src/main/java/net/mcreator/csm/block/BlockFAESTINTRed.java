...
public class BlockFAESTINTRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:faestintred")
	public static final Block block = null;
	public BlockFAESTINTRed(ElementsCitySuperMod instance) {
		super(instance, 5);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityfaestintred");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:faestintred", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("faestintred");
			setUnlocalizedName("faestintred");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.faestintred";
		}
