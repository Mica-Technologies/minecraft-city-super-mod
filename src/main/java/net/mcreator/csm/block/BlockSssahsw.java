...
public class BlockSssahsw extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sssahsw")
	public static final Block block = null;
	public BlockSssahsw(ElementsCitySuperMod instance) {
		super(instance, 77);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysssahsw");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sssahsw", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sssahsw");
			setUnlocalizedName("sssahsw");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sssahsw";
		}
