...
public class BlockGt3rsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:gt3rsoa")
	public static final Block block = null;
	public BlockGt3rsoa(ElementsCitySuperMod instance) {
		super(instance, 637);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitygt3rsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:gt3rsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("gt3rsoa");
			setUnlocalizedName("gt3rsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.gt3rsoa";
		}
