...
public class BlockTLYV_RRFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlyv_rrflash")
	public static final Block block = null;
	public BlockTLYV_RRFlash(ElementsCitySuperMod instance) {
		super(instance, 657);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlyv_rrflash", "inventory"));
	}
