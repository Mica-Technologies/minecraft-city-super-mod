...
public class BlockTLHAheadGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaheadgreen")
	public static final Block block = null;
	public BlockTLHAheadGreen(ElementsCitySuperMod instance) {
		super(instance, 395);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaheadgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaheadgreen");
			setUnlocalizedName("tlhaheadgreen");
