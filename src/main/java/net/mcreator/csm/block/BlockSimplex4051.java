...
public class BlockSimplex4051 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:simplex4051")
	public static final Block block = null;
	public BlockSimplex4051(ElementsCitySuperMod instance) {
		super(instance, 307);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysimplex4051");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:simplex4051", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("simplex4051");
			setUnlocalizedName("simplex4051");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.simplex4051";
		}
