...
public class BlockMt13 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mt13")
	public static final Block block = null;
	public BlockMt13(ElementsCitySuperMod instance) {
		super(instance, 48);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitymt13");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:mt13", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("mt13");
			setUnlocalizedName("mt13");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.mt13";
		}
