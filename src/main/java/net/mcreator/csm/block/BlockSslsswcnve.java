...
public class BlockSslsswcnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sslsswcnve")
	public static final Block block = null;
	public BlockSslsswcnve(ElementsCitySuperMod instance) {
		super(instance, 613);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysslsswcnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslsswcnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslsswcnve");
			setUnlocalizedName("sslsswcnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sslsswcnve";
		}
