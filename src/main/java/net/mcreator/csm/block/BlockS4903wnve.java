...
public class BlockS4903wnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:s4903wnve")
	public static final Block block = null;
	public BlockS4903wnve(ElementsCitySuperMod instance) {
		super(instance, 611);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitys4903wnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s4903wnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("s4903wnve");
			setUnlocalizedName("s4903wnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.s4903wnve";
		}
