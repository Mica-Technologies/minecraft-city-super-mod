...
import net.mcreator.csm.procedure.ProcedureGentexgos;
...
public class BlockGT3Red extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:gt3red")
	public static final Block block = null;
	public BlockGT3Red(ElementsCitySuperMod instance) {
		super(instance, 41);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitygt3red");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:gt3red", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("gt3red");
			setUnlocalizedName("gt3red");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureGentexgos.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.gt3red";
		}
