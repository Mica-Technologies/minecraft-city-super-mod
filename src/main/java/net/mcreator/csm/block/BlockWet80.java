...
public class BlockWet80 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:wet80")
	public static final Block block = null;
	public BlockWet80(ElementsCitySuperMod instance) {
		super(instance, 100);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywet80");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:wet80", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("wet80");
			setUnlocalizedName("wet80");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.wet80";
		}
