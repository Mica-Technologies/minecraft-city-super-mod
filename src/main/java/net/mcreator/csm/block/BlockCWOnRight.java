...
public class BlockCWOnRight extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:cwonright")
	public static final Block block = null;
	public BlockCWOnRight(ElementsCitySuperMod instance) {
		super(instance, 369);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:cwonright", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("cwonright");
			setUnlocalizedName("cwonright");
