...
public class BlockTLHUturnGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhuturngreen")
	public static final Block block = null;
	public BlockTLHUturnGreen(ElementsCitySuperMod instance) {
		super(instance, 413);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhuturngreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhuturngreen");
			setUnlocalizedName("tlhuturngreen");
