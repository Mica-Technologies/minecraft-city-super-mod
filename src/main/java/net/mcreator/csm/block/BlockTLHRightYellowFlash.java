...
public class BlockTLHRightYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhrightyellowflash")
	public static final Block block = null;
	public BlockTLHRightYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 437);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhrightyellowflash", "inventory"));
	}
