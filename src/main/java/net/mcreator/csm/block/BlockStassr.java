...
public class BlockStassr extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:stassr")
	public static final Block block = null;
	public BlockStassr(ElementsCitySuperMod instance) {
		super(instance, 70);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitystassr");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:stassr", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("stassr");
			setUnlocalizedName("stassr");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.stassr";
		}
