...
public class BlockWe70sw extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:we70sw")
	public static final Block block = null;
	public BlockWe70sw(ElementsCitySuperMod instance) {
		super(instance, 97);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywe70sw");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:we70sw", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("we70sw");
			setUnlocalizedName("we70sw");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.we70sw";
		}
