...
public class BlockEstintrsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:estintrsoa")
	public static final Block block = null;
	public BlockEstintrsoa(ElementsCitySuperMod instance) {
		super(instance, 627);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityestintrsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:estintrsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("estintrsoa");
			setUnlocalizedName("estintrsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.estintrsoa";
		}
