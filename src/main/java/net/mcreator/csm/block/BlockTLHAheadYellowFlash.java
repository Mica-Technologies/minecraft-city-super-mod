...
public class BlockTLHAheadYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaheadyellowflash")
	public static final Block block = null;
	public BlockTLHAheadYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 455);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhaheadyellowflash", "inventory"));
	}
