...
public class BlockSslstrobe extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sslstrobe")
	public static final Block block = null;
	public BlockSslstrobe(ElementsCitySuperMod instance) {
		super(instance, 52);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sslstrobe"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslstrobe", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("sslstrobe");
