...
public class BlockTLVSolidBrokenRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvsolidbrokenred")
	public static final Block block = null;
	public BlockTLVSolidBrokenRed(ElementsCitySuperMod instance) {
		super(instance, 528);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidbrokenred", "inventory"));
	}
