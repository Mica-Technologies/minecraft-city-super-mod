...
public class BlockWe70r extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:we70r")
	public static final Block block = null;
	public BlockWe70r(ElementsCitySuperMod instance) {
		super(instance, 94);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywe70r");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:we70r", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("we70r");
			setUnlocalizedName("we70r");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.we70r";
		}
