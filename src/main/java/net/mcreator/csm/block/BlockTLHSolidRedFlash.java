...
public class BlockTLHSolidRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhsolidredflash")
	public static final Block block = null;
	public BlockTLHSolidRedFlash(ElementsCitySuperMod instance) {
		super(instance, 419);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhsolidredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhsolidredflash");
			setUnlocalizedName("tlhsolidredflash");
