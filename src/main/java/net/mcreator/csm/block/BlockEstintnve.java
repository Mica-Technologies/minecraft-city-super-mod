...
public class BlockEstintnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:estintnve")
	public static final Block block = null;
	public BlockEstintnve(ElementsCitySuperMod instance) {
		super(instance, 607);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityestintnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:estintnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("estintnve");
			setUnlocalizedName("estintnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.estintnve";
		}
