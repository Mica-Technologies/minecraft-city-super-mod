...
public class BlockGt3wsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:gt3wsoa")
	public static final Block block = null;
	public BlockGt3wsoa(ElementsCitySuperMod instance) {
		super(instance, 638);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitygt3wsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:gt3wsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("gt3wsoa");
			setUnlocalizedName("gt3wsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.gt3wsoa";
		}
