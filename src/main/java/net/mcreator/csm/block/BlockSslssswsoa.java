...
public class BlockSslssswsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sslssswsoa")
	public static final Block block = null;
	public BlockSslssswsoa(ElementsCitySuperMod instance) {
		super(instance, 636);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysslssswsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslssswsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslssswsoa");
			setUnlocalizedName("sslssswsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sslssswsoa";
		}
