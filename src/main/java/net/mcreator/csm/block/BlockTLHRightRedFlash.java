...
public class BlockTLHRightRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhrightredflash")
	public static final Block block = null;
	public BlockTLHRightRedFlash(ElementsCitySuperMod instance) {
		super(instance, 434);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhrightredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhrightredflash");
			setUnlocalizedName("tlhrightredflash");
