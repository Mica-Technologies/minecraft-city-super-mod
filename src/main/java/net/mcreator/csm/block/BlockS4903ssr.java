...
public class BlockS4903ssr extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:s4903ssr")
	public static final Block block = null;
	public BlockS4903ssr(ElementsCitySuperMod instance) {
		super(instance, 64);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitys4903ssr");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s4903ssr", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("s4903ssr");
			setUnlocalizedName("s4903ssr");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.s4903ssr";
		}
