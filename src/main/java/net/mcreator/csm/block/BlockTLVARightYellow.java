...
public class BlockTLVARightYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvarightyellow")
	public static final Block block = null;
	public BlockTLVARightYellow(ElementsCitySuperMod instance) {
		super(instance, 513);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvarightyellow", "inventory"));
	}
