...
public class BlockStahsrm extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:stahsrm")
	public static final Block block = null;
	public BlockStahsrm(ElementsCitySuperMod instance) {
		super(instance, 67);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitystahsrm");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:stahsrm", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("stahsrm");
			setUnlocalizedName("stahsrm");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.stahsrm";
		}
