...
public class BlockGt3rnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:gt3rnve")
	public static final Block block = null;
	public BlockGt3rnve(ElementsCitySuperMod instance) {
		super(instance, 618);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitygt3rnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:gt3rnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("gt3rnve");
			setUnlocalizedName("gt3rnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.gt3rnve";
		}
