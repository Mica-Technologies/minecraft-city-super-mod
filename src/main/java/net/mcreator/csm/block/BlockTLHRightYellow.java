...
public class BlockTLHRightYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhrightyellow")
	public static final Block block = null;
	public BlockTLHRightYellow(ElementsCitySuperMod instance) {
		super(instance, 383);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhrightyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhrightyellow");
			setUnlocalizedName("tlhrightyellow");
