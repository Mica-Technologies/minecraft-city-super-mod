...
public class BlockTLHBikeGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhbikegreen")
	public static final Block block = null;
	public BlockTLHBikeGreen(ElementsCitySuperMod instance) {
		super(instance, 404);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhbikegreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhbikegreen");
			setUnlocalizedName("tlhbikegreen");
