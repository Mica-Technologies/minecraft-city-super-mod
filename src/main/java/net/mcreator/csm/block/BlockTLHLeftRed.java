...
public class BlockTLHLeftRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhleftred")
	public static final Block block = null;
	public BlockTLHLeftRed(ElementsCitySuperMod instance) {
		super(instance, 366);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhleftred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhleftred");
			setUnlocalizedName("tlhleftred");
