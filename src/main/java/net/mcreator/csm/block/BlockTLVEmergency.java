...
public class BlockTLVEmergency extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvemergency")
	public static final Block block = null;
	public BlockTLVEmergency(ElementsCitySuperMod instance) {
		super(instance, 381);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvemergency", "inventory"));
	}
