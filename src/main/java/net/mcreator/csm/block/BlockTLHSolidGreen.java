...
public class BlockTLHSolidGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhsolidgreen")
	public static final Block block = null;
	public BlockTLHSolidGreen(ElementsCitySuperMod instance) {
		super(instance, 363);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhsolidgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhsolidgreen");
			setUnlocalizedName("tlhsolidgreen");
