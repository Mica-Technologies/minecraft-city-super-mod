...
public class BlockTLHSolidYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhsolidyellow")
	public static final Block block = null;
	public BlockTLHSolidYellow(ElementsCitySuperMod instance) {
		super(instance, 360);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhsolidyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhsolidyellow");
			setUnlocalizedName("tlhsolidyellow");
