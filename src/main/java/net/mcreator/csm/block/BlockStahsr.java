...
public class BlockStahsr extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:stahsr")
	public static final Block block = null;
	public BlockStahsr(ElementsCitySuperMod instance) {
		super(instance, 68);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitystahsr");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:stahsr", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("stahsr");
			setUnlocalizedName("stahsr");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.stahsr";
		}
