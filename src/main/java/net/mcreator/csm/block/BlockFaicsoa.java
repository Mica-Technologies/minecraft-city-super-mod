...
public class BlockFaicsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:faicsoa")
	public static final Block block = null;
	public BlockFaicsoa(ElementsCitySuperMod instance) {
		super(instance, 633);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityfaicsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:faicsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("faicsoa");
			setUnlocalizedName("faicsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.faicsoa";
		}
