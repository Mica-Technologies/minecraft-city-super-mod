...
import net.mcreator.csm.procedure.ProcedureFA7002Med;
...
public class BlockW7002TNorm extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:w7002tnorm")
	public static final Block block = null;
	public BlockW7002TNorm(ElementsCitySuperMod instance) {
		super(instance, 320);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityw7002tnorm");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:w7002tnorm", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("w7002tnorm");
			setUnlocalizedName("w7002tnorm");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFA7002Med.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.w7002tnorm";
		}
