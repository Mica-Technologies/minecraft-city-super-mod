...
public class BlockTLControllerMatteWhite extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlcontrollermattewhite")
	public static final Block block = null;
	public BlockTLControllerMatteWhite(ElementsCitySuperMod instance) {
		super(instance, 1160);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlcontrollermattewhite"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlcontrollermattewhite", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tlcontrollermattewhite");
