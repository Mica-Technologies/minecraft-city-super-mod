...
import net.mcreator.csm.procedure.ProcedureSmokeDetector;
...
public class BlockKiddesmoke extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:kiddesmoke")
	public static final Block block = null;
	public BlockKiddesmoke(ElementsCitySuperMod instance) {
		super(instance, 46);
	}
