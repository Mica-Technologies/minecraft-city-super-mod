...
public class BlockTLVLeftRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvleftredflash")
	public static final Block block = null;
	public BlockTLVLeftRedFlash(ElementsCitySuperMod instance) {
		super(instance, 427);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvleftredflash", "inventory"));
	}
