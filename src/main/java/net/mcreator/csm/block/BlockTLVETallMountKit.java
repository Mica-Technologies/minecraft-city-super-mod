...
public class BlockTLVETallMountKit extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvetallmountkit")
	public static final Block block = null;
	public BlockTLVETallMountKit(ElementsCitySuperMod instance) {
		super(instance, 887);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlvetallmountkit"));
