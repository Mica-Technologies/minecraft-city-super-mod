...
public class BlockWe50w extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:we50w")
	public static final Block block = null;
	public BlockWe50w(ElementsCitySuperMod instance) {
		super(instance, 93);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywe50w");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:we50w", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("we50w");
			setUnlocalizedName("we50w");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.we50w";
		}
