...
public class BlockTL4VSolidGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vsolidgreen")
	public static final Block block = null;
	public BlockTL4VSolidGreen(ElementsCitySuperMod instance) {
		super(instance, 749);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vsolidgreen", "inventory"));
	}
