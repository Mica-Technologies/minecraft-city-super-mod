...
public class BlockTLHAUpLeftGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaupleftgreen")
	public static final Block block = null;
	public BlockTLHAUpLeftGreen(ElementsCitySuperMod instance) {
		super(instance, 520);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaupleftgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaupleftgreen");
			setUnlocalizedName("tlhaupleftgreen");
