...
public class BlockS4903hs extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:s4903hs")
	public static final Block block = null;
	public BlockS4903hs(ElementsCitySuperMod instance) {
		super(instance, 62);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitys4903hs");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s4903hs", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("s4903hs");
			setUnlocalizedName("s4903hs");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.s4903hs";
		}
