...
public class BlockTLVEMountKit extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvemountkit")
	public static final Block block = null;
	public BlockTLVEMountKit(ElementsCitySuperMod instance) {
		super(instance, 886);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlvemountkit"));
