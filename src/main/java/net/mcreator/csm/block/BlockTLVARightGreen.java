...
public class BlockTLVARightGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvarightgreen")
	public static final Block block = null;
	public BlockTLVARightGreen(ElementsCitySuperMod instance) {
		super(instance, 514);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvarightgreen", "inventory"));
	}
