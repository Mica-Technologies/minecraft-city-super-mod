...
public class BlockEstintwsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:estintwsoa")
	public static final Block block = null;
	public BlockEstintwsoa(ElementsCitySuperMod instance) {
		super(instance, 626);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityestintwsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:estintwsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("estintwsoa");
			setUnlocalizedName("estintwsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.estintwsoa";
		}
