...
import net.mcreator.csm.procedure.ProcedureFireAlarm2901;
...
public class BlockDscn1043 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:dscn1043")
	public static final Block block = null;
	public BlockDscn1043(ElementsCitySuperMod instance) {
		super(instance, 20);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitydscn1043");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:dscn1043", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("dscn1043");
			setUnlocalizedName("dscn1043");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFireAlarm2901.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.dscn1043";
		}
