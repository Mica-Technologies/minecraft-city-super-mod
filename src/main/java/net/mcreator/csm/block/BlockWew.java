...
public class BlockWew extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:wew")
	public static final Block block = null;
	public BlockWew(ElementsCitySuperMod instance) {
		super(instance, 102);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywew");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:wew", "inventory"));
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.wew";
		}
