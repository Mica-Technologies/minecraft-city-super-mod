...
import net.mcreator.csm.procedure.ProcedureFireAlarmOldSimplexVE;
...
public class BlockS4903ssr2 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:s4903ssr2")
	public static final Block block = null;
	public BlockS4903ssr2(ElementsCitySuperMod instance) {
		super(instance, 65);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitys4903ssr2");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s4903ssr2", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("s4903ssr2");
			setUnlocalizedName("s4903ssr2");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFireAlarmOldSimplexVE.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.s4903ssr2";
		}
