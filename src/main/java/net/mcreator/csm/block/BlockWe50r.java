...
public class BlockWe50r extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:we50r")
	public static final Block block = null;
	public BlockWe50r(ElementsCitySuperMod instance) {
		super(instance, 92);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywe50r");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:we50r", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("we50r");
			setUnlocalizedName("we50r");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.we50r";
		}
