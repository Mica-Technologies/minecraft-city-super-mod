...
public class BlockWer extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:wer")
	public static final Block block = null;
	public BlockWer(ElementsCitySuperMod instance) {
		super(instance, 101);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywer");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:wer", "inventory"));
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.wer";
		}
