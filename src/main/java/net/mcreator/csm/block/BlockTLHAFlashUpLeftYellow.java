...
public class BlockTLHAFlashUpLeftYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaflashupleftyellow")
	public static final Block block = null;
	public BlockTLHAFlashUpLeftYellow(ElementsCitySuperMod instance) {
		super(instance, 522);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhaflashupleftyellow", "inventory"));
	}
