...
public class BlockTLVUpLeftGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvupleftgreen")
	public static final Block block = null;
	public BlockTLVUpLeftGreen(ElementsCitySuperMod instance) {
		super(instance, 525);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvupleftgreen", "inventory"));
	}
