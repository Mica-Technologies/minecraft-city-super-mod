...
public class BlockTLYV_SRFlashBroken extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlyv_srflashbroken")
	public static final Block block = null;
	public BlockTLYV_SRFlashBroken(ElementsCitySuperMod instance) {
		super(instance, 671);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlyv_srflashbroken", "inventory"));
	}
