...
public class BlockTLVAFlashRightYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaflashrightyellow")
	public static final Block block = null;
	public BlockTLVAFlashRightYellow(ElementsCitySuperMod instance) {
		super(instance, 516);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvaflashrightyellow", "inventory"));
	}
