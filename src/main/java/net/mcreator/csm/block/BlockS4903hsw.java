...
import net.mcreator.csm.procedure.ProcedureFireAlarm4903;
...
public class BlockS4903hsw extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:s4903hsw")
	public static final Block block = null;
	public BlockS4903hsw(ElementsCitySuperMod instance) {
		super(instance, 63);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitys4903hsw");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s4903hsw", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("s4903hsw");
			setUnlocalizedName("s4903hsw");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFireAlarm4903.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.s4903hsw";
		}
