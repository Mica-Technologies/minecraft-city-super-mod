...
public class BlockTLHAUpLeftYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaupleftyellow")
	public static final Block block = null;
	public BlockTLHAUpLeftYellow(ElementsCitySuperMod instance) {
		super(instance, 519);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaupleftyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaupleftyellow");
			setUnlocalizedName("tlhaupleftyellow");
