...
public class BlockMCLACodeApprovedExitSign extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mclacodeapprovedexitsign")
	public static final Block block = null;
	public BlockMCLACodeApprovedExitSign(ElementsCitySuperMod instance) {
		super(instance, 116);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mclacodeapprovedexitsign"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:mclacodeapprovedexitsign", "inventory"));
	}
