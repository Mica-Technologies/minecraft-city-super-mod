...
public class BlockTLHBikeRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhbikeredflash")
	public static final Block block = null;
	public BlockTLHBikeRedFlash(ElementsCitySuperMod instance) {
		super(instance, 440);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhbikeredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhbikeredflash");
			setUnlocalizedName("tlhbikeredflash");
