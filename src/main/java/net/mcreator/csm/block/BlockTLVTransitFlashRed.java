...
public class BlockTLVTransitFlashRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvtransitflashred")
	public static final Block block = null;
	public BlockTLVTransitFlashRed(ElementsCitySuperMod instance) {
		super(instance, 506);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvtransitflashred", "inventory"));
	}
