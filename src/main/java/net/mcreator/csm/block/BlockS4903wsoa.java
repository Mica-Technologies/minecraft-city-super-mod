...
public class BlockS4903wsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:s4903wsoa")
	public static final Block block = null;
	public BlockS4903wsoa(ElementsCitySuperMod instance) {
		super(instance, 630);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitys4903wsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s4903wsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("s4903wsoa");
			setUnlocalizedName("s4903wsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.s4903wsoa";
		}
