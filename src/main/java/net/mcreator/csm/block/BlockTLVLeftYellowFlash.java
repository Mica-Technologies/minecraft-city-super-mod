...
public class BlockTLVLeftYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvleftyellowflash")
	public static final Block block = null;
	public BlockTLVLeftYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 430);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvleftyellowflash", "inventory"));
	}
