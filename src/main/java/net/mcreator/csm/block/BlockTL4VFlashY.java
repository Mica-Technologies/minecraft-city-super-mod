...
public class BlockTL4VFlashY extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vflashy")
	public static final Block block = null;
	public BlockTL4VFlashY(ElementsCitySuperMod instance) {
		super(instance, 1175);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tl4vflashy"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vflashy", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tl4vflashy");
