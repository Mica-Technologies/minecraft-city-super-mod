...
public class BlockTLHLeftGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhleftgreen")
	public static final Block block = null;
	public BlockTLHLeftGreen(ElementsCitySuperMod instance) {
		super(instance, 376);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhleftgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhleftgreen");
			setUnlocalizedName("tlhleftgreen");
