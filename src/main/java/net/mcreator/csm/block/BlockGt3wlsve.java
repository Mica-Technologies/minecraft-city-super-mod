...
public class BlockGt3wlsve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:gt3wlsve")
	public static final Block block = null;
	public BlockGt3wlsve(ElementsCitySuperMod instance) {
		super(instance, 598);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitygt3wlsve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:gt3wlsve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("gt3wlsve");
			setUnlocalizedName("gt3wlsve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.gt3wlsve";
		}
