...
public class BlockTLVUTurnYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvuturnyellow")
	public static final Block block = null;
	public BlockTLVUTurnYellow(ElementsCitySuperMod instance) {
		super(instance, 409);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvuturnyellow", "inventory"));
	}
