...
public class BlockTLVTallMountKit extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvtallmountkit")
	public static final Block block = null;
	public BlockTLVTallMountKit(ElementsCitySuperMod instance) {
		super(instance, 882);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlvtallmountkit"));
