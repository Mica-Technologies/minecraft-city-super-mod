...
public class BlockTLVLeftGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvleftgreen")
	public static final Block block = null;
	public BlockTLVLeftGreen(ElementsCitySuperMod instance) {
		super(instance, 375);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvleftgreen", "inventory"));
	}
