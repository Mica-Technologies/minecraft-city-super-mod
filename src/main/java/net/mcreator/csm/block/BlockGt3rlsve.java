...
public class BlockGt3rlsve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:gt3rlsve")
	public static final Block block = null;
	public BlockGt3rlsve(ElementsCitySuperMod instance) {
		super(instance, 597);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitygt3rlsve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:gt3rlsve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("gt3rlsve");
			setUnlocalizedName("gt3rlsve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.gt3rlsve";
		}
