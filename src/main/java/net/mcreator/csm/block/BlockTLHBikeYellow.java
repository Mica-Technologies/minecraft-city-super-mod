...
public class BlockTLHBikeYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhbikeyellow")
	public static final Block block = null;
	public BlockTLHBikeYellow(ElementsCitySuperMod instance) {
		super(instance, 401);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhbikeyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhbikeyellow");
			setUnlocalizedName("tlhbikeyellow");
