...
public class BlockTLHUturnRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhuturnred")
	public static final Block block = null;
	public BlockTLHUturnRed(ElementsCitySuperMod instance) {
		super(instance, 407);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhuturnred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhuturnred");
			setUnlocalizedName("tlhuturnred");
