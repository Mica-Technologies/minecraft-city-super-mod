...
public class BlockTLHUturnRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhuturnredflash")
	public static final Block block = null;
	public BlockTLHUturnRedFlash(ElementsCitySuperMod instance) {
		super(instance, 446);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhuturnredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhuturnredflash");
			setUnlocalizedName("tlhuturnredflash");
