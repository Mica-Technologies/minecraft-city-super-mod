...
public class BlockTLHAheadRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaheadredflash")
	public static final Block block = null;
	public BlockTLHAheadRedFlash(ElementsCitySuperMod instance) {
		super(instance, 452);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaheadredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaheadredflash");
			setUnlocalizedName("tlhaheadredflash");
