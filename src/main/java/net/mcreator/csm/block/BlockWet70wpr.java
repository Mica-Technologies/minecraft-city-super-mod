...
public class BlockWet70wpr extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:wet70wpr")
	public static final Block block = null;
	public BlockWet70wpr(ElementsCitySuperMod instance) {
		super(instance, 98);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywet70wpr");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:wet70wpr", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("wet70wpr");
			setUnlocalizedName("wet70wpr");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.wet70wpr";
		}
