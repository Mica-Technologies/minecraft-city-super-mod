...
public class BlockEt70wsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:et70wsoa")
	public static final Block block = null;
	public BlockEt70wsoa(ElementsCitySuperMod instance) {
		super(instance, 644);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityet70wsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:et70wsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("et70wsoa");
			setUnlocalizedName("et70wsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.et70wsoa";
		}
