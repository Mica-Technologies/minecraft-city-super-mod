...
import net.mcreator.csm.procedure.ProcedureFireAlarmMTCode3;
...
public class BlockMtwb extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mtwb")
	public static final Block block = null;
	public BlockMtwb(ElementsCitySuperMod instance) {
		super(instance, 105);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitymtwb");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:mtwb", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("mtwb");
			setUnlocalizedName("mtwb");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFireAlarmMTCode3.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.mtwb";
		}
