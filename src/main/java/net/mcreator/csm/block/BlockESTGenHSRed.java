...
public class BlockESTGenHSRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:estgenhsred")
	public static final Block block = null;
	public BlockESTGenHSRed(ElementsCitySuperMod instance) {
		super(instance, 21);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityestgenhsred");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:estgenhsred", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("estgenhsred");
			setUnlocalizedName("estgenhsred");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.estgenhsred";
		}
