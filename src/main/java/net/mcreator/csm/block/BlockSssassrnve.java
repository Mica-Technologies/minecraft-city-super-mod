...
public class BlockSssassrnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sssassrnve")
	public static final Block block = null;
	public BlockSssassrnve(ElementsCitySuperMod instance) {
		super(instance, 609);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysssassrnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sssassrnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sssassrnve");
			setUnlocalizedName("sssassrnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sssassrnve";
		}
