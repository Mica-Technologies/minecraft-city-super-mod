...
public class BlockTL4VSolidYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vsolidyellow")
	public static final Block block = null;
	public BlockTL4VSolidYellow(ElementsCitySuperMod instance) {
		super(instance, 748);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vsolidyellow", "inventory"));
	}
