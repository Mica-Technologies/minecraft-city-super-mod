...
public class BlockTLHAheadGreenFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhaheadgreenflash")
	public static final Block block = null;
	public BlockTLHAheadGreenFlash(ElementsCitySuperMod instance) {
		super(instance, 458);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaheadgreenflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaheadgreenflash");
			setUnlocalizedName("tlhaheadgreenflash");
