...
public class BlockS2910hs extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:s2910hs")
	public static final Block block = null;
	public BlockS2910hs(ElementsCitySuperMod instance) {
		super(instance, 61);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitys2910hs");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s2910hs", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("s2910hs");
			setUnlocalizedName("s2910hs");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.s2910hs";
		}
