...
public class BlockTLVBikeYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvbikeyellowflash")
	public static final Block block = null;
	public BlockTLVBikeYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 442);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvbikeyellowflash", "inventory"));
	}
