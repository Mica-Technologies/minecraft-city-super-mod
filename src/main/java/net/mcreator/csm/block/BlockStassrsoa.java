...
public class BlockStassrsoa extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:stassrsoa")
	public static final Block block = null;
	public BlockStassrsoa(ElementsCitySuperMod instance) {
		super(instance, 635);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitystassrsoa");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:stassrsoa", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("stassrsoa");
			setUnlocalizedName("stassrsoa");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.stassrsoa";
		}
