...
public class BlockTLYV_SRBroken extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlyv_srbroken")
	public static final Block block = null;
	public BlockTLYV_SRBroken(ElementsCitySuperMod instance) {
		super(instance, 670);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlyv_srbroken", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlyv_srbroken");
			setUnlocalizedName("tlyv_srbroken");
