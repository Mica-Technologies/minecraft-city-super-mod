...
public class BlockTLHUTurnYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhuturnyellowflash")
	public static final Block block = null;
	public BlockTLHUTurnYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 449);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhuturnyellowflash", "inventory"));
	}
