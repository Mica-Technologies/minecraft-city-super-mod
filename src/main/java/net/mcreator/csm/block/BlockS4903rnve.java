...
public class BlockS4903rnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:s4903rnve")
	public static final Block block = null;
	public BlockS4903rnve(ElementsCitySuperMod instance) {
		super(instance, 610);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitys4903rnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s4903rnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("s4903rnve");
			setUnlocalizedName("s4903rnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.s4903rnve";
		}
