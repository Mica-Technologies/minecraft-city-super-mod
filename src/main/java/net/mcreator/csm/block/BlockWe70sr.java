...
public class BlockWe70sr extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:we70sr")
	public static final Block block = null;
	public BlockWe70sr(ElementsCitySuperMod instance) {
		super(instance, 96);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywe70sr");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:we70sr", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("we70sr");
			setUnlocalizedName("we70sr");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.we70sr";
		}
