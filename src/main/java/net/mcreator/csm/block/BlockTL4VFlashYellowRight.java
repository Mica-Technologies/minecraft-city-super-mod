...
public class BlockTL4VFlashYellowRight extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vflashyellowright")
	public static final Block block = null;
	public BlockTL4VFlashYellowRight(ElementsCitySuperMod instance) {
		super(instance, 1178);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tl4vflashyellowright"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tl4vflashyellowright", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tl4vflashyellowright");
