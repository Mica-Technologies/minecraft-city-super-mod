...
public class BlockTLHRightRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhrightred")
	public static final Block block = null;
	public BlockTLHRightRed(ElementsCitySuperMod instance) {
		super(instance, 379);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhrightred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhrightred");
			setUnlocalizedName("tlhrightred");
