...
public class BlockTLHLeftRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlhleftredflash")
	public static final Block block = null;
	public BlockTLHLeftRedFlash(ElementsCitySuperMod instance) {
		super(instance, 428);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhleftredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhleftredflash");
			setUnlocalizedName("tlhleftredflash");
