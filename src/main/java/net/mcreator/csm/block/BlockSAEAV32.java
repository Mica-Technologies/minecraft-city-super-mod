...
import net.mcreator.csm.procedure.ProcedureFASAE;
...
public class BlockSAEAV32 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:saeav32")
	public static final Block block = null;
	public BlockSAEAV32(ElementsCitySuperMod instance) {
		super(instance, 305);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysaeav32");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:saeav32", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("saeav32");
			setUnlocalizedName("saeav32");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFASAE.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.saeav32";
		}
