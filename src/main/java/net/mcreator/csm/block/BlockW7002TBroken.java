...
import net.mcreator.csm.procedure.ProcedureFA7002Broken;
...
public class BlockW7002TBroken extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:w7002tbroken")
	public static final Block block = null;
	public BlockW7002TBroken(ElementsCitySuperMod instance) {
		super(instance, 334);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityw7002tbroken");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:w7002tbroken", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("w7002tbroken");
			setUnlocalizedName("w7002tbroken");
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureFA7002Broken.executeProcedure($_dependencies);
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.w7002tbroken";
		}
