...
public class BlockSslssswnve extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:sslssswnve")
	public static final Block block = null;
	public BlockSslssswnve(ElementsCitySuperMod instance) {
		super(instance, 617);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitysslssswnve");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslssswnve", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslssswnve");
			setUnlocalizedName("sslssswnve");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.sslssswnve";
		}
