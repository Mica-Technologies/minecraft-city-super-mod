...
public class BlockTLVUTurnYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvuturnyellowflash")
	public static final Block block = null;
	public BlockTLVUTurnYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 448);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvuturnyellowflash", "inventory"));
	}
