...
public class BlockTLVBikeRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvbikeredflash")
	public static final Block block = null;
	public BlockTLVBikeRedFlash(ElementsCitySuperMod instance) {
		super(instance, 439);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvbikeredflash", "inventory"));
	}
