...
public class BlockCreeStylusFull extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:creestylusfull")
	public static final Block block = null;
	public BlockCreeStylusFull(ElementsCitySuperMod instance) {
		super(instance, 719);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:creestylusfull", "inventory"));
	}
