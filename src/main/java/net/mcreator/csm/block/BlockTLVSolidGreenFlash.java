...
public class BlockTLVSolidGreenFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvsolidgreenflash")
	public static final Block block = null;
	public BlockTLVSolidGreenFlash(ElementsCitySuperMod instance) {
		super(instance, 424);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidgreenflash", "inventory"));
	}
