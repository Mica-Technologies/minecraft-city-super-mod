...
public class BlockWet70wpw extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:wet70wpw")
	public static final Block block = null;
	public BlockWet70wpw(ElementsCitySuperMod instance) {
		super(instance, 99);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywet70wpw");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:wet70wpw", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("wet70wpw");
			setUnlocalizedName("wet70wpw");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.wet70wpw";
		}
