...
public class BlockWheelockWhiteET70SS extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:wheelockwhiteet70ss")
	public static final Block block = null;
	public BlockWheelockWhiteET70SS(ElementsCitySuperMod instance) {
		super(instance, 303);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentitywheelockwhiteet70ss");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:wheelockwhiteet70ss", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("wheelockwhiteet70ss");
			setUnlocalizedName("wheelockwhiteet70ss");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.wheelockwhiteet70ss";
		}
		...
		public String getGuiID() {
			return "csm:wheelockwhiteet70ss";
		}
