...
public class MCreatorTLVAFlashRightYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvaflashrightyellow")
	public static final Block block = null;

	public MCreatorTLVAFlashRightYellow(Elementscsm instance) {
		super(instance, 516);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaflashrightyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvaflashrightyellow");
			setUnlocalizedName("tlvaflashrightyellow");
