...
public class MCreatorTLHLeftYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhleftyellowflash")
	public static final Block block = null;

	public MCreatorTLHLeftYellowFlash(Elementscsm instance) {
		super(instance, 431);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhleftyellowflash",
				"inventory"));
	}
