...
public class MCreatorTLBorderBlackBlack extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tlborderblackblack")
	public static final Block block = null;

	public MCreatorTLBorderBlackBlack(Elementscsm instance) {
		super(instance, 877);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlborderblackblack");
