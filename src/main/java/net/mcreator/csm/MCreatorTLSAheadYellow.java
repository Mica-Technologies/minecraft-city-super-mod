...
public class MCreatorTLSAheadYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsaheadyellow")
	public static final Block block = null;

	public MCreatorTLSAheadYellow(Elementscsm instance) {
		super(instance, 393);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsaheadyellow",
				"inventory"));
	}
