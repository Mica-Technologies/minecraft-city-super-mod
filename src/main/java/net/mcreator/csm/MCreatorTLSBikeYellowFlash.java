...
public class MCreatorTLSBikeYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsbikeyellowflash")
	public static final Block block = null;

	public MCreatorTLSBikeYellowFlash(Elementscsm instance) {
		super(instance, 444);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsbikeyellowflash",
				"inventory"));
	}
