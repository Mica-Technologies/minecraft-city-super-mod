...
public class MCreatorTrafficStreetNameSignMount extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:trafficstreetnamesignmount")
	public static final Block block = null;

	public MCreatorTrafficStreetNameSignMount(Elementscsm instance) {
		super(instance, 559);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation(
				"csm:trafficstreetnamesignmount", "inventory"));
	}
