...
public class MCreatorTLVUpLeftYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvupleftyellow")
	public static final Block block = null;

	public MCreatorTLVUpLeftYellow(Elementscsm instance) {
		super(instance, 524);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvupleftyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvupleftyellow");
			setUnlocalizedName("tlvupleftyellow");
