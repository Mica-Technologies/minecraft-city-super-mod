...
public class MCreatorHB2 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:hb2")
	public static final Block block = null;

	public MCreatorHB2(Elementscsm instance) {
		super(instance, 744);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:hb2", "inventory"));
	}
