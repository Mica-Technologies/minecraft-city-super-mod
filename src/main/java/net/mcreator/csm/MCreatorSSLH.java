...
public class MCreatorSSLH extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:sslh")
	public static final Block block = null;

	public MCreatorSSLH(Elementscsm instance) {
		super(instance, 738);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslh", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslh");
			setUnlocalizedName("sslh");
