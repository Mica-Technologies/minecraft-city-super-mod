...
public class MCreatorTLDGreenSolidLeftGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldgreensolidleftgreen")
	public static final Block block = null;

	public MCreatorTLDGreenSolidLeftGreen(Elementscsm instance) {
		super(instance, 474);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldgreensolidleftgreen",
				"inventory"));
	}
