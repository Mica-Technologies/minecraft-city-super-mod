...
public class MCreatorCEHalo extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:cehalo")
	public static final Block block = null;

	public MCreatorCEHalo(Elementscsm instance) {
		super(instance, 717);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:cehalo", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("cehalo");
			setUnlocalizedName("cehalo");
