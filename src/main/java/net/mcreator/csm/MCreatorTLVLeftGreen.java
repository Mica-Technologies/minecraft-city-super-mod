...
public class MCreatorTLVLeftGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvleftgreen")
	public static final Block block = null;

	public MCreatorTLVLeftGreen(Elementscsm instance) {
		super(instance, 375);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvleftgreen", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvleftgreen");
			setUnlocalizedName("tlvleftgreen");
