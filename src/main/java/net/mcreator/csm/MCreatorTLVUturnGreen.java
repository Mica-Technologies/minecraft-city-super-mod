...
public class MCreatorTLVUturnGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvuturngreen")
	public static final Block block = null;

	public MCreatorTLVUturnGreen(Elementscsm instance) {
		super(instance, 412);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvuturngreen", "inventory"));
	}
