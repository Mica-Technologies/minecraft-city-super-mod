...
public class MCreatorTLHAheadYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhaheadyellow")
	public static final Block block = null;

	public MCreatorTLHAheadYellow(Elementscsm instance) {
		super(instance, 392);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaheadyellow",
				"inventory"));
	}
