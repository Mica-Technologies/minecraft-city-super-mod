...
public class MCreatorAppleTV extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:appletv")
	public static final Block block = null;

	public MCreatorAppleTV(Elementscsm instance) {
		super(instance, 68);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:appletv", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("appletv");
			setUnlocalizedName("appletv");
