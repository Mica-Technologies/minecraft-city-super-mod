...
public class MCreatorTLVRightYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvrightyellow")
	public static final Block block = null;

	public MCreatorTLVRightYellow(Elementscsm instance) {
		super(instance, 382);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvrightyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvrightyellow");
			setUnlocalizedName("tlvrightyellow");
