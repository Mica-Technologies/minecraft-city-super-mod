...
public class MCreatorWheelockRedET70SS extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:wheelockredet70ss")
	public static final Block block = null;

	public MCreatorWheelockRedET70SS(Elementscsm instance) {
		super(instance, 302);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:wheelockredet70ss",
				"inventory"));
	}
