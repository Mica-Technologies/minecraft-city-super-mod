...
public class MCreatorTLHAheadYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhaheadyellowflash")
	public static final Block block = null;

	public MCreatorTLHAheadYellowFlash(Elementscsm instance) {
		super(instance, 455);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaheadyellowflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaheadyellowflash");
			setUnlocalizedName("tlhaheadyellowflash");
