...
public class MCreatorTLVBikeYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvbikeyellow")
	public static final Block block = null;

	public MCreatorTLVBikeYellow(Elementscsm instance) {
		super(instance, 400);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvbikeyellow", "inventory"));
	}
