...
public class MCreatorTLVSolidBrokenRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvsolidbrokenred")
	public static final Block block = null;

	public MCreatorTLVSolidBrokenRed(Elementscsm instance) {
		super(instance, 528);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidbrokenred",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvsolidbrokenred");
			setUnlocalizedName("tlvsolidbrokenred");
