...
public class MCreatorSigndeer extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signdeer")
	public static final Block block = null;

	public MCreatorSigndeer(Elementscsm instance) {
		super(instance, 467);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signdeer");
			setUnlocalizedName("signdeer");
