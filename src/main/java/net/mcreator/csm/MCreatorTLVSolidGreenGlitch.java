...
public class MCreatorTLVSolidGreenGlitch extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvsolidgreenglitch")
	public static final Block block = null;

	public MCreatorTLVSolidGreenGlitch(Elementscsm instance) {
		super(instance, 675);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidgreenglitch",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvsolidgreenglitch");
			setUnlocalizedName("tlvsolidgreenglitch");
