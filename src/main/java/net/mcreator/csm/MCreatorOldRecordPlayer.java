...
public class MCreatorOldRecordPlayer extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:oldrecordplayer")
	public static final Block block = null;

	public MCreatorOldRecordPlayer(Elementscsm instance) {
		super(instance, 1114);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("oldrecordplayer");
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			Block block = this;
			{
				...
				MCreatorOldRecordPlayerSounds.executeProcedure($_dependencies);
			}
			return true;
		}
	}
