...
public class MCreatorTLVTransitGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvtransitgreen")
	public static final Block block = null;

	public MCreatorTLVTransitGreen(Elementscsm instance) {
		super(instance, 505);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvtransitgreen",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvtransitgreen");
			setUnlocalizedName("tlvtransitgreen");
