...
public class MCreatorTLVBikeYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvbikeyellowflash")
	public static final Block block = null;

	public MCreatorTLVBikeYellowFlash(Elementscsm instance) {
		super(instance, 442);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvbikeyellowflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvbikeyellowflash");
			setUnlocalizedName("tlvbikeyellowflash");
