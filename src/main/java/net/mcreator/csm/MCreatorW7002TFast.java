...
public class MCreatorW7002TFast extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:w7002tfast")
	public static final Block block = null;

	public MCreatorW7002TFast(Elementscsm instance) {
		super(instance, 321);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFA7002Reg.executeProcedure($_dependencies);
