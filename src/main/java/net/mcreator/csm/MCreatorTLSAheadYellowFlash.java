...
public class MCreatorTLSAheadYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsaheadyellowflash")
	public static final Block block = null;

	public MCreatorTLSAheadYellowFlash(Elementscsm instance) {
		super(instance, 456);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsaheadyellowflash",
				"inventory"));
	}
