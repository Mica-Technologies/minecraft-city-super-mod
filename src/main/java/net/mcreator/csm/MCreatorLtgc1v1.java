...
public class MCreatorLtgc1v1 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:ltgc1v1")
	public static final Block block = null;

	public MCreatorLtgc1v1(Elementscsm instance) {
		super(instance, 292);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ltgc1v1", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("ltgc1v1");
			setUnlocalizedName("ltgc1v1");
