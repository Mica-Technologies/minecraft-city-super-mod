...
public class MCreatorTLDGreenSolidLeftYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldgreensolidleftyellow")
	public static final Block block = null;

	public MCreatorTLDGreenSolidLeftYellow(Elementscsm instance) {
		super(instance, 475);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldgreensolidleftyellow",
				"inventory"));
	}
