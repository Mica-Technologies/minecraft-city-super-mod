...
public class MCreatorSignonbridge extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signonbridge")
	public static final Block block = null;

	public MCreatorSignonbridge(Elementscsm instance) {
		super(instance, 346);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signonbridge");
			setUnlocalizedName("signonbridge");
