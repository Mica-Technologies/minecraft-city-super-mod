...
public class MCreatorTLSUturnYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsuturnyellow")
	public static final Block block = null;

	public MCreatorTLSUturnYellow(Elementscsm instance) {
		super(instance, 411);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsuturnyellow",
				"inventory"));
	}
