...
public class MCreatorTLDRedSolidRightYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldredsolidrightyellow")
	public static final Block block = null;

	public MCreatorTLDRedSolidRightYellow(Elementscsm instance) {
		super(instance, 471);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldredsolidrightyellow",
				"inventory"));
	}
