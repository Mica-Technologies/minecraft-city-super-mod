...
public class MCreatorTLSAheadRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsaheadredflash")
	public static final Block block = null;

	public MCreatorTLSAheadRedFlash(Elementscsm instance) {
		super(instance, 453);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsaheadredflash",
				"inventory"));
	}
