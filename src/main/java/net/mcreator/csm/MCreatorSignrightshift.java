...
public class MCreatorSignrightshift extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signrightshift")
	public static final Block block = null;

	public MCreatorSignrightshift(Elementscsm instance) {
		super(instance, 446);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signrightshift");
			setUnlocalizedName("signrightshift");
