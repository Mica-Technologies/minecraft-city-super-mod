...
public class MCreatorTLHUturnRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhuturnredflash")
	public static final Block block = null;

	public MCreatorTLHUturnRedFlash(Elementscsm instance) {
		super(instance, 446);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhuturnredflash",
				"inventory"));
	}
