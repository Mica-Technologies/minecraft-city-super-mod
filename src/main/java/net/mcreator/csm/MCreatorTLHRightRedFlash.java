...
public class MCreatorTLHRightRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhrightredflash")
	public static final Block block = null;

	public MCreatorTLHRightRedFlash(Elementscsm instance) {
		super(instance, 434);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhrightredflash",
				"inventory"));
	}
