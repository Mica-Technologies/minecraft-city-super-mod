...
public class MCreatorTLHAFlashUpLeftYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhaflashupleftyellow")
	public static final Block block = null;

	public MCreatorTLHAFlashUpLeftYellow(Elementscsm instance) {
		super(instance, 522);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaflashupleftyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhaflashupleftyellow");
			setUnlocalizedName("tlhaflashupleftyellow");
			...
			setLightLevel(0F);
			setLightOpacity(0);
			setCreativeTab(MCreatorTrafficSignalsHorizontal.tab);
