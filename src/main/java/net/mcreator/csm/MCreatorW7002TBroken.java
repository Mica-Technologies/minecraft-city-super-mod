...
public class MCreatorW7002TBroken extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:w7002tbroken")
	public static final Block block = null;

	public MCreatorW7002TBroken(Elementscsm instance) {
		super(instance, 334);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:w7002tbroken", "inventory"));
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFA7002Broken.executeProcedure($_dependencies);
