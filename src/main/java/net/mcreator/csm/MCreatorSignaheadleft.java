...
public class MCreatorSignaheadleft extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signaheadleft")
	public static final Block block = null;

	public MCreatorSignaheadleft(Elementscsm instance) {
		super(instance, 440);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signaheadleft");
			setUnlocalizedName("signaheadleft");
