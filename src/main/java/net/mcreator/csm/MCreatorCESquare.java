...
public class MCreatorCESquare extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:cesquare")
	public static final Block block = null;

	public MCreatorCESquare(Elementscsm instance) {
		super(instance, 718);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:cesquare", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("cesquare");
			setUnlocalizedName("cesquare");
