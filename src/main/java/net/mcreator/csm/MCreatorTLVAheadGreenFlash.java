...
public class MCreatorTLVAheadGreenFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvaheadgreenflash")
	public static final Block block = null;

	public MCreatorTLVAheadGreenFlash(Elementscsm instance) {
		super(instance, 457);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaheadgreenflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvaheadgreenflash");
			setUnlocalizedName("tlvaheadgreenflash");
