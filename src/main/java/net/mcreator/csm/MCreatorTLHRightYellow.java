...
public class MCreatorTLHRightYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhrightyellow")
	public static final Block block = null;

	public MCreatorTLHRightYellow(Elementscsm instance) {
		super(instance, 383);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhrightyellow",
				"inventory"));
	}
