...
public class MCreatorTLSAheadGreenFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsaheadgreenflash")
	public static final Block block = null;

	public MCreatorTLSAheadGreenFlash(Elementscsm instance) {
		super(instance, 459);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsaheadgreenflash",
				"inventory"));
	}
