...
public class MCreatorGEELSN extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:geelsn")
	public static final Block block = null;

	public MCreatorGEELSN(Elementscsm instance) {
		super(instance, 1070);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:geelsn", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("geelsn");
			setUnlocalizedName("geelsn");
