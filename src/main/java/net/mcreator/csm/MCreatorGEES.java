...
public class MCreatorGEES extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:gees")
	public static final Block block = null;

	public MCreatorGEES(Elementscsm instance) {
		super(instance, 289);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:gees", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("gees");
			setUnlocalizedName("gees");
