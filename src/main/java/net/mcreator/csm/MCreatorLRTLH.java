...
public class MCreatorLRTLH extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:lrtlh")
	public static final Block block = null;

	public MCreatorLRTLH(Elementscsm instance) {
		super(instance, 735);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:lrtlh", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("lrtlh");
			setUnlocalizedName("lrtlh");
