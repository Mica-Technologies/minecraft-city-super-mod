...
public class MCreatorSilverMetalFence extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:silvermetalfence")
	public static final Block block = null;

	public MCreatorSilverMetalFence(Elementscsm instance) {
		super(instance, 749);
	}
	...
	public static class BlockCustom extends BlockFence {
		public BlockCustom() {
			...
			setRegistryName("silvermetalfence");
