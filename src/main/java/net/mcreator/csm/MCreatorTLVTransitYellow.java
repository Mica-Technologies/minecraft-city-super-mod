...
public class MCreatorTLVTransitYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvtransityellow")
	public static final Block block = null;

	public MCreatorTLVTransitYellow(Elementscsm instance) {
		super(instance, 504);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvtransityellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvtransityellow");
			setUnlocalizedName("tlvtransityellow");
