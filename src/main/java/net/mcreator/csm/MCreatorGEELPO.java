...
public class MCreatorGEELPO extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:geelpo")
	public static final Block block = null;

	public MCreatorGEELPO(Elementscsm instance) {
		super(instance, 1071);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:geelpo", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("geelpo");
			setUnlocalizedName("geelpo");
