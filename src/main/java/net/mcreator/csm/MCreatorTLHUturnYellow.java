...
public class MCreatorTLHUturnYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhuturnyellow")
	public static final Block block = null;

	public MCreatorTLHUturnYellow(Elementscsm instance) {
		super(instance, 410);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhuturnyellow",
				"inventory"));
	}
