...
public class MCreatorTLHBikeYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhbikeyellowflash")
	public static final Block block = null;

	public MCreatorTLHBikeYellowFlash(Elementscsm instance) {
		super(instance, 443);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhbikeyellowflash",
				"inventory"));
	}
