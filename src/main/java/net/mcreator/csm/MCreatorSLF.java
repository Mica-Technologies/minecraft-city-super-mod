...
public class MCreatorSLF extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:slf")
	public static final Block block = null;

	public MCreatorSLF(Elementscsm instance) {
		super(instance, 740);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:slf", "inventory"));
	}
