...
public class MCreatorAdaptahornRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:adaptahornred")
	public static final Block block = null;

	public MCreatorAdaptahornRed(Elementscsm instance) {
		super(instance,319);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:adaptahornred", "inventory"));
	}
