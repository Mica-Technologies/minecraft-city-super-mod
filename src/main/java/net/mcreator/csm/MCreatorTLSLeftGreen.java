...
public class MCreatorTLSLeftGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsleftgreen")
	public static final Block block = null;

	public MCreatorTLSLeftGreen(Elementscsm instance) {
		super(instance, 377);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsleftgreen", "inventory"));
	}
