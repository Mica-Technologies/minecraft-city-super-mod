...
public class MCreatorFAESTINTRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:faestintred")
	public static final Block block = null;

	public MCreatorFAESTINTRed(Elementscsm instance) {
		super(instance,5);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarmESTIntegrity.executeProcedure($_dependencies);
