...
public class MCreatorS4903ssr2 extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:s4903ssr2")
	public static final Block block = null;

	public MCreatorS4903ssr2(Elementscsm instance) {
		super(instance, 65);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarmOldSimplexVE.executeProcedure($_dependencies);
