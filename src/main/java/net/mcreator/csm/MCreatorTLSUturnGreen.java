...
public class MCreatorTLSUturnGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsuturngreen")
	public static final Block block = null;

	public MCreatorTLSUturnGreen(Elementscsm instance) {
		super(instance, 414);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlsuturngreen", "inventory"));
	}
