...
public class MCreatorFCIPull extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:fcipull")
	public static final Block block = null;

	public MCreatorFCIPull(Elementscsm instance) {
		super(instance, 314);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "csm:tileentityfcipull");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:fcipull", "inventory"));
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("fcipull");
			setUnlocalizedName("fcipull");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.fcipull";
		}
