...
public class MCreatorLtec extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:ltec")
	public static final Block block = null;

	public MCreatorLtec(Elementscsm instance) {
		super(instance, 564);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ltec", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("ltec");
			setUnlocalizedName("ltec");
