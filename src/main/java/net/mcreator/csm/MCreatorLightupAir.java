...
public class MCreatorLightupAir extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:lightupair")
	public static final Block block = null;

	public MCreatorLightupAir(Elementscsm instance) {
		super(instance, 1062);
	}
	...
	public static class BlockCustom extends Block {
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			switch ((EnumFacing) state.getValue(BlockDirectional.FACING)) {
				...
				case UP :
					return new AxisAlignedBB(0D, 1D, 0D, 0D, 1D, 0.05D);
				case DOWN :
					return new AxisAlignedBB(0D, 0D, 1D, 0D, 0D, 0.95D);
			}
		}
