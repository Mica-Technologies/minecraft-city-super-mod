...
public class MCreatorTLVBikeGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvbikegreen")
	public static final Block block = null;

	public MCreatorTLVBikeGreen(Elementscsm instance) {
		super(instance, 403);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvbikegreen", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvbikegreen");
			setUnlocalizedName("tlvbikegreen");
