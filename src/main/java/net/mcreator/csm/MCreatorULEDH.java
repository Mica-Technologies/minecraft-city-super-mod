...
public class MCreatorULEDH extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:uledh")
	public static final Block block = null;

	public MCreatorULEDH(Elementscsm instance) {
		super(instance, 746);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:uledh", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("uledh");
			setUnlocalizedName("uledh");
