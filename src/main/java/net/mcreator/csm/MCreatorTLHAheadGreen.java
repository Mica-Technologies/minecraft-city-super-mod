...
public class MCreatorTLHAheadGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhaheadgreen")
	public static final Block block = null;

	public MCreatorTLHAheadGreen(Elementscsm instance) {
		super(instance, 395);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhaheadgreen", "inventory"));
	}
