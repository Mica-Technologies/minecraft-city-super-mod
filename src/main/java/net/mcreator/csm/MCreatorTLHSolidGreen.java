...
public class MCreatorTLHSolidGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhsolidgreen")
	public static final Block block = null;

	public MCreatorTLHSolidGreen(Elementscsm instance) {
		super(instance, 363);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhsolidgreen", "inventory"));
	}
