...
public class MCreatorS4903v2HornStrobe extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:s4903v2hornstrobe")
	public static final Block block = null;

	public MCreatorS4903v2HornStrobe(Elementscsm instance) {
		super(instance, 509);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:s4903v2hornstrobe",
				"inventory"));
	}
