...
public class MCreatorTrafficLightSensor extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:trafficlightsensor")
	public static final Block block = null;

	public MCreatorTrafficLightSensor(Elementscsm instance) {
		super(instance, 654);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("trafficlightsensor");
