...
public class MCreatorTLHRightYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhrightyellowflash")
	public static final Block block = null;

	public MCreatorTLHRightYellowFlash(Elementscsm instance) {
		super(instance, 437);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhrightyellowflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhrightyellowflash");
			setUnlocalizedName("tlhrightyellowflash");
