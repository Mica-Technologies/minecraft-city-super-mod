...
public class MCreatorTLSUTurnYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsuturnyellowflash")
	public static final Block block = null;

	public MCreatorTLSUTurnYellowFlash(Elementscsm instance) {
		super(instance, 450);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsuturnyellowflash",
				"inventory"));
	}
