...
public class MCreatorTLVAheadYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvaheadyellow")
	public static final Block block = null;

	public MCreatorTLVAheadYellow(Elementscsm instance) {
		super(instance, 391);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaheadyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvaheadyellow");
			setUnlocalizedName("tlvaheadyellow");
