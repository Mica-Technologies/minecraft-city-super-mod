...
public class MCreatorLGTLH extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:lgtlh")
	public static final Block block = null;

	public MCreatorLGTLH(Elementscsm instance) {
		super(instance, 733);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:lgtlh", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("lgtlh");
			setUnlocalizedName("lgtlh");
