...
public class MCreatorTL4VGRG extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vgrg")
	public static final Block block = null;

	public MCreatorTL4VGRG(Elementscsm instance) {
		super(instance, 754);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vgrg", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vgrg");
			setUnlocalizedName("tl4vgrg");
