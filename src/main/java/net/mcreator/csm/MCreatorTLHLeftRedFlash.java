...
public class MCreatorTLHLeftRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhleftredflash")
	public static final Block block = null;

	public MCreatorTLHLeftRedFlash(Elementscsm instance) {
		super(instance, 428);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhleftredflash",
				"inventory"));
	}
