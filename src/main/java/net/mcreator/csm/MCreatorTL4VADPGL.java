...
public class MCreatorTL4VADPGL extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vadpgl")
	public static final Block block = null;

	public MCreatorTL4VADPGL(Elementscsm instance) {
		super(instance, 758);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vadpgl", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vadpgl");
			setUnlocalizedName("tl4vadpgl");
