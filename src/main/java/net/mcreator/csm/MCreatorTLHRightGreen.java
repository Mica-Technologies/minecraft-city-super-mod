...
public class MCreatorTLHRightGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhrightgreen")
	public static final Block block = null;

	public MCreatorTLHRightGreen(Elementscsm instance) {
		super(instance,386);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhrightgreen", "inventory"));
	}
