...
public class MCreatorTLSLeftYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsleftyellow")
	public static final Block block = null;

	public MCreatorTLSLeftYellow(Elementscsm instance) {
		super(instance, 374);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlsleftyellow", "inventory"));
	}
