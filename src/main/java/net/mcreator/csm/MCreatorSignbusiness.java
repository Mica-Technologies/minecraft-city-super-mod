...
public class MCreatorSignbusiness extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signbusiness")
	public static final Block block = null;

	public MCreatorSignbusiness(Elementscsm instance) {
		super(instance, 419);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signbusiness");
			setUnlocalizedName("signbusiness");
