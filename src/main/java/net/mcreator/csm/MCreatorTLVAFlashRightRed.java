...
public class MCreatorTLVAFlashRightRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvaflashrightred")
	public static final Block block = null;

	public MCreatorTLVAFlashRightRed(Elementscsm instance) {
		super(instance, 515);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaflashrightred",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvaflashrightred");
			setUnlocalizedName("tlvaflashrightred");
