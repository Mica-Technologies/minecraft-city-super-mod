...
public class MCreatorTLSBikeRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsbikeredflash")
	public static final Block block = null;

	public MCreatorTLSBikeRedFlash(Elementscsm instance) {
		super(instance, 441);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsbikeredflash",
				"inventory"));
	}
