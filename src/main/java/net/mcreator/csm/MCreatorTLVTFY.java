...
public class MCreatorTLVTFY extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvtfy")
	public static final Block block = null;

	public MCreatorTLVTFY(Elementscsm instance) {
		super(instance, 760);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvtfy", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvtfy");
			setUnlocalizedName("tlvtfy");
