...
public class MCreatorSignpostspeed30 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:signpostspeed30")
	public static final Block block = null;

	public MCreatorSignpostspeed30(Elementscsm instance) {
		super(instance, 278);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("signpostspeed30");
			setUnlocalizedName("signpostspeed30");
