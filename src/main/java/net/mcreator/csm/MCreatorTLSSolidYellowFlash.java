...
public class MCreatorTLSSolidYellowFlash extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tlssolidyellowflash")
	public static final Block block = null;

	public MCreatorTLSSolidYellowFlash(Elementscsm instance) {
		super(instance, 423);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlssolidyellowflash",
				"inventory"));
	}
