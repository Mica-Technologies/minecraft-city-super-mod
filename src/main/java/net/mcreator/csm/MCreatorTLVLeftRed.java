...
public class MCreatorTLVLeftRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvleftred")
	public static final Block block = null;

	public MCreatorTLVLeftRed(Elementscsm instance) {
		super(instance, 365);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvleftred", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvleftred");
			setUnlocalizedName("tlvleftred");
