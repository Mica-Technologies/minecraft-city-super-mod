...
public class MCreatorTLHAheadGreenFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhaheadgreenflash")
	public static final Block block = null;

	public MCreatorTLHAheadGreenFlash(Elementscsm instance) {
		super(instance, 458);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaheadgreenflash",
				"inventory"));
	}
