...
public class MCreatorTLHAheadRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhaheadredflash")
	public static final Block block = null;

	public MCreatorTLHAheadRedFlash(Elementscsm instance) {
		super(instance, 452);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhaheadredflash",
				"inventory"));
	}
