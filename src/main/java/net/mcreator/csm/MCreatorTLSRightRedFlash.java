...
public class MCreatorTLSRightRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsrightredflash")
	public static final Block block = null;

	public MCreatorTLSRightRedFlash(Elementscsm instance) {
		super(instance, 435);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsrightredflash",
				"inventory"));
	}
