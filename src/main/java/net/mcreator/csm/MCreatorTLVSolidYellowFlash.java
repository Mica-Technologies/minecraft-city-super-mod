...
public class MCreatorTLVSolidYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvsolidyellowflash")
	public static final Block block = null;

	public MCreatorTLVSolidYellowFlash(Elementscsm instance) {
		super(instance, 421);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidyellowflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvsolidyellowflash");
			setUnlocalizedName("tlvsolidyellowflash");
