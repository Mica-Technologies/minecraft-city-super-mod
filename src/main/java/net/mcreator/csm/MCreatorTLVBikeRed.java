...
public class MCreatorTLVBikeRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvbikered")
	public static final Block block = null;

	public MCreatorTLVBikeRed(Elementscsm instance) {
		super(instance, 397);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvbikered", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvbikered");
			setUnlocalizedName("tlvbikered");
