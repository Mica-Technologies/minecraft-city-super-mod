...
public class MCreatorTLSAheadGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlsaheadgreen")
	public static final Block block = null;

	public MCreatorTLSAheadGreen(Elementscsm instance) {
		super(instance, 396);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlsaheadgreen", "inventory"));
	}
