...
public class MCreatorTLHBikeGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhbikegreen")
	public static final Block block = null;

	public MCreatorTLHBikeGreen(Elementscsm instance) {
		super(instance, 404);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhbikegreen", "inventory"));
	}
