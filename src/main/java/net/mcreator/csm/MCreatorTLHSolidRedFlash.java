...
public class MCreatorTLHSolidRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhsolidredflash")
	public static final Block block = null;

	public MCreatorTLHSolidRedFlash(Elementscsm instance) {
		super(instance, 419);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhsolidredflash",
				"inventory"));
	}
