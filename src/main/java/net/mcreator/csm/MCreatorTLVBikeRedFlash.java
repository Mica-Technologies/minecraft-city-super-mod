...
public class MCreatorTLVBikeRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvbikeredflash")
	public static final Block block = null;

	public MCreatorTLVBikeRedFlash(Elementscsm instance) {
		super(instance, 439);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvbikeredflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvbikeredflash");
			setUnlocalizedName("tlvbikeredflash");
