...
public class MCreatorCreeLEDway extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:creeledway")
	public static final Block block = null;

	public MCreatorCreeLEDway(Elementscsm instance) {
		super(instance, 290);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:creeledway", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("creeledway");
			setUnlocalizedName("creeledway");
