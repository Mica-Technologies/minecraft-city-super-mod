...
public class MCreatorS4903hsw extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:s4903hsw")
	public static final Block block = null;

	public MCreatorS4903hsw(Elementscsm instance) {
		super(instance, 63);
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarm4903.executeProcedure($_dependencies);
