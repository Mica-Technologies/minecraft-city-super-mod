...
public class MCreatorTLHSolidGreenFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhsolidgreenflash")
	public static final Block block = null;

	public MCreatorTLHSolidGreenFlash(Elementscsm instance) {
		super(instance, 425);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhsolidgreenflash",
				"inventory"));
	}
