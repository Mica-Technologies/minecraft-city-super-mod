...
public class MCreatorTL4VSolidGreen extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vsolidgreen")
	public static final Block block = null;

	public MCreatorTL4VSolidGreen(Elementscsm instance) {
		super(instance, 749);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vsolidgreen",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vsolidgreen");
			setUnlocalizedName("tl4vsolidgreen");
