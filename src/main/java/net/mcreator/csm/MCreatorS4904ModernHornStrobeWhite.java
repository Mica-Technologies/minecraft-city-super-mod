...
public class MCreatorS4904ModernHornStrobeWhite extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:s4904modernhornstrobewhite")
	public static final Block block = null;

	public MCreatorS4904ModernHornStrobeWhite(Elementscsm instance) {
		super(instance, 510);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation(
				"csm:s4904modernhornstrobewhite", "inventory"));
	}
