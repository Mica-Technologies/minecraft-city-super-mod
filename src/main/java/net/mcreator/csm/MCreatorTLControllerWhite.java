...
public class MCreatorTLControllerWhite extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tlcontrollerwhite")
	public static final Block block = null;

	public MCreatorTLControllerWhite(Elementscsm instance) {
		super(instance, 706);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlcontrollerwhite");
