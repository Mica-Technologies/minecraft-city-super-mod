...
public class MCreatorAEATB0 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:aeatb0")
	public static final Block block = null;

	public MCreatorAEATB0(Elementscsm instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:aeatb0", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("aeatb0");
			setUnlocalizedName("aeatb0");
