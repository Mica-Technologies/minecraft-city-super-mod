...
public class MCreatorTLControllerBlack extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tlcontrollerblack")
	public static final Block block = null;

	public MCreatorTLControllerBlack(Elementscsm instance) {
		super(instance, 707);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlcontrollerblack");
