...
public class MCreatorTLVUpLeftRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvupleftred")
	public static final Block block = null;

	public MCreatorTLVUpLeftRed(Elementscsm instance) {
		super(instance, 523);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvupleftred", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvupleftred");
			setUnlocalizedName("tlvupleftred");
