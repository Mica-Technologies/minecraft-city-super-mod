...
public class MCreatorDSLHR extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:dslhr")
	public static final Block block = null;

	public MCreatorDSLHR(Elementscsm instance) {
		super(instance, 731);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:dslhr", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("dslhr");
			setUnlocalizedName("dslhr");
