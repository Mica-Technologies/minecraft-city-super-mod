...
public class MCreatorTLVARightGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvarightgreen")
	public static final Block block = null;

	public MCreatorTLVARightGreen(Elementscsm instance) {
		super(instance, 514);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvarightgreen",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvarightgreen");
			setUnlocalizedName("tlvarightgreen");
