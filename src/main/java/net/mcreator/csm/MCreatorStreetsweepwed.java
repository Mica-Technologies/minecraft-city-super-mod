...
public class MCreatorStreetsweepwed extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:streetsweepwed")
	public static final Block block = null;

	public MCreatorStreetsweepwed(Elementscsm instance) {
		super(instance, 1081);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("streetsweepwed");
			setUnlocalizedName("streetsweepwed");
