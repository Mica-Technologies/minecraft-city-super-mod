...
public class MCreatorTLDSolidGreenR extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tldsolidgreenr")
	public static final Block block = null;

	public MCreatorTLDSolidGreenR(Elementscsm instance) {
		super(instance, 469);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldsolidgreenr",
				"inventory"));
	}
