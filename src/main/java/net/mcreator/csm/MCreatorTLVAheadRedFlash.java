...
public class MCreatorTLVAheadRedFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvaheadredflash")
	public static final Block block = null;

	public MCreatorTLVAheadRedFlash(Elementscsm instance) {
		super(instance, 451);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaheadredflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvaheadredflash");
			setUnlocalizedName("tlvaheadredflash");
