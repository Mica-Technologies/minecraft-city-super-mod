...
public class MCreatorSSLF extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:sslf")
	public static final Block block = null;

	public MCreatorSSLF(Elementscsm instance) {
		super(instance, 736);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:sslf", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("sslf");
			setUnlocalizedName("sslf");
