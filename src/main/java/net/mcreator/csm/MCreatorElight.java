...
public class MCreatorElight extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:elight")
	public static final Block block = null;

	public MCreatorElight(Elementscsm instance) {
		super(instance, 275);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:elight", "inventory"));
	}
