...
public class MCreatorTLVLeftYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvleftyellowflash")
	public static final Block block = null;

	public MCreatorTLVLeftYellowFlash(Elementscsm instance) {
		super(instance, 430);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvleftyellowflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvleftyellowflash");
			setUnlocalizedName("tlvleftyellowflash");
