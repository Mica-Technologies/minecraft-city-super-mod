...
public class MCreatorHd extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:hd")
	public static final Block block = null;

	public MCreatorHd(Elementscsm instance) {
		super(instance, 236);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:hd", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			Block block = this;
			{
				...
				MCreatorHandDryerSound.executeProcedure($_dependencies);
			}
			return true;
		}
	}
