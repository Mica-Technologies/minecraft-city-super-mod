...
public class MCreatorFAESTINTWhite extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:faestintwhite")
	public static final Block block = null;

	public MCreatorFAESTINTWhite(Elementscsm instance) {
		super(instance,23);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:faestintwhite", "inventory"));
	}
