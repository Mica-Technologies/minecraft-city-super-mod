...
public class MCreatorLTGCL extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:ltgcl")
	public static final Block block = null;

	public MCreatorLTGCL(Elementscsm instance) {
		super(instance, 565);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ltgcl", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("ltgcl");
			setUnlocalizedName("ltgcl");
