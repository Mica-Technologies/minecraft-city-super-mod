...
public class MCreatorSS_SA_SpeakerStrobe_Red extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:ss_sa_speakerstrobe_red")
	public static final Block block = null;

	public MCreatorSS_SA_SpeakerStrobe_Red(Elementscsm instance) {
		super(instance, 532);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ss_sa_speakerstrobe_red",
				"inventory"));
	}
