...
public class MCreatorTLVSolidRed extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvsolidred")
	public static final Block block = null;

	public MCreatorTLVSolidRed(Elementscsm instance) {
		super(instance, 353);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidred", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvsolidred");
			setUnlocalizedName("tlvsolidred");
