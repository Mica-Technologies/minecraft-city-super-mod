...
public class MCreatorSS_SA_SS_RED_WheelockVE extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:ss_sa_ss_red_wheelockve")
	public static final Block block = null;

	public MCreatorSS_SA_SS_RED_WheelockVE(Elementscsm instance) {
		super(instance, 562);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ss_sa_ss_red_wheelockve",
				"inventory"));
	}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					MCreatorFireAlarmVoiceEvac.executeProcedure($_dependencies);
