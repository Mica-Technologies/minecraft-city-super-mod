...
public class MCreatorTLVUTurnYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvuturnyellow")
	public static final Block block = null;

	public MCreatorTLVUTurnYellow(Elementscsm instance) {
		super(instance, 409);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvuturnyellow",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvuturnyellow");
			setUnlocalizedName("tlvuturnyellow");
