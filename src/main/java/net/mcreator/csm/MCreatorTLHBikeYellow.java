...
public class MCreatorTLHBikeYellow extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhbikeyellow")
	public static final Block block = null;

	public MCreatorTLHBikeYellow(Elementscsm instance) {
		super(instance, 401);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlhbikeyellow", "inventory"));
	}
