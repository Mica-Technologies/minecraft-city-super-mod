...
public class MCreatorTLVRightGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvrightgreen")
	public static final Block block = null;

	public MCreatorTLVRightGreen(Elementscsm instance) {
		super(instance, 385);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvrightgreen", "inventory"));
	}
