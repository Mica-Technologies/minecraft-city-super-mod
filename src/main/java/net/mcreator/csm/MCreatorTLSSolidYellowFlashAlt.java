...
public class MCreatorTLSSolidYellowFlashAlt extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tlssolidyellowflashalt")
	public static final Block block = null;

	public MCreatorTLSSolidYellowFlashAlt(Elementscsm instance) {
		super(instance, 667);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlssolidyellowflashalt",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setLightLevel(0F);
			setLightOpacity(0);
			setCreativeTab(MCreatorTrafficSignalsSingle.tab);
