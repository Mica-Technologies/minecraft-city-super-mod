...
public class MCreatorImac extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:imac")
	public static final Block block = null;

	public MCreatorImac(Elementscsm instance) {
		super(instance, 69);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:imac", "inventory"));
	}
