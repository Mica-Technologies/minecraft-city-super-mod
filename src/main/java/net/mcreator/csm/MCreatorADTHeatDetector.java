...
public class MCreatorADTHeatDetector extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:adtheatdetector")
	public static final Block block = null;

	public MCreatorADTHeatDetector(Elementscsm instance) {
		super(instance, 6);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:adtheatdetector",
				"inventory"));
	}
									...
									if (world.getBlockState(bp).getMaterial() == Material.FIRE || b == Blocks.FIRE) {
										...
										if (mcserv != null) {
											mcserv.getPlayerList().sendMessage(
													new TextComponentString("A fire has been detected at [" + bp.getX() + "," + bp.getY() + ","
															+ bp.getZ() + "]. Alarm now activating."));
										}
