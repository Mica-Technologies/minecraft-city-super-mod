...
public class MCreatorL2ESL4 extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:l2esl4")
	public static final Block block = null;

	public MCreatorL2ESL4(Elementscsm instance) {
		super(instance, 727);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:l2esl4", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("l2esl4");
			setUnlocalizedName("l2esl4");
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			switch ((EnumFacing) state.getValue(BlockDirectional.FACING)) {
				...
				case EAST :
					return new AxisAlignedBB(0D, 0D, 0D, 2D, 1D, 1D);
				case UP :
					return new AxisAlignedBB(0D, 0D, 0D, 1D, 2D, 1D);
				case DOWN :
					return new AxisAlignedBB(0D, 1D, 1D, 1D, -1D, 0D);
			}
		}
