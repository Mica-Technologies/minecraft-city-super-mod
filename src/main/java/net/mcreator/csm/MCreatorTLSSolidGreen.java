...
public class MCreatorTLSSolidGreen extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlssolidgreen")
	public static final Block block = null;

	public MCreatorTLSSolidGreen(Elementscsm instance) {
		super(instance, 364);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlssolidgreen", "inventory"));
	}
