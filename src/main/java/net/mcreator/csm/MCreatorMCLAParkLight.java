...
public class MCreatorMCLAParkLight extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:mclaparklight")
	public static final Block block = null;

	public MCreatorMCLAParkLight(Elementscsm instance) {
		super(instance, 565);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:mclaparklight", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("mclaparklight");
			setUnlocalizedName("mclaparklight");
