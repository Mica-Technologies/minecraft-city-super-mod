...
public class MCreatorTLHSolidYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlhsolidyellowflash")
	public static final Block block = null;

	public MCreatorTLHSolidYellowFlash(Elementscsm instance) {
		super(instance, 422);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlhsolidyellowflash",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlhsolidyellowflash");
			setUnlocalizedName("tlhsolidyellowflash");
