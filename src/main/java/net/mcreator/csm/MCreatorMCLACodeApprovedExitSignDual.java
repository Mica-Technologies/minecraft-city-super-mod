...
public class MCreatorMCLACodeApprovedExitSignDual extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:mclacodeapprovedexitsigndual")
	public static final Block block = null;

	public MCreatorMCLACodeApprovedExitSignDual(Elementscsm instance) {
		super(instance, 119);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:mclacodeapprovedexitsigndual",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("mclacodeapprovedexitsigndual");
