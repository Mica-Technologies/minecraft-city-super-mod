...
public class MCreatorTL4VRLG extends Elementscsm.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vrlg")
	public static final Block block = null;

	public MCreatorTL4VRLG(Elementscsm instance) {
		super(instance, 751);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vrlg", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tl4vrlg");
			setUnlocalizedName("tl4vrlg");
