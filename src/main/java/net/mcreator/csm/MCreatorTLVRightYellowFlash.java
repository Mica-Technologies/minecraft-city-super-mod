...
public class MCreatorTLVRightYellowFlash extends Elementscsm.ModElement {

	@GameRegistry.ObjectHolder("csm:tlvrightyellowflash")
	public static final Block block = null;

	public MCreatorTLVRightYellowFlash(Elementscsm instance) {
		super(instance, 436);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvrightyellowflash",
				"inventory"));
	}
