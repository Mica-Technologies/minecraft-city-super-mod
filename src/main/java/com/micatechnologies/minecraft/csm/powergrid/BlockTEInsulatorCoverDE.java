...
public class BlockTEInsulatorCoverDE extends AbstractBlockRotatableNSEWUD {

  public BlockTEInsulatorCoverDE() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.125000, 0.000000, -1.000000, 0.875000, 1.062500, 0.000000);
    }
