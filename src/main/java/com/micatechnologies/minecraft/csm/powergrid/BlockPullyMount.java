...
public class BlockPullyMount extends AbstractBlockRotatableNSEWUD {

  public BlockPullyMount() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.250000, 0.000000, 0.000000, 0.750000, 0.687500, 1.000000);
    }
