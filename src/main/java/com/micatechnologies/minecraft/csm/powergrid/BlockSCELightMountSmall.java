...
public class BlockSCELightMountSmall extends AbstractBlockRotatableNSEWUD {

  public BlockSCELightMountSmall() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.312500, 0.187500, 0.000000, 0.687500, 1.187500, 1.187500);
    }
