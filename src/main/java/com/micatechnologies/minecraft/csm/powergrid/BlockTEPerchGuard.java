...
public class BlockTEPerchGuard extends AbstractBlockRotatableNSEWUD {

  public BlockTEPerchGuard() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.125000, -0.312500, 0.375000, 0.812500, 1.000000, 0.500000);
    }
