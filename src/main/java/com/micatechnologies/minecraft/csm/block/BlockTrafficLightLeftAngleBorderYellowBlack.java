...
public class BlockTrafficLightLeftAngleBorderYellowBlack extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:trafficlightleftangleborderyellowblack" )
    public static final Block block = null;

    public BlockTrafficLightLeftAngleBorderYellowBlack( ElementsCitySuperMod instance ) {
        super( instance, 2151 );
    }

    @Override
    public void initElements() {
        elements.blocks.add( () -> new BlockCustom().setRegistryName( "trafficlightleftangleborderyellowblack" ) );
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:trafficlightleftangleborderyellowblack", "inventory" ) );
    }
    ...
    public static class BlockCustom extends Block
    {
        ...
        public BlockCustom() {
            super( Material.ROCK );
            setUnlocalizedName( "trafficlightleftangleborderyellowblack" );
