...
public class BlockFireAlarmSystemSensorLSeriesHornWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensorlserieshornwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorLSeriesHornWhite( ElementsCitySuperMod instance ) {
        super( instance, 2085 );
    }
