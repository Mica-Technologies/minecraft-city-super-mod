...
public class BlockFireAlarmSimplexTrueAlertHornWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplextruealerthornwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplexTrueAlertHornWhite( ElementsCitySuperMod instance ) {
        super( instance, 2077 );
    }
