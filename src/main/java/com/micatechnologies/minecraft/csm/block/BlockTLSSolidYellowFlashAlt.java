...
public class BlockTLSSolidYellowFlashAlt extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlssolidyellowflashalt")
	public static final Block block = null;
	public BlockTLSSolidYellowFlashAlt(ElementsCitySuperMod instance) {
		super(instance, 667);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlssolidyellowflashalt", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlssolidyellowflashalt");
			setUnlocalizedName("tlssolidyellowflashalt");
