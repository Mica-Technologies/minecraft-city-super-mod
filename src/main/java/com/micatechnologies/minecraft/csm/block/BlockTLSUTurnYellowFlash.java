...
public class BlockTLSUTurnYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsuturnyellowflash")
	public static final Block block = null;
	public BlockTLSUTurnYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 450);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlsuturnyellowflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsuturnyellowflash");
			setUnlocalizedName("tlsuturnyellowflash");
