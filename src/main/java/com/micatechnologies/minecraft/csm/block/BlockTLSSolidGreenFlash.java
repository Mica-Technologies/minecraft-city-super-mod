...
public class BlockTLSSolidGreenFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlssolidgreenflash")
	public static final Block block = null;
	public BlockTLSSolidGreenFlash(ElementsCitySuperMod instance) {
		super(instance, 426);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlssolidgreenflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlssolidgreenflash");
			setUnlocalizedName("tlssolidgreenflash");
