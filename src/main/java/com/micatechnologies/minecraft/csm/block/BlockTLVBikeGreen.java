...
public class BlockTLVBikeGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvbikegreen")
	public static final Block block = null;
	public BlockTLVBikeGreen(ElementsCitySuperMod instance) {
		super(instance, 403);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvbikegreen", "inventory"));
	}
