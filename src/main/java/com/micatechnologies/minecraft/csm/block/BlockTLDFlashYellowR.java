...
public class BlockTLDFlashYellowR extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldflashyellowr")
	public static final Block block = null;
	public BlockTLDFlashYellowR(ElementsCitySuperMod instance) {
		super(instance, 480);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldflashyellowr", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldflashyellowr");
			setUnlocalizedName("tldflashyellowr");
