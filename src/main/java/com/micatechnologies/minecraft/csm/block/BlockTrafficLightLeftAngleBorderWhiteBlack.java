...
public class BlockTrafficLightLeftAngleBorderWhiteBlack extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:trafficlightleftangleborderwhiteblack" )
    public static final Block block = null;

    public BlockTrafficLightLeftAngleBorderWhiteBlack( ElementsCitySuperMod instance ) {
        super( instance, 2152 );
    }

    @Override
    public void initElements() {
        elements.blocks.add( () -> new BlockCustom().setRegistryName( "trafficlightleftangleborderwhiteblack" ) );
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:trafficlightleftangleborderwhiteblack", "inventory" ) );
    }
