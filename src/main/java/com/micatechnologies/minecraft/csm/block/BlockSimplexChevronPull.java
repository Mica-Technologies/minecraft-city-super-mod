...
public class BlockSimplexChevronPull extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:simplexchevronpull")
	public static final Block block = null;
	public BlockSimplexChevronPull(ElementsCitySuperMod instance) {
		super(instance, 316);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:simplexchevronpull", "inventory"));
	}
