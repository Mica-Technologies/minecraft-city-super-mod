...
public class BlockTLDRedSolidLeftYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldredsolidleftyellow")
	public static final Block block = null;
	public BlockTLDRedSolidLeftYellow(ElementsCitySuperMod instance) {
		super(instance, 473);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tldredsolidleftyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldredsolidleftyellow");
			setUnlocalizedName("tldredsolidleftyellow");
