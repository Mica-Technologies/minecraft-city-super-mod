...
public class BlockTLVAheadRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaheadredflash")
	public static final Block block = null;
	public BlockTLVAheadRedFlash(ElementsCitySuperMod instance) {
		super(instance, 451);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaheadredflash", "inventory"));
	}
