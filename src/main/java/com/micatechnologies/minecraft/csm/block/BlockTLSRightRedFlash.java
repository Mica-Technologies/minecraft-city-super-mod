...
public class BlockTLSRightRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsrightredflash")
	public static final Block block = null;
	public BlockTLSRightRedFlash(ElementsCitySuperMod instance) {
		super(instance, 435);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsrightredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsrightredflash");
			setUnlocalizedName("tlsrightredflash");
