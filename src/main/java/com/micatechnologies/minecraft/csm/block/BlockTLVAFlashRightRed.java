...
public class BlockTLVAFlashRightRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaflashrightred")
	public static final Block block = null;
	public BlockTLVAFlashRightRed(ElementsCitySuperMod instance) {
		super(instance, 515);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaflashrightred", "inventory"));
	}
