...
public class BlockTLYV_LYFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlyv_lyflash")
	public static final Block block = null;
	public BlockTLYV_LYFlash(ElementsCitySuperMod instance) {
		super(instance, 654);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlyv_lyflash", "inventory"));
	}
