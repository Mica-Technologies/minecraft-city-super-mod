...
public class BlockFireAlarmSimplexTrueAlertHornStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplextruealerthornstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplexTrueAlertHornStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2081 );
    }
