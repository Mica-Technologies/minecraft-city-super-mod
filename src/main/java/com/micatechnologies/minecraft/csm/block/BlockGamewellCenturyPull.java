...
public class BlockGamewellCenturyPull extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:gamewellcenturypull")
	public static final Block block = null;
	public BlockGamewellCenturyPull(ElementsCitySuperMod instance) {
		super(instance, 310);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:gamewellcenturypull", "inventory"));
	}
