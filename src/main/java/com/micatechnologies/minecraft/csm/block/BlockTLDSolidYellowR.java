...
public class BlockTLDSolidYellowR extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldsolidyellowr")
	public static final Block block = null;
	public BlockTLDSolidYellowR(ElementsCitySuperMod instance) {
		super(instance, 467);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldsolidyellowr", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldsolidyellowr");
			setUnlocalizedName("tldsolidyellowr");
