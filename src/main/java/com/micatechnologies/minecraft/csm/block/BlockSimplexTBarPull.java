...
public class BlockSimplexTBarPull extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:simplextbarpull")
	public static final Block block = null;
	public BlockSimplexTBarPull(ElementsCitySuperMod instance) {
		super(instance, 317);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:simplextbarpull", "inventory"));
	}
