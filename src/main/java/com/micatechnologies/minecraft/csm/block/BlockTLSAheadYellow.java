...
public class BlockTLSAheadYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsaheadyellow")
	public static final Block block = null;
	public BlockTLSAheadYellow(ElementsCitySuperMod instance) {
		super(instance, 393);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsaheadyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsaheadyellow");
			setUnlocalizedName("tlsaheadyellow");
