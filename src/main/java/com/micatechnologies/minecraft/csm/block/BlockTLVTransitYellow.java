...
public class BlockTLVTransitYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvtransityellow")
	public static final Block block = null;
	public BlockTLVTransitYellow(ElementsCitySuperMod instance) {
		super(instance, 504);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvtransityellow", "inventory"));
	}
