...
public class BlockAltoMVWL extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:altomvwl")
	public static final Block block = null;
	public BlockAltoMVWL(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:altomvwl", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("altomvwl");
			setUnlocalizedName("altomvwl");
