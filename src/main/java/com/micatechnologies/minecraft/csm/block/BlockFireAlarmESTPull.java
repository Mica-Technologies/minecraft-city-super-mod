...
public class BlockFireAlarmESTPull extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmestpull";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmESTPull( ElementsCitySuperMod instance ) {
        super( instance, 2113 );
    }
