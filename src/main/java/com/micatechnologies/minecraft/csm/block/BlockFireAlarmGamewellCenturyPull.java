...
public class BlockFireAlarmGamewellCenturyPull extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmgamewellcenturypull";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmGamewellCenturyPull( ElementsCitySuperMod instance ) {
        super( instance, 2115 );
    }
