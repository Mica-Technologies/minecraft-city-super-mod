...
public class BlockFireAlarmSystemSensorLSeriesSpeakerRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensorlseriesspeakerred";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorLSeriesSpeakerRed( ElementsCitySuperMod instance ) {
        super( instance, 2086 );
    }
