...
public class BlockWHOV50Finned extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:whov50finned")
	public static final Block block = null;
	public BlockWHOV50Finned(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:whov50finned", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("whov50finned");
			setUnlocalizedName("whov50finned");
