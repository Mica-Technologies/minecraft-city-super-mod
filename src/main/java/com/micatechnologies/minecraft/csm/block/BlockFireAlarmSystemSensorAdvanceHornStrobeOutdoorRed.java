...
public class BlockFireAlarmSystemSensorAdvanceHornStrobeOutdoorRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensoradvancehornstrobeoutdoorred";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorAdvanceHornStrobeOutdoorRed( ElementsCitySuperMod instance ) {
        super( instance, 2100 );
    }
