...
public class BlockFireAlarmKACSounderRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmkacsounderred";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmKACSounderRed( ElementsCitySuperMod instance ) {
        super( instance, 2065 );
    }
