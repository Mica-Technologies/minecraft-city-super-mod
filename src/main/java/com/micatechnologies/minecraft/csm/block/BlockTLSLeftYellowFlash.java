...
public class BlockTLSLeftYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsleftyellowflash")
	public static final Block block = null;
	public BlockTLSLeftYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 432);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsleftyellowflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsleftyellowflash");
			setUnlocalizedName("tlsleftyellowflash");
