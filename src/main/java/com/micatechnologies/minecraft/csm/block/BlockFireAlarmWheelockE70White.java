...
public class BlockFireAlarmWheelockE70White extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocke70white";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockE70White( ElementsCitySuperMod instance ) {
        super( instance, 2045 );
    }
