...
public class BlockTLYV_RYFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlyv_ryflash")
	public static final Block block = null;
	public BlockTLYV_RYFlash(ElementsCitySuperMod instance) {
		super(instance, 659);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlyv_ryflash", "inventory"));
	}
