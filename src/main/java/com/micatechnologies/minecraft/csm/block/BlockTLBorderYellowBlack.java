...
public class BlockTLBorderYellowBlack extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlborderyellowblack")
	public static final Block block = null;
	public BlockTLBorderYellowBlack(ElementsCitySuperMod instance) {
		super(instance, 879);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlborderyellowblack"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlborderyellowblack", "inventory"));
	}
