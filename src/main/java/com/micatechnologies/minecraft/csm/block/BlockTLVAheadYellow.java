...
public class BlockTLVAheadYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaheadyellow")
	public static final Block block = null;
	public BlockTLVAheadYellow(ElementsCitySuperMod instance) {
		super(instance, 391);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaheadyellow", "inventory"));
	}
