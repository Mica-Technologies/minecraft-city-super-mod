...
public class BlockTLSRightYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsrightyellowflash")
	public static final Block block = null;
	public BlockTLSRightYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 438);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlsrightyellowflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsrightyellowflash");
			setUnlocalizedName("tlsrightyellowflash");
