...
public class BlockTLSRightGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsrightgreen")
	public static final Block block = null;
	public BlockTLSRightGreen(ElementsCitySuperMod instance) {
		super(instance, 387);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsrightgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsrightgreen");
			setUnlocalizedName("tlsrightgreen");
