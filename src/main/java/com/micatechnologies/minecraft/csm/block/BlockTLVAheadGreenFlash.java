...
public class BlockTLVAheadGreenFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaheadgreenflash")
	public static final Block block = null;
	public BlockTLVAheadGreenFlash(ElementsCitySuperMod instance) {
		super(instance, 457);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaheadgreenflash", "inventory"));
	}
