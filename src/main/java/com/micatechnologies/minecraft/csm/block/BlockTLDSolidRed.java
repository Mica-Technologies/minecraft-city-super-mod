...
public class BlockTLDSolidRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldsolidred")
	public static final Block block = null;
	public BlockTLDSolidRed(ElementsCitySuperMod instance) {
		super(instance, 463);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldsolidred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldsolidred");
			setUnlocalizedName("tldsolidred");
