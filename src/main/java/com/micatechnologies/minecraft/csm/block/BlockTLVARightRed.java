...
public class BlockTLVARightRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvarightred")
	public static final Block block = null;
	public BlockTLVARightRed(ElementsCitySuperMod instance) {
		super(instance, 512);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvarightred", "inventory"));
	}
