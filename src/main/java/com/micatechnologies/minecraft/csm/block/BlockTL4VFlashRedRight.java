...
public class BlockTL4VFlashRedRight extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vflashredright")
	public static final Block block = null;
	public BlockTL4VFlashRedRight(ElementsCitySuperMod instance) {
		super(instance, 1176);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tl4vflashredright"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vflashredright", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tl4vflashredright");
