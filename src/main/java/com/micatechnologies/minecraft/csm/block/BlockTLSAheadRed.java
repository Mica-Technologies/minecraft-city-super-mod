...
public class BlockTLSAheadRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsaheadred")
	public static final Block block = null;
	public BlockTLSAheadRed(ElementsCitySuperMod instance) {
		super(instance, 390);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsaheadred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsaheadred");
			setUnlocalizedName("tlsaheadred");
