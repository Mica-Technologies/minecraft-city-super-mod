...
public class BlockTL4VFlashRedLeft extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vflashredleft")
	public static final Block block = null;
	public BlockTL4VFlashRedLeft(ElementsCitySuperMod instance) {
		super(instance, 1177);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tl4vflashredleft"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vflashredleft", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tl4vflashredleft");
