...
public class BlockFireAlarmSystemSensorAdvanceHornStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensoradvancehornstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorAdvanceHornStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2099 );
    }
