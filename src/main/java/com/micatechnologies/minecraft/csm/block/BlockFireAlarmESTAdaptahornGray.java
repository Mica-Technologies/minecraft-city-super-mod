...
public class BlockFireAlarmESTAdaptahornGray extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmestadaptahorngray";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmESTAdaptahornGray( ElementsCitySuperMod instance ) {
        super( instance, 2062 );
    }
