...
public class BlockFireAlarmSimplex2901HornRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplex2901hornred";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplex2901HornRed( ElementsCitySuperMod instance ) {
        super( instance, 2067 );
    }
