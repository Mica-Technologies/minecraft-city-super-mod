...
public class BlockTLVASolidRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvasolidred")
	public static final Block block = null;
	public BlockTLVASolidRed( ElementsCitySuperMod instance) {
		super(instance, 1452);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvasolidred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvasolidred");
			setUnlocalizedName("tlvasolidred");
