...
public class BlockControlBoxLargeSilver extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:controlboxlargesilver")
	public static final Block block = null;
	public BlockControlBoxLargeSilver(ElementsCitySuperMod instance) {
		super(instance, 1173);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("controlboxlargesilver"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:controlboxlargesilver", "inventory"));
	}
