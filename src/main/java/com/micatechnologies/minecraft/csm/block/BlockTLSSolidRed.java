...
public class BlockTLSSolidRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlssolidred")
	public static final Block block = null;
	public BlockTLSSolidRed(ElementsCitySuperMod instance) {
		super(instance, 357);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlssolidred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlssolidred");
			setUnlocalizedName("tlssolidred");
