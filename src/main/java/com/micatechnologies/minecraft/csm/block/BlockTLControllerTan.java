...
public class BlockTLControllerTan extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlcontrollertan")
	public static final Block block = null;
	public BlockTLControllerTan(ElementsCitySuperMod instance) {
		super(instance, 708);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlcontrollertan"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlcontrollertan", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tlcontrollertan");
