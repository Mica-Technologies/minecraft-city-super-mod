...
public class BlockTLYV_SRFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlyv_srflash")
	public static final Block block = null;
	public BlockTLYV_SRFlash(ElementsCitySuperMod instance) {
		super(instance, 647);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlyv_srflash", "inventory"));
	}
