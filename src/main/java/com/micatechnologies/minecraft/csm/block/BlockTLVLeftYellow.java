...
public class BlockTLVLeftYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvleftyellow")
	public static final Block block = null;
	public BlockTLVLeftYellow(ElementsCitySuperMod instance) {
		super(instance, 372);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvleftyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvleftyellow");
			setUnlocalizedName("tlvleftyellow");
