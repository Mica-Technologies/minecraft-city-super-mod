...
public class BlockCWOffLeft extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:cwoffleft")
	public static final Block block = null;
	public BlockCWOffLeft(ElementsCitySuperMod instance) {
		super(instance, 370);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:cwoffleft", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("cwoffleft");
			setUnlocalizedName("cwoffleft");
