...
public class BlockTLVRightRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvrightredflash")
	public static final Block block = null;
	public BlockTLVRightRedFlash(ElementsCitySuperMod instance) {
		super(instance, 433);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvrightredflash", "inventory"));
	}
