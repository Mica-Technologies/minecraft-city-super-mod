...
public class BlockTLYV_LRFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlyv_lrflash")
	public static final Block block = null;
	public BlockTLYV_LRFlash(ElementsCitySuperMod instance) {
		super(instance, 652);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlyv_lrflash", "inventory"));
	}
