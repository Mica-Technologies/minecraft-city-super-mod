...
public class BlockTLSBikeGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsbikegreen")
	public static final Block block = null;
	public BlockTLSBikeGreen(ElementsCitySuperMod instance) {
		super(instance, 405);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsbikegreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsbikegreen");
			setUnlocalizedName("tlsbikegreen");
