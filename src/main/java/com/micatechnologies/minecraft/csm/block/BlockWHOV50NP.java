...
public class BlockWHOV50NP extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:whov50np")
	public static final Block block = null;
	public BlockWHOV50NP(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:whov50np", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("whov50np");
			setUnlocalizedName("whov50np");
