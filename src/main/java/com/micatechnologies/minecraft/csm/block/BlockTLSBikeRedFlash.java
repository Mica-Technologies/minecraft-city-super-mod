...
public class BlockTLSBikeRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsbikeredflash")
	public static final Block block = null;
	public BlockTLSBikeRedFlash(ElementsCitySuperMod instance) {
		super(instance, 441);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsbikeredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsbikeredflash");
			setUnlocalizedName("tlsbikeredflash");
