...
public class BlockTLYV_SYFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlyv_syflash")
	public static final Block block = null;
	public BlockTLYV_SYFlash(ElementsCitySuperMod instance) {
		super(instance, 649);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlyv_syflash", "inventory"));
	}
