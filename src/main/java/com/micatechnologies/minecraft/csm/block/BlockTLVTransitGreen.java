...
public class BlockTLVTransitGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvtransitgreen")
	public static final Block block = null;
	public BlockTLVTransitGreen(ElementsCitySuperMod instance) {
		super(instance, 505);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvtransitgreen", "inventory"));
	}
