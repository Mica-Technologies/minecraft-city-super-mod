...
public class BlockTLSBikeYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsbikeyellow")
	public static final Block block = null;
	public BlockTLSBikeYellow(ElementsCitySuperMod instance) {
		super(instance, 402);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsbikeyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsbikeyellow");
			setUnlocalizedName("tlsbikeyellow");
