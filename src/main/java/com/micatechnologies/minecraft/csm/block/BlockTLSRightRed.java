...
public class BlockTLSRightRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsrightred")
	public static final Block block = null;
	public BlockTLSRightRed(ElementsCitySuperMod instance) {
		super(instance, 380);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsrightred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsrightred");
			setUnlocalizedName("tlsrightred");
