...
public class BlockTLSUturnYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsuturnyellow")
	public static final Block block = null;
	public BlockTLSUturnYellow(ElementsCitySuperMod instance) {
		super(instance, 411);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsuturnyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsuturnyellow");
			setUnlocalizedName("tlsuturnyellow");
