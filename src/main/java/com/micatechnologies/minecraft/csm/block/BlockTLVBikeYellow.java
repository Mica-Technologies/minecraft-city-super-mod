...
public class BlockTLVBikeYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvbikeyellow")
	public static final Block block = null;
	public BlockTLVBikeYellow(ElementsCitySuperMod instance) {
		super(instance, 400);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvbikeyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvbikeyellow");
			setUnlocalizedName("tlvbikeyellow");
