...
import com.micatechnologies.minecraft.csm.creativetab.TabTrafficSignalsSingle;

@ElementsCitySuperMod.ModElement.Tag
public class BlockTLSBikeYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsbikeyellowflash")
	public static final Block block = null;
	public BlockTLSBikeYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 444);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsbikeyellowflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsbikeyellowflash");
			setUnlocalizedName("tlsbikeyellowflash");
			...
			setLightLevel(0F);
			setLightOpacity(0);
			setCreativeTab(TabTrafficSignalsSingle.tab);
