...
public class BlockWHOV20 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:whov20")
	public static final Block block = null;
	public BlockWHOV20(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:whov20", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("whov20");
			setUnlocalizedName("whov20");
