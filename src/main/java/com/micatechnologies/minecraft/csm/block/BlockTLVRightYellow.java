...
public class BlockTLVRightYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvrightyellow")
	public static final Block block = null;
	public BlockTLVRightYellow(ElementsCitySuperMod instance) {
		super(instance, 382);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvrightyellow", "inventory"));
	}
