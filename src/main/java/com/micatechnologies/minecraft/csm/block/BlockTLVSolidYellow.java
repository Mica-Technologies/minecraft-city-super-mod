...
public class BlockTLVSolidYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvsolidyellow")
	public static final Block block = null;
	public BlockTLVSolidYellow(ElementsCitySuperMod instance) {
		super(instance, 359);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsolidyellow", "inventory"));
	}
