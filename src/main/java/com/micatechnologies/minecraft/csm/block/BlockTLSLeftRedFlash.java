...
public class BlockTLSLeftRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsleftredflash")
	public static final Block block = null;
	public BlockTLSLeftRedFlash(ElementsCitySuperMod instance) {
		super(instance, 429);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsleftredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsleftredflash");
			setUnlocalizedName("tlsleftredflash");
