...
public class BlockTLDFlashRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldflashred")
	public static final Block block = null;
	public BlockTLDFlashRed(ElementsCitySuperMod instance) {
		super(instance, 478);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldflashred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldflashred");
			setUnlocalizedName("tldflashred");
