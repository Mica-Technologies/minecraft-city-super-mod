...
public class BlockTLSAheadGreenFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsaheadgreenflash")
	public static final Block block = null;
	public BlockTLSAheadGreenFlash(ElementsCitySuperMod instance) {
		super(instance, 459);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsaheadgreenflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsaheadgreenflash");
			setUnlocalizedName("tlsaheadgreenflash");
