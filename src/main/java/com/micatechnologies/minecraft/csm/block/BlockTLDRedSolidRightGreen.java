...
public class BlockTLDRedSolidRightGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldredsolidrightgreen")
	public static final Block block = null;
	public BlockTLDRedSolidRightGreen(ElementsCitySuperMod instance) {
		super(instance, 470);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tldredsolidrightgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldredsolidrightgreen");
			setUnlocalizedName("tldredsolidrightgreen");
