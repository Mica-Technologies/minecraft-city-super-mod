...
public class BlockCWOnLeft extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:cwonleft")
	public static final Block block = null;
	public BlockCWOnLeft(ElementsCitySuperMod instance) {
		super(instance, 368);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:cwonleft", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("cwonleft");
			setUnlocalizedName("cwonleft");
