...
import com.micatechnologies.minecraft.csm.procedure.ProcedureSetCurrentPanelCoords;
import com.micatechnologies.minecraft.csm.creativetab.TabMCLAAlarmsTab;

@ElementsCitySuperMod.ModElement.Tag
public class BlockAlarmPanel extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:alarmpanel")
	public static final Block block = null;
	public BlockAlarmPanel(ElementsCitySuperMod instance) {
		super(instance, 278);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:alarmpanel", "inventory"));
	}
	public static class BlockCustom extends BlockLever {
		public BlockCustom() {
			super();
			setRegistryName("alarmpanel");
			setUnlocalizedName("alarmpanel");
			...
			Block block = this;
			{
				...
				if (bsc.getValue(BlockLever.POWERED)) {
					...
					world.playSound((EntityPlayer) null, x, y, z, (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
							.getObject(new ResourceLocation("csm:simplex_panel_reset")), SoundCategory.NEUTRAL, (float) 3, (float) 1);
					MinecraftServer mcserv = FMLCommonHandler.instance().getMinecraftServerInstance();
					if (mcserv != null)
