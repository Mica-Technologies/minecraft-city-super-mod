...
public class BlockFireAlarmWheelockMTHornWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelockmthornwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockMTHornWhite( ElementsCitySuperMod instance ) {
        super( instance, 2040 );
    }
