...
public class BlockTLDSolidGreenR extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldsolidgreenr")
	public static final Block block = null;
	public BlockTLDSolidGreenR(ElementsCitySuperMod instance) {
		super(instance, 469);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldsolidgreenr", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldsolidgreenr");
			setUnlocalizedName("tldsolidgreenr");
