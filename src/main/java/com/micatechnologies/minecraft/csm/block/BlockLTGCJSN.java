...
public class BlockLTGCJSN extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:ltgcjsn")
	public static final Block block = null;
	public BlockLTGCJSN(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ltgcjsn", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("ltgcjsn");
			setUnlocalizedName("ltgcjsn");
