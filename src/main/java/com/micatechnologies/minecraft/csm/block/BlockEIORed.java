...
public class BlockEIORed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:eiored")
	public static final Block block = null;
	public BlockEIORed(ElementsCitySuperMod instance) {
		super(instance, 308);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:eiored", "inventory"));
	}
	public static class BlockCustom extends BlockLever {
		public BlockCustom() {
			super();
			setRegistryName("eiored");
			setUnlocalizedName("eiored");
