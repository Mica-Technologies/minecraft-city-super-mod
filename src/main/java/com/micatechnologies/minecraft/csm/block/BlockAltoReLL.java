...
public class BlockAltoReLL extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:altorell")
	public static final Block block = null;
	public BlockAltoReLL(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:altorell", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("altorell");
			setUnlocalizedName("altorell");
