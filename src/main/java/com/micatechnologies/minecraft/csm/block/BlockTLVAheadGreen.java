...
public class BlockTLVAheadGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaheadgreen")
	public static final Block block = null;
	public BlockTLVAheadGreen(ElementsCitySuperMod instance) {
		super(instance, 394);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaheadgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvaheadgreen");
			setUnlocalizedName("tlvaheadgreen");
