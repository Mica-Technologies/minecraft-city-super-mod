...
public class BlockTLSSolidGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlssolidgreen")
	public static final Block block = null;
	public BlockTLSSolidGreen(ElementsCitySuperMod instance) {
		super(instance, 364);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlssolidgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlssolidgreen");
			setUnlocalizedName("tlssolidgreen");
