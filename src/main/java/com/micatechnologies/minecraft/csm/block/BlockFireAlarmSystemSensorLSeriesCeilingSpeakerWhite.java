...
public class BlockFireAlarmSystemSensorLSeriesCeilingSpeakerWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensorlseriesceilingspeakerwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorLSeriesCeilingSpeakerWhite( ElementsCitySuperMod instance ) {
        super( instance, 2089 );
    }
