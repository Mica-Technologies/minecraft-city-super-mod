...
public class BlockTLVSoldRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvsoldredflash")
	public static final Block block = null;
	public BlockTLVSoldRedFlash(ElementsCitySuperMod instance) {
		super(instance, 418);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvsoldredflash", "inventory"));
	}
