...
public class BlockFireAlarmSimplexChevronPull extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplexchevronpull";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplexChevronPull( ElementsCitySuperMod instance ) {
        super( instance, 2111 );
    }
