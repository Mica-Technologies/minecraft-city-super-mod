...
public class BlockTLDGreenSolidRightYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldgreensolidrightyellow")
	public static final Block block = null;
	public BlockTLDGreenSolidRightYellow(ElementsCitySuperMod instance) {
		super(instance, 477);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tldgreensolidrightyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldgreensolidrightyellow");
			setUnlocalizedName("tldgreensolidrightyellow");
