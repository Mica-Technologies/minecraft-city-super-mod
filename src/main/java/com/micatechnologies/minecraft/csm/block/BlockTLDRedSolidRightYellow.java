...
public class BlockTLDRedSolidRightYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldredsolidrightyellow")
	public static final Block block = null;
	public BlockTLDRedSolidRightYellow(ElementsCitySuperMod instance) {
		super(instance, 471);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tldredsolidrightyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldredsolidrightyellow");
			setUnlocalizedName("tldredsolidrightyellow");
