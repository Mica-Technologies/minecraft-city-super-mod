...
public class BlockFireAlarmFCIPull extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmfcipull";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmFCIPull( ElementsCitySuperMod instance ) {
        super( instance, 2114 );
    }
