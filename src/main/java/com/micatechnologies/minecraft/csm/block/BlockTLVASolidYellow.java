...
public class BlockTLVASolidYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvasolidyellow")
	public static final Block block = null;
	public BlockTLVASolidYellow( ElementsCitySuperMod instance) {
		super(instance, 1453);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvasolidyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvasolidyellow");
			setUnlocalizedName("tlvasolidyellow");
