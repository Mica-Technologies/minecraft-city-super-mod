...
public class BlockTLDSolidGreenL extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldsolidgreenl")
	public static final Block block = null;
	public BlockTLDSolidGreenL(ElementsCitySuperMod instance) {
		super(instance, 468);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldsolidgreenl", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldsolidgreenl");
			setUnlocalizedName("tldsolidgreenl");
