...
public class BlockFireAlarmWheelockET80Red extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocket80red";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockET80Red( ElementsCitySuperMod instance ) {
        super( instance, 2033 );
    }
