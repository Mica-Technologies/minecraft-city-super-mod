...
public class BlockTLVAheadYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaheadyellowflash")
	public static final Block block = null;
	public BlockTLVAheadYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 454);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvaheadyellowflash", "inventory"));
	}
