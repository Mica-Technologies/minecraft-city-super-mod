...
public class BlockFireAlarmSystemSensorAdvanceCeilingHornStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensoradvanceceilinghornstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorAdvanceCeilingHornStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2105 );
    }
