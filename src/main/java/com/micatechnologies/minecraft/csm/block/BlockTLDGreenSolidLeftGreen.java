...
public class BlockTLDGreenSolidLeftGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldgreensolidleftgreen")
	public static final Block block = null;
	public BlockTLDGreenSolidLeftGreen(ElementsCitySuperMod instance) {
		super(instance, 474);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tldgreensolidleftgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldgreensolidleftgreen");
			setUnlocalizedName("tldgreensolidleftgreen");
