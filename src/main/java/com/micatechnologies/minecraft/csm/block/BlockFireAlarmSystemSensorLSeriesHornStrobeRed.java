...
public class BlockFireAlarmSystemSensorLSeriesHornStrobeRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensorlserieshornstrobered";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorLSeriesHornStrobeRed( ElementsCitySuperMod instance ) {
        super( instance, 2090 );
    }
