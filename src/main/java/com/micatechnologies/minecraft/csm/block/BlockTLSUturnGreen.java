...
public class BlockTLSUturnGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsuturngreen")
	public static final Block block = null;
	public BlockTLSUturnGreen(ElementsCitySuperMod instance) {
		super(instance, 414);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsuturngreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsuturngreen");
			setUnlocalizedName("tlsuturngreen");
