...
public class BlockTLSAheadYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsaheadyellowflash")
	public static final Block block = null;
	public BlockTLSAheadYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 456);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlsaheadyellowflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsaheadyellowflash");
			setUnlocalizedName("tlsaheadyellowflash");
