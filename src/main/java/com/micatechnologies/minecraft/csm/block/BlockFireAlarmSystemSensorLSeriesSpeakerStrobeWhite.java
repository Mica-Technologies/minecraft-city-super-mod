...
public class BlockFireAlarmSystemSensorLSeriesSpeakerStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensorlseriesspeakerstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorLSeriesSpeakerStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2093 );
    }
