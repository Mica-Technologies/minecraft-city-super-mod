...
public class BlockTLVUpLeftRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvupleftred")
	public static final Block block = null;
	public BlockTLVUpLeftRed(ElementsCitySuperMod instance) {
		super(instance, 523);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvupleftred", "inventory"));
	}
