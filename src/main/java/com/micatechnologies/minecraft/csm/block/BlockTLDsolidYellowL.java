...
public class BlockTLDsolidYellowL extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldsolidyellowl")
	public static final Block block = null;
	public BlockTLDsolidYellowL(ElementsCitySuperMod instance) {
		super(instance, 466);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldsolidyellowl", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldsolidyellowl");
			setUnlocalizedName("tldsolidyellowl");
