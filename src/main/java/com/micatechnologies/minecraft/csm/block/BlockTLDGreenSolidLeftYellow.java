...
public class BlockTLDGreenSolidLeftYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldgreensolidleftyellow")
	public static final Block block = null;
	public BlockTLDGreenSolidLeftYellow(ElementsCitySuperMod instance) {
		super(instance, 475);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tldgreensolidleftyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldgreensolidleftyellow");
			setUnlocalizedName("tldgreensolidleftyellow");
