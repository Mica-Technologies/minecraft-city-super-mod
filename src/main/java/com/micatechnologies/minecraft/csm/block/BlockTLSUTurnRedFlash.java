...
public class BlockTLSUTurnRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsuturnredflash")
	public static final Block block = null;
	public BlockTLSUTurnRedFlash(ElementsCitySuperMod instance) {
		super(instance, 447);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsuturnredflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsuturnredflash");
			setUnlocalizedName("tlsuturnredflash");
