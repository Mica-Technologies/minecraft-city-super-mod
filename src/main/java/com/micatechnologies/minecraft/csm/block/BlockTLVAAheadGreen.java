...
public class BlockTLVAAheadGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaaheadgreen")
	public static final Block block = null;
	public BlockTLVAAheadGreen( ElementsCitySuperMod instance) {
		super(instance, 1453);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvaaheadgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvaaheadgreen");
			setUnlocalizedName("tlvaaheadgreen");
