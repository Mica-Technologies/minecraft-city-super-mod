...
public class BlockTLVASolidGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvasolidgreen")
	public static final Block block = null;
	public BlockTLVASolidGreen( ElementsCitySuperMod instance) {
		super(instance, 1453);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvasolidgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlvasolidgreen");
			setUnlocalizedName("tlvasolidgreen");
