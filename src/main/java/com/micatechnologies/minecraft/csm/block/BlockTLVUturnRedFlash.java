...
public class BlockTLVUturnRedFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvuturnredflash")
	public static final Block block = null;
	public BlockTLVUturnRedFlash(ElementsCitySuperMod instance) {
		super(instance, 445);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvuturnredflash", "inventory"));
	}
