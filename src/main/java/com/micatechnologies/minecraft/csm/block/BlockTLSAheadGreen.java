...
public class BlockTLSAheadGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsaheadgreen")
	public static final Block block = null;
	public BlockTLSAheadGreen(ElementsCitySuperMod instance) {
		super(instance, 396);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsaheadgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsaheadgreen");
			setUnlocalizedName("tlsaheadgreen");
