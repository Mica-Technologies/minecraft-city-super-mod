...
public class BlockTLControllerBlack extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlcontrollerblack")
	public static final Block block = null;
	public BlockTLControllerBlack(ElementsCitySuperMod instance) {
		super(instance, 707);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlcontrollerblack"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlcontrollerblack", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tlcontrollerblack");
