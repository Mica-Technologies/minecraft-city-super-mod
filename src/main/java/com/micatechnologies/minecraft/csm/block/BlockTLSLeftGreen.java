...
public class BlockTLSLeftGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsleftgreen")
	public static final Block block = null;
	public BlockTLSLeftGreen(ElementsCitySuperMod instance) {
		super(instance, 377);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsleftgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsleftgreen");
			setUnlocalizedName("tlsleftgreen");
