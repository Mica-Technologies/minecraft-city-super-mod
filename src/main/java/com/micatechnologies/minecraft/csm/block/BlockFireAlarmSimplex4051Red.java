...
public class BlockFireAlarmSimplex4051Red extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplex4051red";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplex4051Red( ElementsCitySuperMod instance ) {
        super( instance, 2070 );
    }
