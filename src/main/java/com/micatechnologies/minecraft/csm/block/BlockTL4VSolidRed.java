...
public class BlockTL4VSolidRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tl4vsolidred")
	public static final Block block = null;
	public BlockTL4VSolidRed(ElementsCitySuperMod instance) {
		super(instance, 747);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tl4vsolidred", "inventory"));
	}
