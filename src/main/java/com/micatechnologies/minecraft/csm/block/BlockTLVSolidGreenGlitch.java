...
public class BlockTLVSolidGreenGlitch extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvsolidgreenglitch")
	public static final Block block = null;
	public BlockTLVSolidGreenGlitch(ElementsCitySuperMod instance) {
		super(instance, 675);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvsolidgreenglitch", "inventory"));
	}
