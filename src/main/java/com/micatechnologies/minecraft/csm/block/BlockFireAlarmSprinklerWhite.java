...
public class BlockFireAlarmSprinklerWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsprinklerwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSprinklerWhite( ElementsCitySuperMod instance ) {
        super( instance, 2118 );
    }
