...
public class BlockTLDRedSolidLeftGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldredsolidleftgreen")
	public static final Block block = null;
	public BlockTLDRedSolidLeftGreen(ElementsCitySuperMod instance) {
		super(instance, 472);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tldredsolidleftgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldredsolidleftgreen");
			setUnlocalizedName("tldredsolidleftgreen");
