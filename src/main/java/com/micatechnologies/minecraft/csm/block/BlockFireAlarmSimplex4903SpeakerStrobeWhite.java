...
public class BlockFireAlarmSimplex4903SpeakerStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplex4903speakerstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplex4903SpeakerStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2074 );
    }
