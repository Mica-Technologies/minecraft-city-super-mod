...
public class BlockTLVFlashUpLEftRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvflashupleftred")
	public static final Block block = null;
	public BlockTLVFlashUpLEftRed(ElementsCitySuperMod instance) {
		super(instance, 526);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlvflashupleftred", "inventory"));
	}
