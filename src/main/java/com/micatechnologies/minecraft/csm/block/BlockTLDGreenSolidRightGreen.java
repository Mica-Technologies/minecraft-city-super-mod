...
public class BlockTLDGreenSolidRightGreen extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldgreensolidrightgreen")
	public static final Block block = null;
	public BlockTLDGreenSolidRightGreen(ElementsCitySuperMod instance) {
		super(instance, 476);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tldgreensolidrightgreen", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldgreensolidrightgreen");
			setUnlocalizedName("tldgreensolidrightgreen");
