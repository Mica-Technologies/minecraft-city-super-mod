...
public class BlockMCLAClassicPostLight extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mclaclassicpostlight")
	public static final Block block = null;
	public BlockMCLAClassicPostLight(ElementsCitySuperMod instance) {
		super(instance, 565);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:mclaclassicpostlight", "inventory"));
	}
