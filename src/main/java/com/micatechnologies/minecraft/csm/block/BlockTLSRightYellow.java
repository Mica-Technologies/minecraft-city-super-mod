...
public class BlockTLSRightYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsrightyellow")
	public static final Block block = null;
	public BlockTLSRightYellow(ElementsCitySuperMod instance) {
		super(instance, 384);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsrightyellow", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsrightyellow");
			setUnlocalizedName("tlsrightyellow");
