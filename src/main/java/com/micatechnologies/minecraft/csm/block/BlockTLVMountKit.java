...
public class BlockTLVMountKit extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvmountkit")
	public static final Block block = null;
	public BlockTLVMountKit(ElementsCitySuperMod instance) {
		super(instance, 883);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlvmountkit"));
