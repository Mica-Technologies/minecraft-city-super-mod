...
public class BlockTLSSolidYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlssolidyellowflash")
	public static final Block block = null;
	public BlockTLSSolidYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 423);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlssolidyellowflash", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlssolidyellowflash");
			setUnlocalizedName("tlssolidyellowflash");
