...
public class BlockGEPB extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:gepb")
	public static final Block block = null;
	public BlockGEPB(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:gepb", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("gepb");
			setUnlocalizedName("gepb");
