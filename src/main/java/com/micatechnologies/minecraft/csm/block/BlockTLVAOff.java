...
public class BlockTLVAOff extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaoff")
	public static final Block block = null;
	public BlockTLVAOff(ElementsCitySuperMod instance) {
		super(instance, 893);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlvaoff"));
