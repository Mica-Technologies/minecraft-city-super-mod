...
public class BlockTLSBikeRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsbikered")
	public static final Block block = null;
	public BlockTLSBikeRed(ElementsCitySuperMod instance) {
		super(instance, 399);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsbikered", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsbikered");
			setUnlocalizedName("tlsbikered");
