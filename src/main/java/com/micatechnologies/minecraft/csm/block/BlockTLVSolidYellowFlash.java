...
public class BlockTLVSolidYellowFlash extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvsolidyellowflash")
	public static final Block block = null;
	public BlockTLVSolidYellowFlash(ElementsCitySuperMod instance) {
		super(instance, 421);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvsolidyellowflash", "inventory"));
	}
