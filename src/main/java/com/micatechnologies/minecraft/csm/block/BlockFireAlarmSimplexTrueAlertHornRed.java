...
public class BlockFireAlarmSimplexTrueAlertHornRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplextruealerthornred";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplexTrueAlertHornRed( ElementsCitySuperMod instance ) {
        super( instance, 2076 );
    }
