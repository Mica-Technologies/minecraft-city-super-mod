...
public class BlockTLDFlashYellowL extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tldflashyellowl")
	public static final Block block = null;
	public BlockTLDFlashYellowL(ElementsCitySuperMod instance) {
		super(instance, 479);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tldflashyellowl", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tldflashyellowl");
			setUnlocalizedName("tldflashyellowl");
