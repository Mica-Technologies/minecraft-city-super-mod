...
public class BlockTLSUturnRed extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlsuturnred")
	public static final Block block = null;
	public BlockTLSUturnRed(ElementsCitySuperMod instance) {
		super(instance, 408);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlsuturnred", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("tlsuturnred");
			setUnlocalizedName("tlsuturnred");
