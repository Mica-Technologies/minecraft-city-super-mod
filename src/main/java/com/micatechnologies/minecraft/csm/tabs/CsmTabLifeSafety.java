...
public class CsmTabLifeSafety extends CsmTab {
  ...
  public void initTabElements(FMLPreInitializationEvent fmlPreInitializationEvent) {
    ...
    initTabBlock(new BlockFireAlarmBeaconFactory("firealarmbeaconred", new AxisAlignedBB(0.187500, 0.187500, 0.250000, 0.812500, 0.812500, 1.000000), new float[]{4.25f, 4.25f, 4f}, new float[]{11.75f, 11.75f, 11.5f}, new float[]{1.0f, 0.12f, 0.1f}));
    initTabBlock(new BlockFireAlarmBeaconFactory("firealarmbeacongreen", new AxisAlignedBB(0.187500, 0.187500, 0.250000, 0.812500, 0.812500, 1.000000), new float[]{4.25f, 4.25f, 4f}, new float[]{11.75f, 11.75f, 11.5f}, new float[]{0.2f, 1.0f, 0.32f}));
    initTabBlock(new BlockFireAlarmBeaconFactory("firealarmbeaconblue", new AxisAlignedBB(0.187500, 0.187500, 0.250000, 0.812500, 0.812500, 1.000000), new float[]{4.25f, 4.25f, 4f}, new float[]{11.75f, 11.75f, 11.5f}, new float[]{0.28f, 0.5f, 1.0f}));
    initTabBlock(new BlockFireAlarmBeaconFactory("firealarmbeaconclear", new AxisAlignedBB(0.187500, 0.187500, 0.250000, 0.812500, 0.812500, 1.000000), new float[]{4.25f, 4.25f, 4f}, new float[]{11.75f, 11.75f, 11.5f}, new float[]{1.0f, 1.0f, 1.0f}));
    ...
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensoradvancelfhornstrobered", "csm:spectralert_lf", new AxisAlignedBB(0.187500, 0.125000, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.4f, 4.75f, 13f}, new float[]{10.7f, 9.9f, 14f}));
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensoradvancelfhornstrobewhite", "csm:spectralert_lf", new AxisAlignedBB(0.187500, 0.125000, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.4f, 4.75f, 13f}, new float[]{10.7f, 9.9f, 14f}));
    ...
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensorclassichornstrobered", "csm:spectralert_classic", new AxisAlignedBB(0.078125, 0.012500, 0.781250, 0.921875, 0.993750, 1.000000), new float[]{3.83f, 0.69f, 12.5f}, new float[]{12.42f, 7.44f, 14.5f}));
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensorclassichornstrobewhite", "csm:spectralert_classic", new AxisAlignedBB(0.078125, 0.012500, 0.781250, 0.921875, 0.993750, 1.000000), new float[]{3.83f, 0.69f, 12.5f}, new float[]{12.42f, 7.44f, 14.5f}));
    ...
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsystemsensorlseriesledceilingspeakerstrobered", new AxisAlignedBB(0.062500, 0.062500, 0.937500, 0.937500, 0.937500, 1.000000), new float[]{6.2f, 6.2f, 15f}, new float[]{9.8f, 9.8f, 16f}));
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsystemsensorlseriesledceilingspeakerstrobewhite", new AxisAlignedBB(0.062500, 0.062500, 0.937500, 0.937500, 0.937500, 1.000000), new float[]{6.2f, 6.2f, 15f}, new float[]{9.8f, 9.8f, 16f}));
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensorlseriesledhornstrobeoutdoorred", "csm:spectralert", new AxisAlignedBB(0.218750, 0.046875, 0.656250, 0.781250, 0.921875, 1.000000), new float[]{6.05f, 4f, 10.5f}, new float[]{10.1f, 8f, 11.5f}));
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensorlseriesledhornstrobered", "csm:spectralert", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.75f, 5.8f, 13f}, new float[]{10.25f, 10.3f, 14f}));
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensorlseriesledhornstrobewhite", "csm:spectralert", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.75f, 5.8f, 13f}, new float[]{10.25f, 10.3f, 14f}));
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsystemsensorlseriesledspeakerstrobered", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.75f, 5.85f, 13f}, new float[]{10.25f, 10.35f, 14f}));
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsystemsensorlseriesledspeakerstrobewhite", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.75f, 5.85f, 13f}, new float[]{10.25f, 10.35f, 14f}));
