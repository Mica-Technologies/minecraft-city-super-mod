...
/**
 * Arcade cabinet block representing the classic Galaga arcade game. Plays cabinet sounds when
 * right-clicked and emits light.
 *
 * @author Mica Technologies
 * @since 2026.4
 */
public class BlockACGalaga extends AbstractBlockRotatableNSEWUD {

  public BlockACGalaga() {
  ...
  public boolean onBlockActivated(World world, BlockPos pos, IBlockState state,
    ...
    if (!world.isRemote) {
      SoundEvent sound = CsmSounds.SOUND.GALAGA_CABINET.getSoundEvent();
      if (sound != null) {
