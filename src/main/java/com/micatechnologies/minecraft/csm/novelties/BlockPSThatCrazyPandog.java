...
/**
 * Decorative pet store sign block representing the That Crazy Pandog brand.
 *
 * @author Mica Technologies
 * @since 2026.4
 */
public class BlockPSThatCrazyPandog extends AbstractBlockRotatableNSEWUD {

  public BlockPSThatCrazyPandog() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.250000, 0.000000, 0.368750, 0.750000, 1.000000, 0.625000);
    }
