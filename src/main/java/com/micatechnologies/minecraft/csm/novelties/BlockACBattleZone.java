...
/**
 * Arcade cabinet block representing the classic Battlezone arcade game. Plays cabinet sounds when
 * right-clicked and emits light.
 *
 * @author Mica Technologies
 * @since 2026.4
 */
public class BlockACBattleZone extends AbstractBlockRotatableNSEWUD {

  public BlockACBattleZone() {
  ...
  public boolean onBlockActivated(World world, BlockPos pos, IBlockState state,
    ...
    if (!world.isRemote) {
      SoundEvent sound = CsmSounds.SOUND.BZ_CABINET.getSoundEvent();
      if (sound != null) {
