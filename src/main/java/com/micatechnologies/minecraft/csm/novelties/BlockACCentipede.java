...
/**
 * Arcade cabinet block representing the classic Centipede arcade game. Plays cabinet sounds when
 * right-clicked and emits light.
 *
 * @author Mica Technologies
 * @since 2026.4
 */
public class BlockACCentipede extends AbstractBlockRotatableNSEWUD {

  public BlockACCentipede() {
  ...
  public boolean onBlockActivated(World world, BlockPos pos, IBlockState state,
    ...
    if (!world.isRemote) {
      SoundEvent sound = CsmSounds.SOUND.CP_CABINET.getSoundEvent();
      if (sound != null) {
