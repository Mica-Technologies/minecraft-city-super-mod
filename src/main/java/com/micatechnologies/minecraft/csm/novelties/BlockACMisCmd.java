...
/**
 * Arcade cabinet block representing the classic Missile Command arcade game. Plays cabinet sounds
 * when right-clicked and emits light.
 *
 * @author Mica Technologies
 * @since 2026.4
 */
public class BlockACMisCmd extends AbstractBlockRotatableNSEW {

  public BlockACMisCmd() {
  ...
  public boolean onBlockActivated(World world, BlockPos pos, IBlockState state,
    ...
    if (!world.isRemote) {
      SoundEvent sound = FurnishingsSounds.MISCMD_CABINET.getSoundEvent();
      if (sound != null) {
