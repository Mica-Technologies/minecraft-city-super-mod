...
public class BlockControllableDoghouseSecondaryLeftSignal extends AbstractBlockControllableSignalHead {

  public BlockControllableDoghouseSecondaryLeftSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllabledoghousesignalsecondaryleft";
  }
