...
public class BlockControllableVerticalRightFlashYellowSignal
    extends AbstractBlockControllableSignalHead {

  public BlockControllableVerticalRightFlashYellowSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllableverticalrightflashyellowsignal";
  }
