...
public class BlockControllableSingleSolidSignalGreenRightAngle
    extends AbstractBlockControllableSignalHead implements
    ICsmRetiringBlock {

  public BlockControllableSingleSolidSignalGreenRightAngle() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllablesinglesolidsignalgreenrightangle";
  }
