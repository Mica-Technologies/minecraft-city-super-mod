...
public class TileEntityTrafficSignalController extends AbstractTickableTileEntity
{
     ...
     * @since 2.0
     */
    private static final String NBT_KEY_YELLOW_TIME = "tcYellowTime";
     ...
     * @since 2.0
     */
    private static final String NBT_KEY_FLASH_DONT_WALK_TIME = "tcFlashDontWalkTime";
     ...
     * @since 2.0
     */
    private static final String NBT_KEY_ALL_RED_TIME = "tcAllRedTime";
     ...
     * @since 2.0
     */
    private static final String NBT_KEY_MIN_REQUESTABLE_SERVICE_TIME = "tcMinRequestableServiceTime";
     ...
     * @since 2.0
     */
    private static final String NBT_KEY_MAX_REQUESTABLE_SERVICE_TIME = "tcMaxRequestableServiceTime";
     ...
     * @since 2.0
     */
    private static final String NBT_KEY_MIN_GREEN_TIME = "tcMinGreenTime";
     ...
     * @since 2.0
     */
    private static final String NBT_KEY_MAX_GREEN_TIME = "tcMaxGreenTime";
     ...
     * @since 2.0
     */
    private static final String NBT_KEY_MIN_GREEN_TIME_SECONDARY = "tcMinGreenSecondaryTime";
     ...
     * @since 2.0
     */
    private static final String NBT_KEY_MAX_GREEN_TIME_SECONDARY = "tcMaxGreenSecondaryTime";
    ...
    public NBTTagCompound writeNBT( NBTTagCompound compound ) {
        ...
        compound.setLong( NBT_KEY_YELLOW_TIME, yellowTime );

        // Write the flashing don't walk time to NBT
        compound.setLong( NBT_KEY_FLASH_DONT_WALK_TIME, flashDontWalkTime );

        // Write the all red time to NBT
        compound.setLong( NBT_KEY_ALL_RED_TIME, allRedTime );

        // Write the minimum requestable service time to NBT
        compound.setLong( NBT_KEY_MIN_REQUESTABLE_SERVICE_TIME, minRequestableServiceTime );

        // Write the maximum requestable service time to NBT
        compound.setLong( NBT_KEY_MAX_REQUESTABLE_SERVICE_TIME, maxRequestableServiceTime );

        // Write the minimum green time to NBT
        compound.setLong( NBT_KEY_MIN_GREEN_TIME, minGreenTime );

        // Write the maximum green time to NBT
        compound.setLong( NBT_KEY_MAX_GREEN_TIME, maxGreenTime );

        // Write the secondary minimum green time to NBT
        compound.setLong( NBT_KEY_MIN_GREEN_TIME_SECONDARY, minGreenTimeSecondary );

        // Write the secondary maximum green time to NBT
        compound.setLong( NBT_KEY_MAX_GREEN_TIME_SECONDARY, maxGreenTimeSecondary );
    ...
    public void readNBT( NBTTagCompound compound ) {
        ...
        if ( compound.hasKey( NBT_KEY_YELLOW_TIME ) ) {
            yellowTime = compound.getLong( NBT_KEY_YELLOW_TIME );
        }

        // Load the traffic signal controller flashing don't walk time
        if ( compound.hasKey( NBT_KEY_FLASH_DONT_WALK_TIME ) ) {
            flashDontWalkTime = compound.getLong( NBT_KEY_FLASH_DONT_WALK_TIME );
        }

        // Load the traffic signal controller all red time
        if ( compound.hasKey( NBT_KEY_ALL_RED_TIME ) ) {
            allRedTime = compound.getLong( NBT_KEY_ALL_RED_TIME );
        }

        // Load the traffic signal controller minimum requestable service time
        if ( compound.hasKey( NBT_KEY_MIN_REQUESTABLE_SERVICE_TIME ) ) {
            minRequestableServiceTime = compound.getLong( NBT_KEY_MIN_REQUESTABLE_SERVICE_TIME );
        }

        // Load the traffic signal controller maximum requestable service time
        if ( compound.hasKey( NBT_KEY_MAX_REQUESTABLE_SERVICE_TIME ) ) {
            maxRequestableServiceTime = compound.getLong( NBT_KEY_MAX_REQUESTABLE_SERVICE_TIME );
        }

        // Load the traffic signal controller minimum green time
        if ( compound.hasKey( NBT_KEY_MIN_GREEN_TIME ) ) {
            minGreenTime = compound.getLong( NBT_KEY_MIN_GREEN_TIME);
        }

        // Load the traffic signal controller maximum green time
        if ( compound.hasKey( NBT_KEY_MAX_GREEN_TIME ) ) {
            maxGreenTime = compound.getLong( NBT_KEY_MAX_GREEN_TIME );
        }

        // Load the traffic signal controller secondary minimum green time
        if ( compound.hasKey( NBT_KEY_MIN_GREEN_TIME_SECONDARY ) ) {
            minGreenTimeSecondary = compound.getLong( NBT_KEY_MIN_GREEN_TIME_SECONDARY );
        }

        // Load the traffic signal controller secondary maximum green time
        if ( compound.hasKey( NBT_KEY_MAX_GREEN_TIME_SECONDARY ) ) {
            maxGreenTimeSecondary = compound.getLong( NBT_KEY_MAX_GREEN_TIME_SECONDARY );
        }
    }
