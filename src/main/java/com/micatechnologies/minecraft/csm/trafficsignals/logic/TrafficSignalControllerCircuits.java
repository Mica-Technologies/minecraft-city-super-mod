...
/**
 * The class representation of a list of traffic signal controller circuits in a format which can be
...
public class TrafficSignalControllerCircuits {
  ...
  /**
   * Gets a {@link TrafficSignalControllerCircuits} object containing the data for the list of
   * traffic signal controller circuits in NBT format.
   *
   * @param nbt The {@link NBTTagCompound} containing the data for the list of traffic signal
   *            controller circuits in NBT format.
   *
   * @return The {@link TrafficSignalControllerCircuits} object containing the data for the list of
   *     traffic signal controller circuits in NBT format.
   *
  ...
  /**
   * Adds the specified {@link TrafficSignalControllerCircuit} to the list of
  ...
  /**
   * Gets the number of {@link TrafficSignalControllerCircuit}s configured for the traffic signal
   * controller.
   *
   * @return The number of {@link TrafficSignalControllerCircuit}s configured for the traffic signal
   *     controller.
   *
   * @since 1.0
   */
  ...
  /**
   * Unlinks the device at the specified {@link BlockPos} from the applicable
   * {@link TrafficSignalControllerCircuit}, if present.
   *
  ...
  /**
   * Executes the specified {@link java.util.function.Consumer} for each signal device linked to any
   * (all) of the {@link TrafficSignalControllerCircuit}s for the traffic signal controller.
   *
   * @param action The {@link java.util.function.Consumer} to execute for each signal device linked
   *               to any (all) of the {@link TrafficSignalControllerCircuit}s for the traffic
   *               signal controller.
   *
   * @since 1.0
   */
  ...
  /**
   * Powers off each signal device linked to any (all) of the
   * {@link TrafficSignalControllerCircuit}s for the traffic signal controller.
   *
  ...
  /**
   * Gets an {@link NBTTagCompound} containing the data for the list of traffic signal controller
   * circuits in NBT format.
   *
   * @return The {@link NBTTagCompound} containing the data for the list of traffic signal
   *     controller circuits in NBT format.
   *     <p>
  ...
  /**
   * Checks if the given {@link Object} is equal to this {@link TrafficSignalControllerCircuits}
   * object.
   *
   * @param o The {@link Object} to check.
   *
   * @return {@code true} if the given {@link Object} is equal to this
   *     {@link TrafficSignalControllerCircuits} object, {@code false} otherwise.
   *
   * @since 1.0
   */
  @Override
