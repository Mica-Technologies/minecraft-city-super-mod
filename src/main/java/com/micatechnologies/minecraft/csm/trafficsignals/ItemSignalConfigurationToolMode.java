...
/**
 * Enum representing the different modes of the signal configuration tool item and corresponding friendly names.
 *
...
public enum ItemSignalConfigurationToolMode
{
    ...
    TOGGLE_CONTROLLER_OVERLAP_PEDESTRIAN_SIGNALS_SETTING( "Toggle Controller Overlap Pedestrian Signals Setting" ),
    ...
    /**
     * Constructs a new {@link ItemSignalConfigurationToolMode} enum value with the given friendly name.
     *
     * @param friendlyName The friendly name for the {@link ItemSignalConfigurationToolMode} enum value.
     *
     * @since 1.0
     */
