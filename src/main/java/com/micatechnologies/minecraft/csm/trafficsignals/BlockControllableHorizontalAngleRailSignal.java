...
public class BlockControllableHorizontalAngleRailSignal extends AbstractBlockControllableSignalHead implements
    ICsmRetiringBlock {

  public BlockControllableHorizontalAngleRailSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllablehorizontalanglerailsignal";
  }
  ...
  public String getReplacementBlockId() {
    return "controllablehorizontalrailsignal";
  }
