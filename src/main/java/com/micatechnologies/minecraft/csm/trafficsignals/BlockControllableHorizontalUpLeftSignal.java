...
public class BlockControllableHorizontalUpLeftSignal extends AbstractBlockControllableSignalHead {

  public BlockControllableHorizontalUpLeftSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllablehorizontalupleftsignal";
  }
