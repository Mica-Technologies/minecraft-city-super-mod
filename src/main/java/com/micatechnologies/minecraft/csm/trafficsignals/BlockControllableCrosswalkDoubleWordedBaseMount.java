...
/**
 * Double-worded crosswalk signal block with a base mount. Displays the walk/do-not-walk text in a
 * two-line format. Countdown overlay is not supported for this variant.
 *
 * @author Mica Technologies
 * @since 1.0
 */
public class BlockControllableCrosswalkDoubleWordedBaseMount
  ...
  public String getBlockRegistryName() {
    return "controllablecrosswalkdoublewordedbasemount";
  }
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.125000, -0.187500, 0.000000, 0.875000, 1.562500, 0.687500);
    }
