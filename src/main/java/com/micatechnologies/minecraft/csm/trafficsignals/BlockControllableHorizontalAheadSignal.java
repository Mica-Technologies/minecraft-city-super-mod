...
public class BlockControllableHorizontalAheadSignal extends AbstractBlockControllableSignalHead {

  public BlockControllableHorizontalAheadSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllablehorizontalaheadsignal";
  }
