...
public class BlockControllableHorizontalUTurnSignal extends AbstractBlockControllableSignalHead {

  public BlockControllableHorizontalUTurnSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllablehorizontaluturnsignal";
  }
