...
public class BlockControllableDoghouseSecondaryLeftFYASignal
    extends AbstractBlockControllableSignalHead {

  public BlockControllableDoghouseSecondaryLeftFYASignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllabledoghousesignalsecondaryleftfya";
  }
