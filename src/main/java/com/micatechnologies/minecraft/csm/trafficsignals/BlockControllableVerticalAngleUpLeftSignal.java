...
public class BlockControllableVerticalAngleUpLeftSignal extends AbstractBlockControllableSignalHead implements
    ICsmRetiringBlock {

  public BlockControllableVerticalAngleUpLeftSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllableverticalangleupleftsignal";
  }
