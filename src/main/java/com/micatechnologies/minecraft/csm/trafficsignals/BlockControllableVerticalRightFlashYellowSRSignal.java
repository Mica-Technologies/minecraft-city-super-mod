...
public class BlockControllableVerticalRightFlashYellowSRSignal
    extends AbstractBlockControllableSignalHead {

  public BlockControllableVerticalRightFlashYellowSRSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllableverticalrightflashyellowsrsignal";
  }
