...
public class BlockControllableVerticalSolidFlashGreenSignalGray
    extends AbstractBlockControllableSignalHead implements
    ICsmRetiringBlock {

  public BlockControllableVerticalSolidFlashGreenSignalGray() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllableverticalsolidflashgreensignalgray";
  }
  ...
  public String getReplacementBlockId() {
    return "controllableverticalsolidflashgreensignal";
  }
}
