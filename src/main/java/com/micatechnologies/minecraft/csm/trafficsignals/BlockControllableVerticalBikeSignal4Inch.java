...
public class BlockControllableVerticalBikeSignal4Inch extends AbstractBlockControllableSignalHead {

  public BlockControllableVerticalBikeSignal4Inch() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllableverticalbikesignal4inch";
  }

  @Override
  public float[] getSectionYPositions(int sectionCount) {
    // 4-inch sections: tighter vertical spacing than 8-inch
    return new float[] {-1.0f, -5.0f, -9.0f};
  }
