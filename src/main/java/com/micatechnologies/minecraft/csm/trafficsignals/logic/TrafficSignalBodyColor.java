...
public enum TrafficSignalBodyColor implements IStringSerializable {
  ...
  DARK_OLIVE_GREEN("dark_olive_green", "Dark Olive Green", 0.33333334F, 0.41960785F, 0.18431373F),
  BATTLESHIP_GRAY("battleship_gray", "Battleship Gray", 0.5019608F, 0.5019608F, 0.5019608F),
  YELLOW("yellow", "Yellow", 1.0F, 1.0F, 0.0F);
