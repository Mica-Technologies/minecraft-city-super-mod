...
/**
 * Crosswalk signal block with a left-side pole mount angled at 90 degrees. The angled geometry
 * means countdown overlay rendering is not supported for this variant.
 *
 * @author Mica Technologies
 * @since 1.0
 */
public class BlockControllableCrosswalkLeftMount90Deg
  ...
  public float getCountdownZOffset() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.000000, 0.000000, 0.250000, 1.812500, 1.250000, 0.750000);
    }
