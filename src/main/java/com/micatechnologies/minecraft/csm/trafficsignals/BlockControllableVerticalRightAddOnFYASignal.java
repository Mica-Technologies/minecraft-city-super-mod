...
public class BlockControllableVerticalRightAddOnFYASignal extends AbstractBlockControllableSignalHead {

  public BlockControllableVerticalRightAddOnFYASignal() {
    super(Material.ROCK);
  }
