...
public class BlockControllableVerticalHybridLeftSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllableverticalhybridleftsignal" )
    public static final Block block = null;

    public BlockControllableVerticalHybridLeftSignal( ElementsCitySuperMod instance ) {
        super( instance, 3331 );
    }
    ...
    public static class BlockCustom extends AbstractBlockControllableSignal
    {
        public BlockCustom() {
            super( Material.ROCK );
            setRegistryName( "controllableverticalhybridleftsignal" );
            setUnlocalizedName( "controllableverticalhybridleftsignal" );
