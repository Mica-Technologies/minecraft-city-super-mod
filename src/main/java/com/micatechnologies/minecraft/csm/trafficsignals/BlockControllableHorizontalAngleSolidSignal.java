...
public class BlockControllableHorizontalAngleSolidSignal extends AbstractBlockControllableSignalHead implements
    ICsmRetiringBlock {

  public BlockControllableHorizontalAngleSolidSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllablehorizontalanglesolidsignal";
  }
  ...
  public String getReplacementBlockId() {
    return "controllablehorizontalsolidsignal";
  }
