...
public class BlockControllableDoghouseMainLeftSignal extends AbstractBlockControllableSignalHead {

  public BlockControllableDoghouseMainLeftSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllabledoghousesignalmainleft";
  }
