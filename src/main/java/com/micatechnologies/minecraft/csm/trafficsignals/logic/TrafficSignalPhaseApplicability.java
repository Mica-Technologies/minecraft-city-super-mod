...
public enum TrafficSignalPhaseApplicability
{
    ...
    /**
     * The integer value of the {@link TrafficSignalPhaseApplicability} object.
     *
     * @since 1.0
     */
    ...
    /**
     * Constructor of the enumeration with the corresponding integer value of the
     * {@link TrafficSignalPhaseApplicability} enum.
     *
     * @param value the integer value of the {@link TrafficSignalPhaseApplicability} object to be constructed
     *
     * @since 1.0
     */
    TrafficSignalPhaseApplicability( int value )
    {
        this.value = value;
    }
    ...
    /**
     * Gets the corresponding integer value of the {@link TrafficSignalPhaseApplicability} object.
     *
     * @return the integer value of the {@link TrafficSignalPhaseApplicability} object
     *
     * @since 1.0
     */
    public int getValue()
