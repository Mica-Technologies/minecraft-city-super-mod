...
/**
 * Enumeration of the different directions of a traffic signal phase, such as left turns, right
 * turns, all east signals, all west signals, etc.
 *
...
public enum TrafficSignalPhaseApplicability {
  ...
  /**
   * Enumeration value for requestable default green + flashing don't walk + flashing yellow HAWK
   * (High-Intensity Activated crossWalK beacon) signals applicability.
   *
   * @since 1.0
   */
  ...
  /**
   * Enumeration value for requestable service green + flashing don't walk + flashing yellow HAWK
   * (High-Intensity Activated crossWalK beacon) signals applicability.
   *
   * @since 1.0
   */
   ...
   * {@link TrafficSignalPhaseApplicability#NONE} if no {@link TrafficSignalPhaseApplicability} enum
   * with the specified ordinal value exists. This can be used to retrieve a
   * {@link TrafficSignalPhaseApplicability} enum from NBT data which was saved using the
   * {@link #toNBT()} method.
   *
   ...
   *     {@link TrafficSignalPhaseApplicability#NONE} if no {@link TrafficSignalPhaseApplicability}
   *     enum with the specified ordinal value exists
   *
   * @since 1.0
   */
  ...
  /**
   * Gets the ordinal value of the {@link TrafficSignalPhaseApplicability} enum. This can be used to
   * store a {@link TrafficSignalPhaseApplicability} enum in NBT data to be retrieved later using
   * the {@link #fromNBT(int)} method.
   *
