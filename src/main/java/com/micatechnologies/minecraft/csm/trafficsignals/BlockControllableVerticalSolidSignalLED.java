...
public class BlockControllableVerticalSolidSignalLED extends AbstractBlockControllableSignalHead {

  public BlockControllableVerticalSolidSignalLED() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllableverticalsolidsignalled";
  }
