...
public class TrafficSignalPhases
{
    ...
    public TrafficSignalPhases( TrafficSignalControllerCircuits trafficSignalControllerCircuits )
    {
        ...
        TrafficSignalPhase offPhase = new TrafficSignalPhase( TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, 0, 0,
        ...
        TrafficSignalPhase flashPhase1 = new TrafficSignalPhase( TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, 0, 0,
        ...
        TrafficSignalPhase flashPhase2 = new TrafficSignalPhase( TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, 0, 0,
                                                                 TrafficSignalPhaseApplicability.NONE );
        circuitIndex = 1;
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
        ...
        TrafficSignalPhase faultPhase1 = new TrafficSignalPhase( TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, 0, 0,
                                                                 TrafficSignalPhaseApplicability.NONE );
        circuitIndex = 1;
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
        ...
        // Create a new TrafficSignalPhase object for second flash phase
        TrafficSignalPhase faultPhase2 = new TrafficSignalPhase( TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, 0, 0,
                                                                 TrafficSignalPhaseApplicability.NONE );
        circuitIndex = 1;
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            // Odd circuits should be off, even circuits should flash red
        ...
        TrafficSignalPhase allRedPhase = new TrafficSignalPhase( TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, 0, 0,
                                                                 TrafficSignalPhaseApplicability.NONE );
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            allRedPhase.addRedSignals( circuit.getPedestrianSignals() );
            allRedPhase.addRedSignals( circuit.getPedestrianBeaconSignals() );
            allRedPhase.addRedSignals( circuit.getPedestrianAccessorySignals() );
        }
        ...
        TrafficSignalPhase rampMeterFlash1Phase = new TrafficSignalPhase( TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, 0,
                                                                          0, TrafficSignalPhaseApplicability.NONE );
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            rampMeterFlash1Phase.addOffSignals( circuit.getPedestrianSignals() );
        ...
        TrafficSignalPhase rampMeterFlash2Phase = new TrafficSignalPhase( TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, 0,
                                                                          0, TrafficSignalPhaseApplicability.NONE );
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            rampMeterFlash2Phase.addOffSignals( circuit.getPedestrianSignals() );
        ...
        TrafficSignalPhase requestableDefaultGreenPhase = new TrafficSignalPhase(
                TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, 0, 0,
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableDefaultGreenPhase.addGreenSignals( circuit.getPedestrianSignals() );
                requestableDefaultGreenPhase.addOffSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultGreenPhase.addGreenSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
                ...
                requestableDefaultGreenPhase.addRedSignals( circuit.getPedestrianSignals() );
                requestableDefaultGreenPhase.addRedSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultGreenPhase.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            circuitIndex++;
        }
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableDefaultGreenFlashDwPhase.addYellowSignals( circuit.getPedestrianSignals() );
                requestableDefaultGreenFlashDwPhase.addOffSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultGreenFlashDwPhase.addYellowSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
                ...
                requestableDefaultGreenFlashDwPhase.addRedSignals( circuit.getPedestrianSignals() );
                requestableDefaultGreenFlashDwPhase.addGreenSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultGreenFlashDwPhase.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            circuitIndex++;
        }
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableDefaultGreenFlashDwHawkPhase1.addYellowSignals( circuit.getPedestrianSignals() );
                requestableDefaultGreenFlashDwHawkPhase1.addYellowSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultGreenFlashDwHawkPhase1.addYellowSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
                ...
                requestableDefaultGreenFlashDwHawkPhase1.addRedSignals( circuit.getPedestrianSignals() );
                requestableDefaultGreenFlashDwHawkPhase1.addGreenSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultGreenFlashDwHawkPhase1.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            circuitIndex++;
        }
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableDefaultGreenFlashDwHawkPhase2.addYellowSignals( circuit.getPedestrianSignals() );
                requestableDefaultGreenFlashDwHawkPhase2.addOffSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultGreenFlashDwHawkPhase2.addYellowSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
                ...
                requestableDefaultGreenFlashDwHawkPhase2.addRedSignals( circuit.getPedestrianSignals() );
                requestableDefaultGreenFlashDwHawkPhase2.addGreenSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultGreenFlashDwHawkPhase2.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            circuitIndex++;
        }
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableDefaultYellowPhase.addRedSignals( circuit.getPedestrianSignals() );
                requestableDefaultYellowPhase.addYellowSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultYellowPhase.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableDefaultRedPhase.addRedSignals( circuit.getPedestrianSignals() );
                requestableDefaultRedPhase.addRedSignals( circuit.getPedestrianBeaconSignals() );
                requestableDefaultRedPhase.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
                requestableDefaultRedPhase.addRedSignals( circuit.getFlashingLeftSignals() );
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableServiceGreenPhase.addRedSignals( circuit.getPedestrianSignals() );
                requestableServiceGreenPhase.addRedSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceGreenPhase.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
                ...
                requestableServiceGreenPhase.addGreenSignals( circuit.getPedestrianSignals() );
                requestableServiceGreenPhase.addOffSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceGreenPhase.addGreenSignals( circuit.getPedestrianAccessorySignals() );
            }
            circuitIndex++;
        }
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableServiceGreenFlashDwPhase.addRedSignals( circuit.getPedestrianSignals() );
                requestableServiceGreenFlashDwPhase.addGreenSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceGreenFlashDwPhase.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
                ...
                requestableServiceGreenFlashDwPhase.addYellowSignals( circuit.getPedestrianSignals() );
                requestableServiceGreenFlashDwPhase.addOffSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceGreenFlashDwPhase.addYellowSignals( circuit.getPedestrianAccessorySignals() );
            }
            circuitIndex++;
        }
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableServiceGreenFlashDwHawkPhase1.addRedSignals( circuit.getPedestrianSignals() );
                requestableServiceGreenFlashDwHawkPhase1.addGreenSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceGreenFlashDwHawkPhase1.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
                ...
                requestableServiceGreenFlashDwHawkPhase1.addYellowSignals( circuit.getPedestrianSignals() );
                requestableServiceGreenFlashDwHawkPhase1.addYellowSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceGreenFlashDwHawkPhase1.addYellowSignals( circuit.getPedestrianAccessorySignals() );
            }
            circuitIndex++;
        }
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableServiceGreenFlashDwHawkPhase2.addRedSignals( circuit.getPedestrianSignals() );
                requestableServiceGreenFlashDwHawkPhase2.addGreenSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceGreenFlashDwHawkPhase2.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
                ...
                requestableServiceGreenFlashDwHawkPhase2.addYellowSignals( circuit.getPedestrianSignals() );
                requestableServiceGreenFlashDwHawkPhase2.addOffSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceGreenFlashDwHawkPhase2.addYellowSignals( circuit.getPedestrianAccessorySignals() );
            }
            circuitIndex++;
        }
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableServiceYellowPhase.addRedSignals( circuit.getPedestrianSignals() );
                requestableServiceYellowPhase.addGreenSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceYellowPhase.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
        ...
        for ( TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits() ) {
            ...
            if ( circuitIndex == 1 ) {
                ...
                requestableServiceRedPhase.addRedSignals( circuit.getPedestrianSignals() );
                requestableServiceRedPhase.addGreenSignals( circuit.getPedestrianBeaconSignals() );
                requestableServiceRedPhase.addRedSignals( circuit.getPedestrianAccessorySignals() );
            }
            // Handle second + higher circuits
            else {
                requestableServiceRedPhase.addRedSignals( circuit.getFlashingLeftSignals() );
