...
/**
 * A class implementation of an easily indexed and accessed array of {@link TrafficSignalPhase}s
 * which can be easily serialized and deserialized as Minecraft NBT data.
 *
...
public class TrafficSignalPhases {
  ...
  /**
   * The phase index value for the first requestable default green + flashing don't walk + flashing
   * yellow HAWK (High-Intensity Activated crossWalK beacon) phase.
   *
   * @since 1.0
   */
  ...
  /**
   * The phase index value for the second requestable default green + flashing don't walk + flashing
   * yellow HAWK (High-Intensity Activated crossWalK beacon) phase.
   *
   * @since 1.0
   */
  ...
  /**
   * The phase index value for the first requestable service green + flashing don't walk + flashing
   * yellow HAWK (High-Intensity Activated crossWalK beacon) phase.
   *
   * @since 1.0
   */
  ...
  /**
   * The phase index value for the second requestable service green + flashing don't walk + flashing
   * yellow HAWK (High-Intensity Activated crossWalK beacon) phase.
   *
   * @since 1.0
   */
  ...
  /**
   * Creates a new {@link TrafficSignalPhases} object with the applicable
   * {@link TrafficSignalPhase}s from the given {@link TrafficSignalControllerMode} and
  ...
  public TrafficSignalPhases(World world,
    ...
    TrafficSignalPhase offPhase = new TrafficSignalPhase(TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE,
        null,
    ...
    TrafficSignalPhase flashPhase1 = new TrafficSignalPhase(
        TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, null,
        TrafficSignalPhaseApplicability.NONE);
    int circuitIndex = 1;
    for (TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits()) {
      // First circuit should flash yellow, even circuits should be off, odd circuits should
      // flash red
      if (circuitIndex == 1) {
    ...
    TrafficSignalPhase flashPhase2 = new TrafficSignalPhase(
        TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, null,
        TrafficSignalPhaseApplicability.NONE);
    circuitIndex = 1;
    for (TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits()) {
    ...
    // Create a new TrafficSignalPhase object for second flash phase
    TrafficSignalPhase faultPhase2 = new TrafficSignalPhase(
        TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE, null,
        TrafficSignalPhaseApplicability.NONE);
    circuitIndex = 1;
    for (TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits()) {
    ...
    TrafficSignalPhase rampMeterDisabledPhase = new TrafficSignalPhase(
        TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE,
        null,
    ...
    TrafficSignalPhase rampMeterStartingPhase = new TrafficSignalPhase(
        TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE,
        null,
    ...
    TrafficSignalPhase rampMeterFlash1Phase = new TrafficSignalPhase(
        TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE,
    ...
    TrafficSignalPhase rampMeterFlash2Phase = new TrafficSignalPhase(
        TrafficSignalPhase.CIRCUIT_NOT_APPLICABLE,
        null, TrafficSignalPhaseApplicability.NONE);
    for (TrafficSignalControllerCircuit circuit : trafficSignalControllerCircuits.getCircuits()) {
    ...
    // Create a new TrafficSignalPhase object for requestable default green + flashing don't walk
    // phase
    ...
    // Create a new TrafficSignalPhase object for first requestable default green + flashing
    // don't walk + flashing
    ...
    phases[PHASE_INDEX_REQUESTABLE_DEFAULT_GREEN_FLASH_DW_HAWK_1] =
        requestableDefaultGreenFlashDwHawkPhase1;

    // Create a new TrafficSignalPhase object for second requestable default green + flashing
    // don't walk + flashing
    // yellow HAWK (High-Intensity Activated crossWalK) phase
    ...
    phases[PHASE_INDEX_REQUESTABLE_DEFAULT_GREEN_FLASH_DW_HAWK_2] =
        requestableDefaultGreenFlashDwHawkPhase2;
    ...
    // Create a new TrafficSignalPhase object for requestable service green + flashing don't walk
    // phase
    ...
    // Create a new TrafficSignalPhase object for first requestable service green + flashing
    // don't walk + flashing
    // yellow HAWK (High-Intensity Activated crossWalK) phase
    ...
    phases[PHASE_INDEX_REQUESTABLE_SERVICE_GREEN_FLASH_DW_HAWK_1] =
        requestableServiceGreenFlashDwHawkPhase1;

    // Create a new TrafficSignalPhase object for second requestable service green + flashing
    // don't walk + flashing
    // yellow HAWK (High-Intensity Activated crossWalK) phase
    ...
    phases[PHASE_INDEX_REQUESTABLE_SERVICE_GREEN_FLASH_DW_HAWK_2] =
        requestableServiceGreenFlashDwHawkPhase2;
  ...
  /**
   * Private constructor for creating a new {@link TrafficSignalPhases} object from the given array
   * of {@link TrafficSignalPhase}s from an {@link NBTTagCompound}.
   *
   ...
   *
   * @param nbt The {@link NBTTagCompound} containing the data for the {@link TrafficSignalPhases}
  ...
  /**
   * Verifies that the number of {@link TrafficSignalPhase}s in this {@link TrafficSignalPhases}
   * object is equal to the expected number of phases, defined by {@link #PHASE_INDEX_COUNT}.
   *
   * @return {@code true} if the number of {@link TrafficSignalPhase}s in this
   *     {@link TrafficSignalPhases} object is equal to the expected number of phases, defined by
   *     {@link #PHASE_INDEX_COUNT}, {@code false} otherwise.
   */
  ...
  /**
   * Gets an {@link NBTTagCompound} containing the data for this {@link TrafficSignalPhases} object
   * in NBT format.
   *
   * @return The {@link NBTTagCompound} containing the data for this {@link TrafficSignalPhases}
   *     object in NBT format.
   *     <p>
   *     The returned {@link NBTTagCompound} can be used to reconstruct the
   *     {@link TrafficSignalPhases} object.
   *     </p>
   *
   * @see #fromNBT(NBTTagCompound)
   * @since 1.0
   ...
   *
   * @return {@code true} if the given {@link Object} is equal to this {@link TrafficSignalPhases}
