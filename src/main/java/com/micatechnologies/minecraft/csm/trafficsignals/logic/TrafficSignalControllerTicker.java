...
public class TrafficSignalControllerTicker
{
     ...
     * @param minRequestableServiceTime             The minimum service time for the traffic signal controller when in
     *                                              requestable mode.
     * @param maxRequestableServiceTime             The maximum service time for the traffic signal controller when in
     *                                              requestable mode.
                                                     ...
                                                     long dedicatedPedSignalTime )
    {
        ...
        // If original phase is green, get corresponding min/max green times and check for phase change
            ...
            if ( timeSinceLastPhaseChange >= phaseMinGreenTimeMs ) {
                ...
                // If the current phase priority indicator is different than the upcoming phase priority indicator, then
