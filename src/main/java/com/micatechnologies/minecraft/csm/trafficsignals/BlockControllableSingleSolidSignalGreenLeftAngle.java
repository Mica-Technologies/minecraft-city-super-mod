...
public class BlockControllableSingleSolidSignalGreenLeftAngle
    extends AbstractBlockControllableSignalHead implements
    ICsmRetiringBlock {

  public BlockControllableSingleSolidSignalGreenLeftAngle() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllablesinglesolidsignalgreenleftangle";
  }
