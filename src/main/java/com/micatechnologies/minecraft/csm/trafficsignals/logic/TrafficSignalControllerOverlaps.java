...
/**
 * Class representation of a traffic signal controller's overlaps. Overlaps are used to determine which signals can
 * safely be green at the same time.
 *
 * <p>For example, in some scenarios, a left turn signal on circuit 1 can be green at the same time as a right turn
 * signal on circuit 2 if the movements are physically separated.
 *
...
public class TrafficSignalControllerOverlaps
{
    ...
    /**
     * Gets the {@link List<BlockPos>} of overlaps for the given source {@link BlockPos}. If no overlaps are configured
     * for the given source, null is returned.
     *
     * @param overlapSource The {@link BlockPos} of the source device.
     *
     * @return The {@link List<BlockPos>} of overlaps for the given source {@link BlockPos}. If no overlaps are
     *         configured for the given source, null is returned.
     *
     * @since 1.0
     */
    ...
    /**
     * Removes all overlaps for the given source {@link BlockPos} from the traffic signal controller and returns true if
     * successful.
     *
     * @param overlapSource the {@link BlockPos} of the source device
     *
    ...
    /**
     * Gets an {@link NBTTagCompound} containing the data for this {@link TrafficSignalControllerOverlaps} in NBT
     * format.
     *
     * @return The {@link NBTTagCompound} containing the data for this {@link TrafficSignalControllerOverlaps} in NBT
     *         format.
     *         <p>
     ...
     *
     * @param nbt The {@link NBTTagCompound} containing the data for the {@link TrafficSignalControllerOverlaps} object
     *            in NBT format.
     *
     * @return The {@link TrafficSignalControllerOverlaps} object from the given {@link NBTTagCompound}.
     *
