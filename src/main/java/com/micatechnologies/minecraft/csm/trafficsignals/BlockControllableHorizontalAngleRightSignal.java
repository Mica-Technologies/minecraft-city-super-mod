...
public class BlockControllableHorizontalAngleRightSignal extends AbstractBlockControllableSignalHead {

  public BlockControllableHorizontalAngleRightSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllablehorizontalanglerightsignal";
  }
