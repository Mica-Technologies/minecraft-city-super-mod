...
public class BlockControllableVerticalSolidFlashRedSignal extends AbstractBlockControllableSignalHead {

  public BlockControllableVerticalSolidFlashRedSignal() {
    super(Material.ROCK);
  }
