...
public class BlockControllableVerticalRightDoubleAddOnSignalGray
    extends AbstractBlockControllableSignalHead implements
    ICsmRetiringBlock {

  public BlockControllableVerticalRightDoubleAddOnSignalGray() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllableverticalrightdoubleaddonsignalgray";
  }
  ...
  public String getReplacementBlockId() {
    return "controllableverticalrightdoubleaddonsignal";
  }
}
