...
public abstract class AbstractBlockControllableSignalHead extends AbstractBlockControllableSignal
  ...
  public static final PropertyEnum<DirectionSixteen> TILTED_FACING =
      PropertyEnum.create("titled_facing", DirectionSixteen.class);
  ...
  protected @NotNull BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, FACING, COLOR, BODY_COLOR, TILTED_FACING, VISOR_TYPE);
  }

  protected @NotNull DirectionSixteen getTiltedFacing(@NotNull IBlockState state) {
    return state.getValue(TILTED_FACING);
  }
  ...
  public @NotNull IBlockState getActualState(@NotNull IBlockState state,
    ...
    if (tileEntity instanceof TileEntityTrafficSignalHead trafficSignalHead) {
      ...
      return state.withProperty(BODY_COLOR, statePaintColor)
          .withProperty(TILTED_FACING, stateTiltedFacing)
