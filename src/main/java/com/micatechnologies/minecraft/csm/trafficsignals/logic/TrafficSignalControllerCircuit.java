...
public class TrafficSignalControllerCircuit {
   ...
   *            {@link TrafficSignalControllerCircuit} object in NBT format.
   *
   * @return The {@link TrafficSignalControllerCircuit} object from the given
   *     {@link NBTTagCompound}.
   *
  ...
  public static TrafficSignalControllerCircuit fromNBT(NBTTagCompound nbt) {
    ...
    if (nbt.hasKey(NBT_KEY_NO_TURN_BLANKOUT_SIGNAL_LIST)) {
  ...
  public List<BlockPos> getNoTurnBlankoutSignals() {
  ...
  /**
   * Executes the specified {@link java.util.function.Consumer} for each signal device linked to
   * this circuit.
   *
   * @param action The {@link java.util.function.Consumer} to execute for each signal device linked
   *               to this circuit.
   *
   * @since 1.0
   */
  ...
  /**
   * Gets a boolean indicating whether the specified device {@link BlockPos} is linked to this
   * circuit.
   *
   * @param devicePos The {@link BlockPos} of the device to check.
   *
   * @return True if the specified device {@link BlockPos} is linked to this circuit, false
   *     otherwise.
   *
   * @since 1.0
   */
  ...
  /**
   * Links each signal {@link BlockPos} in the specified list to this circuit as a flashing left
   * signal.
   *
  ...
  /**
   * Links each signal {@link BlockPos} in the specified list to this circuit as a flashing right
   * signal.
   *
   * @param signalPoses The list of {@link BlockPos}es of signals to link.
   *
  ...
  /**
   * Links each signal {@link BlockPos} in the specified list to this circuit as a standard left
   * signal.
   *
   * @param signalPoses The list of {@link BlockPos}es of signals to link.
   *
  ...
  /**
   * Links each signal {@link BlockPos} in the specified list to this circuit as a standard right
   * signal.
   *
   * @param signalPoses The list of {@link BlockPos}es of signals to link.
   *
  ...
  /**
   * Links each signal {@link BlockPos} in the specified list to this circuit as a
   * through/solid/ball signal.
   *
   * @param signalPoses The list of {@link BlockPos}es of signals to link.
   *
   * @since 1.0
  ...
  /**
   * Links each signal {@link BlockPos} in the specified list to this circuit as a pedestrian
   * signal.
   *
   * @param signalPoses The list of {@link BlockPos}es of signals to link.
   *
  ...
  /**
   * Links each signal {@link BlockPos} in the specified list to this circuit as a pedestrian beacon
   * signal.
   *
   * @param signalPoses The list of {@link BlockPos}es of signals to link.
   *
  ...
  /**
   * Links each signal {@link BlockPos} in the specified list to this circuit as a protected
   * signal.
   *
   * @param signalPoses The list of {@link BlockPos}es of signals to link.
   *
  ...
  /**
   * Tries to link the devices in the specified device {@link BlockPos} list to this circuit (for
   * migration from previous NBT data format). If the device is not an
   * {@link AbstractBlockControllableSignal} or {@link AbstractBlockTrafficSignalSensor} then it is
   * ignored. If specified boolean {@code isSensorsList} is true, then the devices will be linked as
   * sensors, otherwise they will be linked as signals. Signal lists can be any type of signal, but
   * sensor lists must be sensors.
   *
   * @param linkWorld     The {@link World} to link the devices in.
   * @param devicePosList The list of {@link BlockPos}es of devices to link.
   * @param isSensorsList Whether the list is a list of sensors. If true, the devices will be linked
   *                      as sensors, otherwise they will be linked as signals.
   *
   * @since 1.0
   */
  public void tryLinkDevicesMigration(World linkWorld, List<BlockPos> devicePosList,
      boolean isSensorsList) {
        ...
        if (signalPos != null) {
          if (isSensorsList) {
            ...
            AbstractBlockControllableSignal controllableSignal
                = AbstractBlockControllableSignal.getSignalBlockInstanceOrNull(linkWorld,
                signalPos);
  ...
  /**
   * Links the specified device {@link BlockPos} to this circuit with the specified
   * {@link SIGNAL_SIDE}
   *
  ...
  public boolean linkNoTurnBlankoutSignal(BlockPos signalPos) {
  ...
  /**
   * Gets a boolean indicating whether all the signals in this circuit are facing the same
   * direction.
   *
   * @param world The {@link World} to check the signals in.
   *
   * @return {@code true} if all the signals in this circuit are facing the same direction,
   ...
   *     {@link TrafficSignalControllerCircuit} object.
   *     </p>
   *
   * @see #fromNBT(NBTTagCompound)
   * @since 1.0
