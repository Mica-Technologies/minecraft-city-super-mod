...
public class BlockControllableVerticalAngle2AheadSignal extends AbstractBlockControllableSignalHead implements
    ICsmRetiringBlock {

  public BlockControllableVerticalAngle2AheadSignal() {
    super(Material.ROCK);
  }
  ...
  public String getBlockRegistryName() {
    return "controllableverticalangle2aheadsignal";
  }
  ...
  public TrafficSignalSectionInfo[] getDefaultTrafficSignalSectionInfo() {
    return new TrafficSignalSectionInfo[] {
        ...
        new TrafficSignalSectionInfo(TrafficSignalBodyColor.FLAT_BLACK, TrafficSignalBodyColor.FLAT_BLACK, TrafficSignalBodyColor.FLAT_BLACK,
            TrafficSignalVisorType.CUTAWAY, TrafficSignalBulbStyle.LED, TrafficSignalBulbType.UP,
  ...
  public String getReplacementBlockId() {
    return "controllableverticalaheadsignal";
  }
