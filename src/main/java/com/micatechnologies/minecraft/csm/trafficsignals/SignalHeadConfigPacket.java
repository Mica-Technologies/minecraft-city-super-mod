 ...
 * signal head configuration GUI. Carries the block position and the action to perform.
 */
public class SignalHeadConfigPacket implements IMessage {

  private BlockPos pos;
  private int actionOrdinal;

  public SignalHeadConfigPacket() {
    // Required by Forge
  }

  public SignalHeadConfigPacket(BlockPos pos, int actionOrdinal) {
    this.pos = pos;
