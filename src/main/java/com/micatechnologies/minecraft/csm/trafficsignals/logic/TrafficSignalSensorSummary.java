...
/**
 * Utility class for providing a summary of sensor information for a {@link TrafficSignalControllerCircuit}, including
 * the cumulative count of waiting entities at all sensors and each individual facing direction, east, west, north,
 * south, up, and down.
 *
...
public class TrafficSignalSensorSummary
{
    ...
    /**
     * Creates a new instance of the {@link TrafficSignalSensorSummary} class with the specified cumulative count of
     * waiting entities at all sensors and each individual facing direction, east, west, north, and south.
     *
