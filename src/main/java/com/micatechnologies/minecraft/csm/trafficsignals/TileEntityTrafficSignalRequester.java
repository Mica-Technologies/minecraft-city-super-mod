...
/**
 * Tile entity utility class for traffic signal requester blocks such as a crosswalk button or
 * sensor. This class assists in tracking and managing the count and state of requests.
 *
...
public class TileEntityTrafficSignalRequester extends TileEntityTrafficSignalTickableRequester {
   ...
   *     implementation always returns false, as the tile entity does not tick.
   *
   * @since 2.0
   */
  @Override
   ...
   * paused, the tick event will not be called. This implementation always returns true as the tile
   * entity does not tick.
   *
   * @return a boolean indicating if the tile entity ticking should be paused. This implementation
   *     always returns true as the tile entity does not tick.
   *
   * @since 2.0
   */
  @Override
  ...
  /**
   * Returns the tick rate of the tile entity. This implementation returns {@link Long#MAX_VALUE} as
   * the tile entity does not tick.
   *
   * @return the tick rate of the tile entity. This implementation returns {@link Long#MAX_VALUE} as
   *     the tile entity does not tick.
   *
   * @since 2.0
   */
