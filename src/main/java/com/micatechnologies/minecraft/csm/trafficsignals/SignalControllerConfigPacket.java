 ...
 * signal controller configuration GUI.
 */
public class SignalControllerConfigPacket implements IMessage {

  private BlockPos pos;
  private int actionOrdinal;

  public SignalControllerConfigPacket() {
  }

  public SignalControllerConfigPacket(BlockPos pos, int actionOrdinal) {
    this.pos = pos;
