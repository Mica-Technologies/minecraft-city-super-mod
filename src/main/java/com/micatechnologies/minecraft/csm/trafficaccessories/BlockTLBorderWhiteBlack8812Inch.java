...
public class BlockTLBorderWhiteBlack8812Inch extends AbstractBlockRotatableNSEWUD
{
    public BlockTLBorderWhiteBlack8812Inch() {
    ...
    public String getBlockRegistryName() {
        return "tlborderwhiteblack8812inch";
    }
