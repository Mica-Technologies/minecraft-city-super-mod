...
public class BlockTrafficPoleVerticalDoubleGuyMountTan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalDoubleGuyMountTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticaldoubleguymounttan";
  }
