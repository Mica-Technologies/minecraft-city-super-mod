...
public class BlockTrafficpoleverticalsignalmountconcrete extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficpoleverticalsignalmountconcrete() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalsignalmountconcrete";
  }
