...
public class BlockDMPTUnpainted extends AbstractBlockRotatableNSEWUD {

  public BlockDMPTUnpainted() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.125000, 0.125000, -0.062500, 0.875000, 0.875000, 1.000000);
    }
