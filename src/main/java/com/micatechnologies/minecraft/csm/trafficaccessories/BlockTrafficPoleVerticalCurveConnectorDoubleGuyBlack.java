...
public class BlockTrafficPoleVerticalCurveConnectorDoubleGuyBlack
    extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalCurveConnectorDoubleGuyBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalcurveconnectordoubleguyblack";
  }
