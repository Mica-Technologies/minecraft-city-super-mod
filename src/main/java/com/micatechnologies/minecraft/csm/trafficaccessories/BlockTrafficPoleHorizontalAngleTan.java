...
public class BlockTrafficPoleHorizontalAngleTan extends AbstractBlockRotatableNSEWUD
{
    public BlockTrafficPoleHorizontalAngleTan() {
    ...
    public String getBlockRegistryName() {
        return "trafficpolehorizontalangletan";
    }
