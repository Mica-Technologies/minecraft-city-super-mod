...
public class BlockTrafficPoleVerticalQuadMountTan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalQuadMountTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalquadmounttan";
  }
