...
/** Client to server: cycle one setting on the wire mount at a position. */
public class SpanWireMountConfigPacket implements IMessage {

  private BlockPos pos;
  private int actionOrdinal;

  public SpanWireMountConfigPacket() {
  }

  public SpanWireMountConfigPacket(BlockPos pos, int actionOrdinal) {
    this.pos = pos;
