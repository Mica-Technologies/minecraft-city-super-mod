...
public class BlockTrafficPoleVerticalSignalMount extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalSignalMount() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalsignalmount";
  }
