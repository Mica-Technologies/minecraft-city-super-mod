...
public class BlockTLDoghouseBorderBlackYellow extends AbstractBlockSignalBackplateFitted {

  public BlockTLDoghouseBorderBlackYellow() {
  ...
  public String getBlockRegistryName() {
    return "tldoghouseborderblackyellow";
  }
