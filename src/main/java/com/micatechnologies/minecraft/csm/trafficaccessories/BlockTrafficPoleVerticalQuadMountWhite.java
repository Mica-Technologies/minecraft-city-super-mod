...
public class BlockTrafficPoleVerticalQuadMountWhite extends AbstractBlockRotatableNSEWUD
{
    public BlockTrafficPoleVerticalQuadMountWhite() {
    ...
    public String getBlockRegistryName() {
        return "trafficpoleverticalquadmountwhite";
    }
