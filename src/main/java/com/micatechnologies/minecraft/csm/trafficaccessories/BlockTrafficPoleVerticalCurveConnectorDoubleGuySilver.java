...
public class BlockTrafficPoleVerticalCurveConnectorDoubleGuySilver
    extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalCurveConnectorDoubleGuySilver() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalcurveconnectordoubleguysilver";
  }
