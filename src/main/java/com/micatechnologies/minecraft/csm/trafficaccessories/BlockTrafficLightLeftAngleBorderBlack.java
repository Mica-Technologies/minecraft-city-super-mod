...
public class BlockTrafficLightLeftAngleBorderBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficLightLeftAngleBorderBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficlightleftangleborderblack";
  }
