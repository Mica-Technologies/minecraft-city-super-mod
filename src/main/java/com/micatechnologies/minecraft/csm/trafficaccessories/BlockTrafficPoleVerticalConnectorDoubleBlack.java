...
public class BlockTrafficPoleVerticalConnectorDoubleBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorDoubleBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectordoubleblack";
  }
