...
public class BlockTrafficpoleverticalquadmountconcrete extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficpoleverticalquadmountconcrete() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalquadmountconcrete";
  }
