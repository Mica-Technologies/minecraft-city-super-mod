...
public class BlockTrafficPoleVerticalLightMountTan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalLightMountTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticallightmounttan";
  }
