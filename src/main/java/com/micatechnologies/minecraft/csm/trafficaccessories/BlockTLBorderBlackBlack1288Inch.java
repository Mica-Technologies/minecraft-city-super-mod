...
public class BlockTLBorderBlackBlack1288Inch extends AbstractBlockRotatableNSEWUD
{
    public BlockTLBorderBlackBlack1288Inch() {
    ...
    public String getBlockRegistryName() {
        return "tlborderblackblack1288inch";
    }
