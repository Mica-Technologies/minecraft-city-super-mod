...
public class BlockTLiteHorzWireMount extends AbstractBlockRotatableNSEWUD {

  public BlockTLiteHorzWireMount() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(1.437500, -0.250000, 0.500000, 1.562500, 0.000000, 0.875000);
    }
