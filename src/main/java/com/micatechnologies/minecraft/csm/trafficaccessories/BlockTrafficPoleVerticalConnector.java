...
public class BlockTrafficPoleVerticalConnector extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnector() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnector";
  }
