...
public class BlockTrafficPoleHorizSignMountTan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleHorizSignMountTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizsignmounttan";
  }
