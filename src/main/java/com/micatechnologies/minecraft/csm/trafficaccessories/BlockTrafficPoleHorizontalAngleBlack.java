...
public class BlockTrafficPoleHorizontalAngleBlack extends AbstractBlockRotatableNSEWUD
{
    public BlockTrafficPoleHorizontalAngleBlack() {
    ...
    public String getBlockRegistryName() {
        return "trafficpolehorizontalangleblack";
    }
