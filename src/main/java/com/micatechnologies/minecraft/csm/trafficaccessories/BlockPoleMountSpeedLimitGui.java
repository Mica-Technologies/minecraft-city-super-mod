...
/**
 * Config GUI for the pole-mounted electronic speed limit sign. Same controls as the
 * overhead variant — speed, housing color, full-screen toggle — re-using the same
 * shared update packet on save.
 */
public class BlockPoleMountSpeedLimitGui extends GuiScreen {
  ...
  private final TileEntityPoleMountSpeedLimit tileEntity;
  private int speedValue;
  private TrafficSignalBodyColor housingColor;
  private boolean fullScreen;

  public BlockPoleMountSpeedLimitGui(TileEntityPoleMountSpeedLimit tileEntity) {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    drawCenteredString(fontRenderer, "Pole-Mount Speed Limit Sign", centerX, startY - 15,
        0xFFAA00);
