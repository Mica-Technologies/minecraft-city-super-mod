...
public class BlockTrafficPoleHorizSignMountWhite extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleHorizSignMountWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizsignmountwhite";
  }
