...
public class BlockTLDoghouseBorderPinkBlack extends AbstractBlockSignalBackplateFitted {

  public BlockTLDoghouseBorderPinkBlack() {
  ...
  public String getBlockRegistryName() {
    return "tldoghouseborderpinkblack";
  }
