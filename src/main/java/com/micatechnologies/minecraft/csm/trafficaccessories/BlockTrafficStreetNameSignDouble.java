...
public class BlockTrafficStreetNameSignDouble extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:trafficstreetnamesigndouble")
	public static final Block block = null;
	public BlockTrafficStreetNameSignDouble(ElementsCitySuperMod instance) {
		super(instance, 561);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:trafficstreetnamesigndouble", "inventory"));
	}
