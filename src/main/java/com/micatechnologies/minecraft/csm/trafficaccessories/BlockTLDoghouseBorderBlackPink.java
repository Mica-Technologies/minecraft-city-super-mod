...
public class BlockTLDoghouseBorderBlackPink extends AbstractBlockSignalBackplateFitted {

  public BlockTLDoghouseBorderBlackPink() {
  ...
  public String getBlockRegistryName() {
    return "tldoghouseborderblackpink";
  }
