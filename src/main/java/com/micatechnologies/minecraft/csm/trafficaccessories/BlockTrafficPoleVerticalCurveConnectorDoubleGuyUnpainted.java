...
public class BlockTrafficPoleVerticalCurveConnectorDoubleGuyUnpainted
    extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalCurveConnectorDoubleGuyUnpainted() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalcurveconnectordoubleguyunpainted";
  }
