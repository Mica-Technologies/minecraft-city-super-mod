...
public class BlockTLBorderBlackWhite extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlborderblackwhite")
	public static final Block block = null;
	public BlockTLBorderBlackWhite( ElementsCitySuperMod instance) {
		super(instance, 3992);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlborderblackwhite"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlborderblackwhite", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tlborderblackwhite");
