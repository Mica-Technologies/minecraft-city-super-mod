...
public class BlockTrafficPoleHorizontalSingleMountBlack extends AbstractBlockRotatableNSEWUD implements
    ICsmRetiringBlock, ICsmNoSnowAccumulation {

  public BlockTrafficPoleHorizontalSingleMountBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizontalsinglemountblack";
  }
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.000000, 0.250000, 0.000000, 0.750000, 0.750000, 1.000000);
    }
