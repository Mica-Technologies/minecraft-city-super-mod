...
public class BlockTrafficpoleverticalsignalmountunpainted extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficpoleverticalsignalmountunpainted() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalsignalmountunpainted";
  }
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.125000, -1.000000, 0.125000, 1.562500, 2.000000, 0.875000);
    }
