...
public class BlockTrafficPoleVerticalDoubleGuyMountWhite extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalDoubleGuyMountWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticaldoubleguymountwhite";
  }
