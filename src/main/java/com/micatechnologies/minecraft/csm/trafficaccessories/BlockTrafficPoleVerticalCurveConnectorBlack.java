...
public class BlockTrafficPoleVerticalCurveConnectorBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalCurveConnectorBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalcurveconnectorblack";
  }
