...
public class BlockTrafficPoleVerticalLightMountBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalLightMountBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticallightmountblack";
  }
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.312500, 0.187500, -1.000000, 0.687500, 1.187500, 1.187500);
    }
