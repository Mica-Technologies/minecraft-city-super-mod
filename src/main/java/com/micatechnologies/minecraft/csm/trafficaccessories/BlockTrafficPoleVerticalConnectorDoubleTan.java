...
public class BlockTrafficPoleVerticalConnectorDoubleTan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorDoubleTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectordoubletan";
  }
