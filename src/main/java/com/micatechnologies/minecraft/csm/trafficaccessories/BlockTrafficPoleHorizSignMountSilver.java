...
public class BlockTrafficPoleHorizSignMountSilver extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleHorizSignMountSilver() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizsignmountsilver";
  }
