...
public class BlockTrafficPoleHorizontalAngleMount1Tan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleHorizontalAngleMount1Tan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizontalanglemount1tan";
  }
