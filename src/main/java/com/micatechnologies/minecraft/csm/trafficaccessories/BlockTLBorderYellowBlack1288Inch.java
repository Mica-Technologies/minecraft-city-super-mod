...
public class BlockTLBorderYellowBlack1288Inch extends AbstractBlockRotatableNSEWUD
{
    public BlockTLBorderYellowBlack1288Inch() {
    ...
    public String getBlockRegistryName() {
        return "tlborderyellowblack1288inch";
    }
