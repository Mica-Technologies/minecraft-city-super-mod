...
public class BlockTLiteVertWireMount extends AbstractBlockRotatableNSEWUD {

  public BlockTLiteVertWireMount() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.437500, 0.500000, 0.437500, 0.562500, 1.000000, 0.937500);
    }
