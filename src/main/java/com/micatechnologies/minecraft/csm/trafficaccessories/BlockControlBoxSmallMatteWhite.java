...
public class BlockControlBoxSmallMatteWhite extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:controlboxsmallmattewhite")
	public static final Block block = null;
	public BlockControlBoxSmallMatteWhite(ElementsCitySuperMod instance) {
		super(instance, 1162);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("controlboxsmallmattewhite"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:controlboxsmallmattewhite", "inventory"));
	}
