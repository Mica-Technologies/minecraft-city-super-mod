...
public class BlockTrafficPoleVerticalConnectorAngledUnpainted extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorAngledUnpainted() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectorangledunpainted";
  }
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.125000, 0.000000, -0.625000, 0.875000, 1.000000, 0.875000);
    }
