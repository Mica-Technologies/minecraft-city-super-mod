...
public class BlockTrafficpolehorzdblconcrete extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficpolehorzdblconcrete() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorzdblconcrete";
  }
