...
public class BlockTrafficpolevertdblunpainted extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficpolevertdblunpainted() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolevertdblunpainted";
  }
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.125000, 0.125000, -1.000000, 0.875000, 0.875000, 1.000000);
    }
