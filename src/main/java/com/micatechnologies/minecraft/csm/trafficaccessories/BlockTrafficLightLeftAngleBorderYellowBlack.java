...
public class BlockTrafficLightLeftAngleBorderYellowBlack extends AbstractBlockRotatableNSEWUD
{
    public BlockTrafficLightLeftAngleBorderYellowBlack() {
    ...
    public String getBlockRegistryName() {
        return "trafficlightleftangleborderyellowblack";
    }
