...
public class BlockTrafficPoleVerticalSignalMountTan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalSignalMountTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalsignalmounttan";
  }
