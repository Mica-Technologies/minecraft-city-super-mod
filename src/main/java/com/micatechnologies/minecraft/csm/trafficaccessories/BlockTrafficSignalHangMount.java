...
public class BlockTrafficSignalHangMount extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficSignalHangMount() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.500000, -0.750000, 0.750000, 0.600000, 1.609375, 0.850000);
    }
