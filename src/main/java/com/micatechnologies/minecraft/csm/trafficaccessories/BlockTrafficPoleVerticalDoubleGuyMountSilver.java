...
public class BlockTrafficPoleVerticalDoubleGuyMountSilver extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalDoubleGuyMountSilver() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticaldoubleguymountsilver";
  }
