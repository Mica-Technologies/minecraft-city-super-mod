...
public class BlockTrafficPoleVerticalConnectorDoubleWhite extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorDoubleWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectordoublewhite";
  }
