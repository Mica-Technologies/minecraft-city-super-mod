...
public class BlockTLDoghouseBorderYellowBlack extends AbstractBlockSignalBackplateFitted {

  public BlockTLDoghouseBorderYellowBlack() {
  ...
  public String getBlockRegistryName() {
    return "tldoghouseborderyellowblack";
  }
