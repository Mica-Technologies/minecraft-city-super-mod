...
public class BlockTLHawkBorderYellowBlack extends AbstractBlockRotatableNSEWUD {

  public static final PropertyBool
      FITTED = PropertyBool.create("fitted");

  public BlockTLHawkBorderYellowBlack() {
  ...
  public String getBlockRegistryName() {
    return "tlhawkborderyellowblack";
  }
  ...
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, FACING, FITTED);
  }
}
