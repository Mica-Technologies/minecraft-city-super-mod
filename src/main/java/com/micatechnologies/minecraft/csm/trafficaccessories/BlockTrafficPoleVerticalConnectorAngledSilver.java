...
public class BlockTrafficPoleVerticalConnectorAngledSilver extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorAngledSilver() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectorangledsilver";
  }
