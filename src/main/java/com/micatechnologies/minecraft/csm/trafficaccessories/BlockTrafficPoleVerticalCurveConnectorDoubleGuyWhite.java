...
public class BlockTrafficPoleVerticalCurveConnectorDoubleGuyWhite
    extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalCurveConnectorDoubleGuyWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalcurveconnectordoubleguywhite";
  }
