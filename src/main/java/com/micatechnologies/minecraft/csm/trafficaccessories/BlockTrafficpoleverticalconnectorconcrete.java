...
public class BlockTrafficpoleverticalconnectorconcrete extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficpoleverticalconnectorconcrete() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectorconcrete";
  }
