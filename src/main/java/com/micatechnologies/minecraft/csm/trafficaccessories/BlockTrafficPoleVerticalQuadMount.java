...
public class BlockTrafficPoleVerticalQuadMount extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalQuadMount() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalquadmount";
  }
