...
public class BlockTrafficPoleVerticalCurveConnector extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalCurveConnector() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalcurveconnector";
  }
