...
public class BlockTLDoghouseBorderBlackBlack extends AbstractBlockSignalBackplateFitted {

  public BlockTLDoghouseBorderBlackBlack() {
  ...
  public String getBlockRegistryName() {
    return "tldoghouseborderblackblack";
  }
