...
public class BlockTrafficPoleVerticalSignalMountWhite extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalSignalMountWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalsignalmountwhite";
  }
