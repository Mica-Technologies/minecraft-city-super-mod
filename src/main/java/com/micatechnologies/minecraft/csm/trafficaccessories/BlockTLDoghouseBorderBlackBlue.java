...
public class BlockTLDoghouseBorderBlackBlue extends AbstractBlockSignalBackplateFitted {

  public BlockTLDoghouseBorderBlackBlue() {
  ...
  public String getBlockRegistryName() {
    return "tldoghouseborderblackblue";
  }
