...
public class BlockTrafficPoleHorizontalAngleMount2Tan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleHorizontalAngleMount2Tan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizontalanglemount2tan";
  }
