...
public class BlockTrafficPoleSmallBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleSmallBlack() {
  ...
  public @NotNull IBlockState getActualState(IBlockState state, @NotNull IBlockAccess worldIn,
    ...
    return state.withProperty(MOUNT_EAST, isBlockToEast).withProperty(MOUNT_WEST, isBlockToWest)
        .withProperty(MOUNT_NORTH, isBlockToNorth).withProperty(MOUNT_SOUTH, isBlockToSouth)
