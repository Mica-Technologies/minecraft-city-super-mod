...
public class BlockTrafficSignalSnowBeacon extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficSignalSnowBeacon() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(-0.500000, -1.000000, 0.250000, 1.375000, 0.631250, 0.750000);
    }
