...
public class BlockTLDoghouseBorderGrayGray extends AbstractBlockSignalBackplateFitted {

  public BlockTLDoghouseBorderGrayGray() {
  ...
  public String getBlockRegistryName() {
    return "tldoghousebordergraygray";
  }
