...
public class BlockTLVABorderBlackYellow extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlvaborderblackyellow")
	public static final Block block = null;
	public BlockTLVABorderBlackYellow(ElementsCitySuperMod instance) {
		super(instance, 895);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlvaborderblackyellow"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:tlvaborderblackyellow", "inventory"));
	}
