...
public class BlockTrafficPoleHorizontalMountDoubleBlack extends AbstractBlockRotatableNSEWUD implements
    ICsmRetiringBlock {

  public BlockTrafficPoleHorizontalMountDoubleBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizontalmountdoubleblack";
  }
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.000000, 0.250000, 0.000000, 1.000000, 0.750000, 1.000000);
    }
  ...
  public String getReplacementBlockId() {
    return "trafficpolehorizontalblack";
  }
}
