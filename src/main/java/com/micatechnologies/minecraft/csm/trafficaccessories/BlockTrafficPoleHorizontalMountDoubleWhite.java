...
public class BlockTrafficPoleHorizontalMountDoubleWhite extends AbstractBlockRotatableNSEWUD implements
    ICsmRetiringBlock, ICsmNoSnowAccumulation {

  public BlockTrafficPoleHorizontalMountDoubleWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizontalmountdoublewhite";
  }
