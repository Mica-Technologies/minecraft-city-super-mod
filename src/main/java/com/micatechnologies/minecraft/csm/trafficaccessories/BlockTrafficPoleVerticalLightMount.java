...
public class BlockTrafficPoleVerticalLightMount extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalLightMount() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticallightmount";
  }
