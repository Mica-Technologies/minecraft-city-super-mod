...
public class BlockTLDoghouseBorderBlackWhite extends AbstractBlockSignalBackplateFitted {

  public BlockTLDoghouseBorderBlackWhite() {
  ...
  public String getBlockRegistryName() {
    return "tldoghouseborderblackwhite";
  }
