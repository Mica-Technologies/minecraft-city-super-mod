...
public class BlockTrafficPoleHorizontalMountDoubleTan extends AbstractBlockRotatableNSEWUD implements
    ICsmRetiringBlock {

  public BlockTrafficPoleHorizontalMountDoubleTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizontalmountdoubletan";
  }
