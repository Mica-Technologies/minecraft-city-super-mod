...
public class BlockTrafficSignalPreemptionBeacon extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficSignalPreemptionBeacon() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.000000, -0.421875, 0.406250, 0.562500, 0.156250, 0.593750);
    }
