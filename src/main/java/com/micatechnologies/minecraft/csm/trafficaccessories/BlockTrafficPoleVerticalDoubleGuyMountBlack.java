...
public class BlockTrafficPoleVerticalDoubleGuyMountBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalDoubleGuyMountBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticaldoubleguymountblack";
  }
