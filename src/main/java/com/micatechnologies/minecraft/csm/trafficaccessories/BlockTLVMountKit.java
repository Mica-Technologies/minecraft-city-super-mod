...
public class BlockTLVMountKit extends AbstractBlockRotatableNSEWUD {

  public BlockTLVMountKit() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.437500, -0.812500, 0.000000, 0.562500, 1.562500, 1.000000);
    }
