...
public class BlockTrafficpolehorzdoublemountunpainted extends AbstractBlockRotatableNSEWUD  implements
    ICsmRetiringBlock {

  public BlockTrafficpolehorzdoublemountunpainted() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorzdoublemountunpainted";
  }
