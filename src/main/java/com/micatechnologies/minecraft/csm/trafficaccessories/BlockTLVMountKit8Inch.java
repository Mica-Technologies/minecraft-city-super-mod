...
public class BlockTLVMountKit8Inch extends AbstractBlockRotatableNSEWUD {

  public BlockTLVMountKit8Inch() {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.437500, -0.812500, 0.000000, 0.562500, 0.812500, 1.000000);
    }
