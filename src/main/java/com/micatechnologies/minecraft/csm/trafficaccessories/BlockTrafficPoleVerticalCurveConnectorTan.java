...
public class BlockTrafficPoleVerticalCurveConnectorTan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalCurveConnectorTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalcurveconnectortan";
  }
