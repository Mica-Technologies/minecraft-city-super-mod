...
public class LaneControlSignalConfigPacket implements IMessage {

    private BlockPos pos;
    private int actionOrdinal;

    public LaneControlSignalConfigPacket() {
    }

    public LaneControlSignalConfigPacket(BlockPos pos, int actionOrdinal) {
        this.pos = pos;
