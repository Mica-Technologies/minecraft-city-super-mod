...
public class BlockTLBorderBlackBlack8812Inch extends AbstractBlockRotatableNSEWUD
{
    public BlockTLBorderBlackBlack8812Inch() {
    ...
    public String getBlockRegistryName() {
        return "tlborderblackblack8812inch";
    }
