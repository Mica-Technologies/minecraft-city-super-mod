...
public class BlockTrafficPoleVerticalCurveConnectorDoubleGuyTan
    extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalCurveConnectorDoubleGuyTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalcurveconnectordoubleguytan";
  }
