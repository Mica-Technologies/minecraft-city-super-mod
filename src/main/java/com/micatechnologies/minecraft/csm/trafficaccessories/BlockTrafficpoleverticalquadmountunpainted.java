...
public class BlockTrafficpoleverticalquadmountunpainted extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficpoleverticalquadmountunpainted() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalquadmountunpainted";
  }
