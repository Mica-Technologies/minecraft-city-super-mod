...
public class BlockTrafficPoleHorizontalAngleMount3Tan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleHorizontalAngleMount3Tan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizontalanglemount3tan";
  }
