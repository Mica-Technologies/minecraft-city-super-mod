...
public class BlockTrafficPoleVerticalConnectorDoubleSilver extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorDoubleSilver() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectordoublesilver";
  }
