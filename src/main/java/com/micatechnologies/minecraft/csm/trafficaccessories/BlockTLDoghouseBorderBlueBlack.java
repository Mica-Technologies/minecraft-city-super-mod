...
public class BlockTLDoghouseBorderBlueBlack extends AbstractBlockSignalBackplateFitted {

  public BlockTLDoghouseBorderBlueBlack() {
  ...
  public String getBlockRegistryName() {
    return "tldoghouseborderblueblack";
  }
