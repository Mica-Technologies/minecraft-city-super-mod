...
public class BlockTrafficPoleVerticalConnectorAngledBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorAngledBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectorangledblack";
  }
