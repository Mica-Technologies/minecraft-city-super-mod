...
public class BlockTrafficPoleVerticalSignalMountBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalSignalMountBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalsignalmountblack";
  }
