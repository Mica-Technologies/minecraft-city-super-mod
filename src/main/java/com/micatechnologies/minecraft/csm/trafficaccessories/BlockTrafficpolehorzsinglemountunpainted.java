...
public class BlockTrafficpolehorzsinglemountunpainted extends AbstractBlockRotatableNSEWUD  implements
    ICsmRetiringBlock {

  public BlockTrafficpolehorzsinglemountunpainted() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorzsinglemountunpainted";
  }
  ...
  public String getReplacementBlockId() {
    return "trafficpolehorzunpainted";
  }
}
