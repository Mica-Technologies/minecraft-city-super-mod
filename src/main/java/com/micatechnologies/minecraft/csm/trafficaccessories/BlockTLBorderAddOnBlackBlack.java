...
public class BlockTLBorderAddOnBlackBlack extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:tlborderaddonblackblack")
	public static final Block block = null;
	public BlockTLBorderAddOnBlackBlack( ElementsCitySuperMod instance) {
		super(instance, 2991);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tlborderaddonblackblack"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:tlborderaddonblackblack", "inventory"));
	}
