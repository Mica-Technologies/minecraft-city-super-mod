...
public class BlockTrafficPoleVerticalConnectorWhite extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectorwhite";
  }
