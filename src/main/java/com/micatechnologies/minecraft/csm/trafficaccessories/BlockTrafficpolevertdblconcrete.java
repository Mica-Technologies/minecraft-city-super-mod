...
public class BlockTrafficpolevertdblconcrete extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficpolevertdblconcrete() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolevertdblconcrete";
  }
