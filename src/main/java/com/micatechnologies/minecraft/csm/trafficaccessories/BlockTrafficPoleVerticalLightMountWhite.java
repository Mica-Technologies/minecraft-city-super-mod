...
public class BlockTrafficPoleVerticalLightMountWhite extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalLightMountWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticallightmountwhite";
  }
