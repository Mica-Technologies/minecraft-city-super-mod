...
public class BlockTrafficLightLeftAngleBorderTan extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:trafficlightleftanglebordertan" )
    public static final Block block = null;

    public BlockTrafficLightLeftAngleBorderTan( ElementsCitySuperMod instance ) {
        super( instance, 2153 );
    }

    @Override
    public void initElements() {
        elements.blocks.add( () -> new BlockCustom().setRegistryName( "trafficlightleftanglebordertan" ) );
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:trafficlightleftanglebordertan", "inventory" ) );
    }
