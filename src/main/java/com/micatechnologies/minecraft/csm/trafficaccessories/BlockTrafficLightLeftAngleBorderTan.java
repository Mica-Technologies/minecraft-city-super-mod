...
public class BlockTrafficLightLeftAngleBorderTan extends AbstractBlockRotatableNSEWUD
{
    public BlockTrafficLightLeftAngleBorderTan() {
    ...
    public String getBlockRegistryName() {
        return "trafficlightleftanglebordertan";
    }
