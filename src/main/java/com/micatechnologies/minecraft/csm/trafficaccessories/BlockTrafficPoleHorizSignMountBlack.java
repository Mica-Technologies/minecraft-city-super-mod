...
public class BlockTrafficPoleHorizSignMountBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleHorizSignMountBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizsignmountblack";
  }
