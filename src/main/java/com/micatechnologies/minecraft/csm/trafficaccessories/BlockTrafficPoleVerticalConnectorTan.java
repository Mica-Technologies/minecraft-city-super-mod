...
public class BlockTrafficPoleVerticalConnectorTan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectortan";
  }
