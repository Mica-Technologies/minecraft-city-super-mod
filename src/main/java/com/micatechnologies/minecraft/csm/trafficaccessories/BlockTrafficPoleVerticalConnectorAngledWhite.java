...
public class BlockTrafficPoleVerticalConnectorAngledWhite extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorAngledWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectorangledwhite";
  }
