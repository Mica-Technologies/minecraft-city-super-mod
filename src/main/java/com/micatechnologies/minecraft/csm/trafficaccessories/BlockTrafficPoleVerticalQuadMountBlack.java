...
public class BlockTrafficPoleVerticalQuadMountBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalQuadMountBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalquadmountblack";
  }
