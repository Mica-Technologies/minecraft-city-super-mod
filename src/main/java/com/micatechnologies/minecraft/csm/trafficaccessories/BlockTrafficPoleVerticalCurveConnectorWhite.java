...
public class BlockTrafficPoleVerticalCurveConnectorWhite extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalCurveConnectorWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalcurveconnectorwhite";
  }
