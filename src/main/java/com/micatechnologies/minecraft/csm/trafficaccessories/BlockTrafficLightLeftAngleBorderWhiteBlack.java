...
public class BlockTrafficLightLeftAngleBorderWhiteBlack extends AbstractBlockRotatableNSEWUD
{
    public BlockTrafficLightLeftAngleBorderWhiteBlack() {
    ...
    public String getBlockRegistryName() {
        return "trafficlightleftangleborderwhiteblack";
    }
