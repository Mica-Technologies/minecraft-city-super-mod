...
public class BlockTLBorderWhiteBlack1288Inch extends AbstractBlockRotatableNSEWUD
{
    public BlockTLBorderWhiteBlack1288Inch() {
    ...
    public String getBlockRegistryName() {
        return "tlborderwhiteblack1288inch";
    }
