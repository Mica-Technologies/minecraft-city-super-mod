...
public class BlockTrafficpolehorzsignmountunpainted extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficpolehorzsignmountunpainted() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorzsignmountunpainted";
  }
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.000000, 0.000000, 0.000000, 0.750000, 1.000000, 1.000000);
    }
