...
public class BlockTrafficPoleVerticalConnectorBlack extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorBlack() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectorblack";
  }
