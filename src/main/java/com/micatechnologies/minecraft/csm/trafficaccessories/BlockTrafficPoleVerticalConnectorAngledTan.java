...
public class BlockTrafficPoleVerticalConnectorAngledTan extends AbstractBlockRotatableNSEWUD {

  public BlockTrafficPoleVerticalConnectorAngledTan() {
  ...
  public String getBlockRegistryName() {
    return "trafficpoleverticalconnectorangledtan";
  }
