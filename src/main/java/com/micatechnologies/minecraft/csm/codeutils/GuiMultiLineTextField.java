...
/**
 * This multi-line text field component was adapted from the publicly available version by <em>Draco18s</em> on GitHub
 * at <a
 * href="https://gist.github.com/Draco18s/2b02762b597e67a9b887aed241f25077">https://gist.github.com/Draco18s/2b02762b597e67a9b887aed241f25077</a>.
 */
    ...
    public void setSelectionPos( int position )
    {
        ...
        if ( this.fontRenderer != null ) {
            ...
            if ( position == this.lineScrollOffset ) {
                this.lineScrollOffset -= this.fontRenderer.trimStringToWidth( this.text.get( currentLine ), j, true )
                                                          .length();
            }
