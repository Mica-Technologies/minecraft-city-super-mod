 ...
 * {@link AbstractBlockRotatableNSEWUD} with the addition of a powered property.
 *
 * @version 1.0
 * @see Block
 * @see AbstractBlock
...
public abstract class AbstractPoweredBlockRotatableNSEWUD extends AbstractBlock {
  ...
  /**
   * Overridden method from {@link Block} which is called when a neighbor block changes. This method
   * sets the powered property of the block based on whether the block is receiving power from a
   * redstone source.
   *
