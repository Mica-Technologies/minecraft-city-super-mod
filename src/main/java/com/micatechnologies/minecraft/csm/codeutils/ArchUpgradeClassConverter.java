...
public class ArchUpgradeClassConverter {
    public static void main(String[] args) {
        ...
        // Define upgrade path
        final String upgradePath = "E:\\source\\repos\\minecraft-city-super-mod\\src\\main\\java\\com\\micatechnologies\\minecraft\\csm\\hvac\\BlockART1.java";
    ...
    public static boolean upgradeClass(File file) throws Exception {
        ...
        System.err.println("File Contents: " + fileContents);
        ...
        // Get material type
        String materialTypeRegex = "public\\s+BlockCustom\\(\\s*\\)\\s*\\{\\s*super\\(\\s*([a-zA-Z_.]+)\\s*\\);[\\s\\S]*?\\}";
        ...
        newClass.append("package com.micatechnologies.minecraft.csm.buildingmaterials;\n" +
                                "\n" +
