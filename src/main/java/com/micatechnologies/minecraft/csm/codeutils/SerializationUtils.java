...
public class SerializationUtils {
  ...
  /**
   * Sets the given {@link BlockPos} in the given {@link NBTTagCompound} with the given
   * {@link String} key. If the {@link BlockPos} is null, the key is removed from the
   * {@link NBTTagCompound}.
   *
   ...
   * @param blockPos The {@link BlockPos} to set in the {@link NBTTagCompound}. If null, the key is
   *                 removed from the {@link NBTTagCompound}.
   *
   * @since 1.0
   */
  public static void setBlockPosInNBTOrRemoveIfNull(NBTTagCompound compound, String nbtKey,
      BlockPos blockPos) {
    if (blockPos != null) {
  ...
  /**
   * Gets a {@link NBTTagLongArray} of serialized {@link BlockPos} long values from the given
   * {@link List} of {@link BlockPos}es.
   *
   * @param list The {@link List} of {@link BlockPos}es to serialize.
   *
   * @return A {@link NBTTagLongArray} of serialized {@link BlockPos} long values from the given
   *     {@link List} of {@link BlockPos}es.
   *
   * @since 1.0
   */
  ...
  /**
   * Gets a {@link List} of {@link BlockPos}es from the given {@link NBTBase} containing serialized
   * {@link BlockPos} long values.
   *
   * @param nbtBase The {@link NBTBase} containing serialized {@link BlockPos} long values to
   *                deserialize.
   *
   * @return A {@link List} of {@link BlockPos}es from the given {@link NBTBase} containing
   *     serialized {@link BlockPos} long values.
   *
   * @since 1.0
   */
