 ...
 * {@link AbstractBlockRotatableHZEight} and settles the block onto the surface below it.
 *
 * <p>The eight-direction counterpart of {@link AbstractBlockRoadSurfaceRotatableNSEW}, for work
 * zone devices laid along a line that does not run with the block grid. See
 * {@link RoadSurfaceHeight} for how the surface height is worked out.</p>
 *
 ...
 *
 * @version 1.0
 * @see AbstractBlockRotatableHZEight
 * @see AbstractBlockRoadSurfaceRotatableNSEW
 * @see RoadSurfaceHeight
 * @since 2026.9
 */
public abstract class AbstractBlockRoadSurfaceRotatableHZEight
    extends AbstractBlockRotatableHZEight implements ICsmRoadSurfaceAware {

  /**
   * Constructs an {@link AbstractBlockRoadSurfaceRotatableHZEight} instance.
   *
   * @param material The material of the block.
   *
   * @since 1.0
   */
  public AbstractBlockRoadSurfaceRotatableHZEight(Material material) {
    super(material);
  }
  ...
  /**
   * Overridden method from {@link AbstractBlockRotatableHZEight} which applies the same downward
