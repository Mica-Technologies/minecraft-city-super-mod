...
public class BlockHvacZoneThermostat extends AbstractBlockRotatableNSEWUD
  ...
  public int getWeakPower(IBlockState state, IBlockAccess blockAccess, BlockPos pos,
    ...
    if (te instanceof TileEntityHvacZoneThermostat) {
      return ((TileEntityHvacZoneThermostat) te).isCalling() ? 15 : 0;
    }
    return 0;
  }
  ...
  public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state,
    ...
    playerIn.openGui(Csm.instance, 7, worldIn, pos.getX(), pos.getY(), pos.getZ());
    return true;
  }

  @Override
  public Class<? extends TileEntity> getTileEntityClass() {
    return TileEntityHvacZoneThermostat.class;
  }

  @Override
  public String getTileEntityName() {
    return "tileentityhvaczonethermostat";
  }

  @Override
  public TileEntity createNewTileEntity(World worldIn, int meta) {
    return new TileEntityHvacZoneThermostat();
  }
}
