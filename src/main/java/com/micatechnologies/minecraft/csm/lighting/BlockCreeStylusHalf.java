...
public class BlockCreeStylusHalf extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:creestylushalf")
	public static final Block block = null;
	public BlockCreeStylusHalf(ElementsCitySuperMod instance) {
		super(instance, 720);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:creestylushalf", "inventory"));
	}
