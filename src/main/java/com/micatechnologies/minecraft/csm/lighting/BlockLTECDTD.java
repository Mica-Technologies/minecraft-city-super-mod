...
public class BlockLTECDTD extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:ltecdtd")
	public static final Block block = null;
	public BlockLTECDTD(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ltecdtd", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("ltecdtd");
			setUnlocalizedName("ltecdtd");
