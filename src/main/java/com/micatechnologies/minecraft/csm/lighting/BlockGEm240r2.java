...
public class BlockGEm240r2 extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "gem240r2";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockGEm240r2( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
