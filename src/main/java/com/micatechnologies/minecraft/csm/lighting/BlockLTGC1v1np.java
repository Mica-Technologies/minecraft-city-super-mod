...
public class BlockLTGC1v1np extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "ltgc1v1np";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockLTGC1v1np( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
