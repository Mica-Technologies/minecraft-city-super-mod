...
public class BlockSearsLF3 extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "searslf3";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockSearsLF3( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
