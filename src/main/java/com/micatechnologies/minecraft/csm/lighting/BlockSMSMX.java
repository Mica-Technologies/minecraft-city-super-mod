...
public class BlockSMSMX extends ElementsCitySuperMod.ModElement {
	public static final String elementId = "smsmx";

	@GameRegistry.ObjectHolder("csm:"+elementId)
	public static final Block block = null;
	public BlockSMSMX(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
