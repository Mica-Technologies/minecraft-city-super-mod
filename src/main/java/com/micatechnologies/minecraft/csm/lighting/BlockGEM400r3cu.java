...
public class BlockGEM400r3cu extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "gem400r3cu";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockGEM400r3cu( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
