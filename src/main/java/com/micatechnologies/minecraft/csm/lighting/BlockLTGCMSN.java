...
public class BlockLTGCMSN extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:ltgcmsn")
	public static final Block block = null;
	public BlockLTGCMSN(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:ltgcmsn", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("ltgcmsn");
			setUnlocalizedName("ltgcmsn");
