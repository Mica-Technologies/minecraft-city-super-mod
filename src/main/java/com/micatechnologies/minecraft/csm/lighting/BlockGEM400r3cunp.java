...
public class BlockGEM400r3cunp extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "gem400r3cunp";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockGEM400r3cunp( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
