...
public class BlockLTGCMv2 extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "ltgcmv2";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockLTGCMv2( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
