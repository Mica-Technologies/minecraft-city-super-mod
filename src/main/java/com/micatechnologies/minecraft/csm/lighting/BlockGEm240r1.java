...
public class BlockGEm240r1 extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "gem240r1";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockGEm240r1( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
