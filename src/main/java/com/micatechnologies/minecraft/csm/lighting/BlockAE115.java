...
public class BlockAE115 extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "ae115";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockAE115( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
