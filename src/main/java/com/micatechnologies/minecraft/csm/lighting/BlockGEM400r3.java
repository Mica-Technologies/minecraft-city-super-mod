...
public class BlockGEM400r3 extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "gem400r3";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockGEM400r3( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
