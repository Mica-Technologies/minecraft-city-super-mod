...
public class BlockSearsLF extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "searslf";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockSearsLF( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
