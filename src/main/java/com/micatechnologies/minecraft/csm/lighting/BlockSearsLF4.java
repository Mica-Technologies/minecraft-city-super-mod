...
public class BlockSearsLF4 extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "searslf4";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockSearsLF4( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
