...
public class BlockWHOV50 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:whov50")
	public static final Block block = null;
	public BlockWHOV50(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:whov50", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("whov50");
			setUnlocalizedName("whov50");
