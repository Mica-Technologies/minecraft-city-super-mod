...
public class BlockAltoSQLL extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:altosqll")
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:altosqll", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("altosqll");
			setUnlocalizedName("altosqll");
