...
public class BlockGEm240r2cu extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "gem240r2cu";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockGEm240r2cu( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
