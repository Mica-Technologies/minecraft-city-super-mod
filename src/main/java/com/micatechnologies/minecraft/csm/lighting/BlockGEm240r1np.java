...
public class BlockGEm240r1np extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "gem240r1np";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockGEm240r1np( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
