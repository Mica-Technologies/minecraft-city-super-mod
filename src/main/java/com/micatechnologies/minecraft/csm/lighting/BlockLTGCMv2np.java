...
public class BlockLTGCMv2np extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "ltgcmv2np";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockLTGCMv2np( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
