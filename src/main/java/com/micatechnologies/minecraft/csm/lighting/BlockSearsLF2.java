...
public class BlockSearsLF2 extends ElementsCitySuperMod.ModElement
{
    public static final String elementId = "searslf2";

    @GameRegistry.ObjectHolder( "csm:" + elementId )
    public static final Block block = null;

    public BlockSearsLF2( ElementsCitySuperMod instance ) {
        super( instance, 349 );
    }
