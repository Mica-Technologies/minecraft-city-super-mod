...
public class BlockControllableHorizontalSolidSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllablehorizontalsolidsignal" )
    public static final Block block = null;

    public BlockControllableHorizontalSolidSignal( ElementsCitySuperMod instance ) {
        super( instance, 2135 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllablehorizontalsolidsignal",
                                                                               "inventory" ) );
    }
