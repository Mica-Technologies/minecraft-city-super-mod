...
public class BlockControllableVerticalAngle2BikeSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllableverticalangle2bikesignal" )
    public static final Block block = null;

    public BlockControllableVerticalAngle2BikeSignal( ElementsCitySuperMod instance ) {
        super( instance, 2122 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllableverticalangle2bikesignal",
                                                                               "inventory" ) );
    }
