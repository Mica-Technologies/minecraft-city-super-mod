...
public class BlockControllableHorizontalUpLeftSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllablehorizontalupleftsignal" )
    public static final Block block = null;

    public BlockControllableHorizontalUpLeftSignal( ElementsCitySuperMod instance ) {
        super( instance, 2136 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllablehorizontalupleftsignal",
                                                                               "inventory" ) );
    }
