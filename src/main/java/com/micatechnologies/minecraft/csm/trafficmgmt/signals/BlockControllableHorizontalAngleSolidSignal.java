...
public class BlockControllableHorizontalAngleSolidSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllablehorizontalanglesolidsignal" )
    public static final Block block = null;

    public BlockControllableHorizontalAngleSolidSignal( ElementsCitySuperMod instance ) {
        super( instance, 2145 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllablehorizontalanglesolidsignal",
                                                                               "inventory" ) );
    }
