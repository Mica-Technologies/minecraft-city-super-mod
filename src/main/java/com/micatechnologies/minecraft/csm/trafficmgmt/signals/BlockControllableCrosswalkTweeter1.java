...
public class BlockControllableCrosswalkTweeter1 extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllablecrosswalktweeter1" )
    public static final Block block = null;

    public BlockControllableCrosswalkTweeter1( ElementsCitySuperMod instance ) {
        super( instance, 2023 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllablecrosswalktweeter1",
                                                                               "inventory" ) );
    }
