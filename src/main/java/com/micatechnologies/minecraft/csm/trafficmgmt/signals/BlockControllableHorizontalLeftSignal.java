...
public class BlockControllableHorizontalLeftSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllablehorizontalleftsignal" )
    public static final Block block = null;

    public BlockControllableHorizontalLeftSignal( ElementsCitySuperMod instance ) {
        super( instance, 2132 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllablehorizontalleftsignal",
                                                                               "inventory" ) );
    }
