...
public class BlockControllableVerticalAngleLeftSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllableverticalangleleftsignal" )
    public static final Block block = null;

    public BlockControllableVerticalAngleLeftSignal( ElementsCitySuperMod instance ) {
        super( instance, 2005 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllableverticalangleleftsignal",
                                                                               "inventory" ) );
    }
