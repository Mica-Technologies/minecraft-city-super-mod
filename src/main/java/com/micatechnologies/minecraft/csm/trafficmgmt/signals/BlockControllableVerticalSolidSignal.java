...
public class BlockControllableVerticalSolidSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllableverticalsolidsignal" )
    public static final Block block = null;

    public BlockControllableVerticalSolidSignal( ElementsCitySuperMod instance ) {
        super( instance, 2002 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllableverticalsolidsignal",
                                                                               "inventory" ) );
    }
