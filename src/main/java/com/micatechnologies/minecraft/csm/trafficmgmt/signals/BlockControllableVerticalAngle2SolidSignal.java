...
public class BlockControllableVerticalAngle2SolidSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllableverticalangle2solidsignal" )
    public static final Block block = null;

    public BlockControllableVerticalAngle2SolidSignal( ElementsCitySuperMod instance ) {
        super( instance, 2126 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllableverticalangle2solidsignal",
                                                                               "inventory" ) );
    }
