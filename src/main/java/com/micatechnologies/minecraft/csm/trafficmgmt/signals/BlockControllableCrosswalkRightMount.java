...
public class BlockControllableCrosswalkRightMount extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllablecrosswalkrightmount" )
    public static final Block block = null;

    public BlockControllableCrosswalkRightMount( ElementsCitySuperMod instance ) {
        super( instance, 2022 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllablecrosswalkrightmount",
                                                                               "inventory" ) );
    }
