...
public class BlockControllableVerticalAngle2RailSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllableverticalangle2railsignal" )
    public static final Block block = null;

    public BlockControllableVerticalAngle2RailSignal( ElementsCitySuperMod instance ) {
        super( instance, 2124 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllableverticalangle2railsignal",
                                                                               "inventory" ) );
    }
