...
public class BlockControllableSingleSolidSignalYellow extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllablesinglesolidsignalyellow" )
    public static final Block block = null;

    public BlockControllableSingleSolidSignalYellow( ElementsCitySuperMod instance ) {
        super( instance, 2027 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllablesinglesolidsignalyellow",
                                                                               "inventory" ) );
    }
