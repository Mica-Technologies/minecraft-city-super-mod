...
public class BlockControllableVerticalUturnSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllableverticaluturnsignal" )
    public static final Block block = null;

    public BlockControllableVerticalUturnSignal( ElementsCitySuperMod instance ) {
        super( instance, 2010 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllableverticaluturnsignal",
                                                                               "inventory" ) );
    }
