...
public class BlockControllableVerticalAngle2UpLeftSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllableverticalangle2upleftsignal" )
    public static final Block block = null;

    public BlockControllableVerticalAngle2UpLeftSignal( ElementsCitySuperMod instance ) {
        super( instance, 2127 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllableverticalangle2upleftsignal",
                                                                               "inventory" ) );
    }
