...
public class BlockControllableHorizontalAngleLeftSignal extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:controllablehorizontalangleleftsignal" )
    public static final Block block = null;

    public BlockControllableHorizontalAngleLeftSignal( ElementsCitySuperMod instance ) {
        super( instance, 2142 );
    }
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:controllablehorizontalangleleftsignal",
                                                                               "inventory" ) );
    }
