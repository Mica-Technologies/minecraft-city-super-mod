...
public class BlockSilverslab extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:silverslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("csm:silverslab_double")
	public static final Block block_slab_double = null;
	public BlockSilverslab(ElementsCitySuperMod instance) {
		super(instance, 730);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("silverslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("silverslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:silverslab", "inventory"));
	}
