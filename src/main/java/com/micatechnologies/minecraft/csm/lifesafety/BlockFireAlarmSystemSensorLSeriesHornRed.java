...
public class BlockFireAlarmSystemSensorLSeriesHornRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensorlserieshornred";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorLSeriesHornRed( ElementsCitySuperMod instance ) {
        super( instance, 2084 );
    }
