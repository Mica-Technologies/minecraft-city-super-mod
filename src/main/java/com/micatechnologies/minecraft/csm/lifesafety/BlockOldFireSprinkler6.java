...
public class BlockOldFireSprinkler6 extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "oldfiresprinkler6";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockOldFireSprinkler6( ElementsCitySuperMod instance ) {
        super( instance, 2117 );
    }
