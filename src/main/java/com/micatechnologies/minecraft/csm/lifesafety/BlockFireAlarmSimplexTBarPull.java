...
public class BlockFireAlarmSimplexTBarPull extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplextbarpull";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplexTBarPull( ElementsCitySuperMod instance ) {
        super( instance, 2112 );
    }
