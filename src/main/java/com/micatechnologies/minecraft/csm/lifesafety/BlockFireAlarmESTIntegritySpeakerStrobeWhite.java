...
public class BlockFireAlarmESTIntegritySpeakerStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmestintegrityspeakerstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmESTIntegritySpeakerStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2058 );
    }
