...
public class BlockFireAlarmESTIntegrityHornStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmestintegrityhornstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmESTIntegrityHornStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2056 );
    }
