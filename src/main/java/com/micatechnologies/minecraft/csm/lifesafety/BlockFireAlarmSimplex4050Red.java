...
public class BlockFireAlarmSimplex4050Red extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplex4050red";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplex4050Red( ElementsCitySuperMod instance ) {
        super( instance, 2069 );
    }
