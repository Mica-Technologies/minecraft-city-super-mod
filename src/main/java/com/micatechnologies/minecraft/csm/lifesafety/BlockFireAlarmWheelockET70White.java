...
public class BlockFireAlarmWheelockET70White extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocket70white";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockET70White( ElementsCitySuperMod instance ) {
        super( instance, 2049 );
    }
