...
public class BlockFireAlarmWheelockE70SpeakerWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocke70speakerwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockE70SpeakerWhite( ElementsCitySuperMod instance ) {
        super( instance, 2047 );
    }
