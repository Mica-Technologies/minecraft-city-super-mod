...
public class BlockMCLACodeApprovedExitSignISA extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:mclacodeapprovedexitsignisa" )
    public static final Block block = null;

    public BlockMCLACodeApprovedExitSignISA( ElementsCitySuperMod instance ) {
        super( instance, 9870 );
    }

    @Override
    public void initElements() {
        elements.blocks.add( () -> new BlockCustom().setRegistryName( "mclacodeapprovedexitsignisa" ) );
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:mclacodeapprovedexitsignisa",
                                                                               "inventory" ) );
    }
    ...
    public static class BlockCustom extends Block
    {
        ...
        public BlockCustom() {
            super( Material.ROCK );
            setUnlocalizedName( "mclacodeapprovedexitsignisa" );
