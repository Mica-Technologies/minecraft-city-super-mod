...
public class BlockMCLACodeApprovedExitSignISA extends AbstractBlockRotatableNSEWUD {

  public BlockMCLACodeApprovedExitSignISA() {
  ...
  public String getBlockRegistryName() {
    return "mclacodeapprovedexitsignisa";
  }
