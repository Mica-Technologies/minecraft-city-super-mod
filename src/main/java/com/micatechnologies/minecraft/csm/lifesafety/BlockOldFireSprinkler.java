...
public class BlockOldFireSprinkler extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "oldfiresprinkler";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockOldFireSprinkler( ElementsCitySuperMod instance ) {
        super( instance, 2117 );
    }
