...
public class BlockFireAlarmKiddeSmokeDetector extends AbstractBlockRotatableNSEWUD
{
    public BlockFireAlarmKiddeSmokeDetector() {
                                     ...
                                     float hitZ )
    {
        ...
        int y = pos.getY();
        int z = pos.getZ();
        world.playSound( null, x, y, z, SoundEvent.REGISTRY.getObject( new ResourceLocation( "csm:smokealarm" ) ),
                         SoundCategory.NEUTRAL, ( float ) 4, ( float ) 1 );
        return true;
    }
}
