...
public class BlockFireAlarmSystemSensorAdvanceHornStrobeOutdoorRed extends
  ...
  public float[] getStrobeLensFrom() {
    return new float[]{6f, 6.7f, 13f};
  }

  @Override
  public float[] getStrobeLensTo() {
    return new float[]{10f, 11.2f, 14f};
  }
  ...
  public String getSoundResourceName(IBlockState blockState) {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.000000, 0.125000, 0.812500, 1.000000, 1.000000, 1.000000);
    }
}
