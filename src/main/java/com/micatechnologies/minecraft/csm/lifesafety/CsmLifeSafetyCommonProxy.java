...
/**
 * Server-side (and common) proxy for the Life Safety module. Everything this module does per side is
 * rendering, so the common proxy has nothing to do; the client proxy extends it.
 *
 * @see ICsmProxy
 */
public class CsmLifeSafetyCommonProxy implements ICsmProxy {
