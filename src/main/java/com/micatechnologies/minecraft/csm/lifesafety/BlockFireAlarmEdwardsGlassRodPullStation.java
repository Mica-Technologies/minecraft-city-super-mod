...
public class BlockFireAlarmEdwardsGlassRodPullStation extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmedwardsglassrodpullstation";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmEdwardsGlassRodPullStation( ElementsCitySuperMod instance ) {
        super( instance, 2107 );
    }
