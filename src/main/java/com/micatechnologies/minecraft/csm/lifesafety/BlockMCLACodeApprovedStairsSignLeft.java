...
public class BlockMCLACodeApprovedStairsSignLeft extends AbstractBlockRotatableNSEWUD {

  public BlockMCLACodeApprovedStairsSignLeft() {
  ...
  public String getBlockRegistryName() {
    return "mclacodeapprovedstairssignleft";
  }
