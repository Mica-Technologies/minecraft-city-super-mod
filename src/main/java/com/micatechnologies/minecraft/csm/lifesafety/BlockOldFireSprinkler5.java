...
public class BlockOldFireSprinkler5 extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "oldfiresprinkler5";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockOldFireSprinkler5( ElementsCitySuperMod instance ) {
        super( instance, 2117 );
    }
