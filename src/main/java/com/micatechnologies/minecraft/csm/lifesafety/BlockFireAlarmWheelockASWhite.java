...
public class BlockFireAlarmWheelockASWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelockaswhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockASWhite( ElementsCitySuperMod instance ) {
        super( instance, 2032 );
    }
