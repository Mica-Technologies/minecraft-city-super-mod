...
public class BlockFireAlarmSystemSensorLSeriesHornStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensorlserieshornstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorLSeriesHornStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2091 );
    }
