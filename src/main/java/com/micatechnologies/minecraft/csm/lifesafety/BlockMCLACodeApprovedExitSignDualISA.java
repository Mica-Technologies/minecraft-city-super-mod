...
public class BlockMCLACodeApprovedExitSignDualISA extends AbstractBlockRotatableNSEWUD {

  public BlockMCLACodeApprovedExitSignDualISA() {
  ...
  public String getBlockRegistryName() {
    return "mclacodeapprovedexitsigndualisa";
  }
