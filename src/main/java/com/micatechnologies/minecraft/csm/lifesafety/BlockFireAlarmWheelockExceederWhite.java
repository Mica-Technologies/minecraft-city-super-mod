...
public class BlockFireAlarmWheelockExceederWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelockexceederwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockExceederWhite( ElementsCitySuperMod instance ) {
        super( instance, 2035 );
    }
