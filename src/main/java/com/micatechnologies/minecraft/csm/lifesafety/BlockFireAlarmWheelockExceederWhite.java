...
/**
 * White Wheelock Exceeder fire alarm horn/strobe block that plays the Wheelock AS alarm tone
...
public class BlockFireAlarmWheelockExceederWhite extends AbstractBlockFireAlarmSounder
  ...
  public float[] getStrobeLensFrom() {
    return new float[]{3f, 10f, 13f};
  }

  @Override
  public float[] getStrobeLensTo() {
    return new float[]{13f, 13f, 14f};
  }


  public static final PropertyInteger SOUND = PropertyInteger.create("sound", 0, 1);
  public static final String[] SOUND_NAMES = {"Code 3", "Marchtime"};
  ...
  public String getBlockRegistryName() {
    return "firealarmwheelockexceederwhite";
  }
