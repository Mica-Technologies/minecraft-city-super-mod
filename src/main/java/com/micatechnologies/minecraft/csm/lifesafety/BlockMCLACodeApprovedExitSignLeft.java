...
public class BlockMCLACodeApprovedExitSignLeft extends AbstractBlockRotatableNSEWUD {

  public BlockMCLACodeApprovedExitSignLeft() {
  ...
  public String getBlockRegistryName() {
    return "mclacodeapprovedexitsignleft";
  }
