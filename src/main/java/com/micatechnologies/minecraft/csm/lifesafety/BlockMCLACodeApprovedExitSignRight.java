...
public class BlockMCLACodeApprovedExitSignRight extends AbstractBlockRotatableNSEWUD
{
    public BlockMCLACodeApprovedExitSignRight() {
    ...
    public String getBlockRegistryName() {
        return "mclacodeapprovedexitsignright";
    }
