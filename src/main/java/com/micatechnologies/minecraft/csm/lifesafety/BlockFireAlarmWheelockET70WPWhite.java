...
public class BlockFireAlarmWheelockET70WPWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocket70wpwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockET70WPWhite( ElementsCitySuperMod instance ) {
        super( instance, 2051 );
    }
