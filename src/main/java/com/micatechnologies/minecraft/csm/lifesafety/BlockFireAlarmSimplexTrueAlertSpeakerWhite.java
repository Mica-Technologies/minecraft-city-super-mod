...
public class BlockFireAlarmSimplexTrueAlertSpeakerWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplextruealertspeakerwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplexTrueAlertSpeakerWhite( ElementsCitySuperMod instance ) {
        super( instance, 2079 );
    }
