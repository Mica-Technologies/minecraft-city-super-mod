...
public class BlockFireAlarmSpaceAgeAV32Red extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmspaceageav32red";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSpaceAgeAV32Red( ElementsCitySuperMod instance ) {
        super( instance, 2066 );
    }
