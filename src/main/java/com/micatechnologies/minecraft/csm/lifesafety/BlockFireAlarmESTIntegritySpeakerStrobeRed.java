...
public class BlockFireAlarmESTIntegritySpeakerStrobeRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmestintegrityspeakerstrobered";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmESTIntegritySpeakerStrobeRed( ElementsCitySuperMod instance ) {
        super( instance, 2057 );
    }
