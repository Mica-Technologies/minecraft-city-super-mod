...
public class BlockGreenManExitSignDownArrowSingleSided extends AbstractBlockRotatableNSEWUD {

  public BlockGreenManExitSignDownArrowSingleSided() {
  ...
  public String getBlockRegistryName() {
    return "greenmanexitsigndownarrowsinglesided";
  }
