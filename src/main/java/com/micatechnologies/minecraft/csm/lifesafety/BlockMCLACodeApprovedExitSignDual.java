...
public class BlockMCLACodeApprovedExitSignDual extends AbstractBlockRotatableNSEWUD
{
    public BlockMCLACodeApprovedExitSignDual() {
    ...
    public String getBlockRegistryName() {
        return "mclacodeapprovedexitsigndual";
    }
