...
public class BlockFireAlarmWheelockMTHornStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelockmthornstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockMTHornStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2037 );
    }
