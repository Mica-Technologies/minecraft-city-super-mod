...
public class BlockFireAlarmFireLiteBG8 extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmfirelitebg8";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmFireLiteBG8( ElementsCitySuperMod instance ) {
        super( instance, 2109 );
    }
