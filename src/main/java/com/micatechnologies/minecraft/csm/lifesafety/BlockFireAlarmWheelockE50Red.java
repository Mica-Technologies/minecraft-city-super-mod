...
public class BlockFireAlarmWheelockE50Red extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocke50red";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockE50Red( ElementsCitySuperMod instance ) {
        super( instance, 2052 );
    }
