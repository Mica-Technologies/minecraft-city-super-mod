...
public class BlockFireAlarmWheelockE50Red extends AbstractBlockFireAlarmSounderVoiceEvac
  ...
  public float[] getStrobeLensFrom() {
    return new float[]{3.5f, 13.3f, 13f};
  }

  @Override
  public float[] getStrobeLensTo() {
    return new float[]{12.5f, 15.3f, 14f};
  }


  @Override
  public String getBlockRegistryName() {
    return "firealarmwheelocke50red";
  }
