...
public class BlockFireAlarmWheelockET70WPRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocket70wpred";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockET70WPRed( ElementsCitySuperMod instance ) {
        super( instance, 2050 );
    }
