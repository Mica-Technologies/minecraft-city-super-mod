...
public class BlockGreenManExitSignRightArrow extends AbstractBlockRotatableNSEWUD {

  public BlockGreenManExitSignRightArrow() {
  ...
  public String getBlockRegistryName() {
    return "greenmanexitsignrightarrow";
  }
