...
public class BlockGreenManExitSignRightArrow extends ElementsCitySuperMod.ModElement
{
    @GameRegistry.ObjectHolder( "csm:greenmanexitsignrightarrow" )
    public static final Block block = null;

    public BlockGreenManExitSignRightArrow( ElementsCitySuperMod instance ) {
        super( instance, 4903 );
    }

    @Override
    public void initElements() {
        elements.blocks.add( () -> new BlockCustom().setRegistryName( "greenmanexitsignrightarrow" ) );
    ...
    public void registerModels( ModelRegistryEvent event ) {
        ModelLoader.setCustomModelResourceLocation( Item.getItemFromBlock( block ), 0,
                                                    new ModelResourceLocation( "csm:greenmanexitsignrightarrow",
                                                                               "inventory" ) );
    }
    ...
    public static class BlockCustom extends Block
    {
        ...
        public BlockCustom() {
            super( Material.ROCK );
            setUnlocalizedName( "greenmanexitsignrightarrow" );
