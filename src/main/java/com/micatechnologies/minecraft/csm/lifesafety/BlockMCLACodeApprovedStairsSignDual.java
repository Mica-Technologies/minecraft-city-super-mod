...
public class BlockMCLACodeApprovedStairsSignDual extends ElementsCitySuperMod.ModElement {
	...
	public BlockMCLACodeApprovedStairsSignDual(ElementsCitySuperMod instance) {
		super(instance, 123);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mclacodeapprovedstairssigndual"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:mclacodeapprovedstairssigndual", "inventory"));
	}
