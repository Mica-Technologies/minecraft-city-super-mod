...
public class BlockMCLACodeApprovedStairsSignDual extends AbstractBlockRotatableNSEWUD {

  public BlockMCLACodeApprovedStairsSignDual() {
  ...
  public String getBlockRegistryName() {
    return "mclacodeapprovedstairssigndual";
  }
