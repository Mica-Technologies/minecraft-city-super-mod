...
public class BlockFireAlarmWheelockE60White extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocke60white";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockE60White( ElementsCitySuperMod instance ) {
        super( instance, 2054 );
    }
