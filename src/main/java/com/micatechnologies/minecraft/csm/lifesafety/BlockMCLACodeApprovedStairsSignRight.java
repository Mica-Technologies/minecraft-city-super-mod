...
public class BlockMCLACodeApprovedStairsSignRight extends AbstractBlockRotatableNSEWUD {

  public BlockMCLACodeApprovedStairsSignRight() {
  ...
  public String getBlockRegistryName() {
    return "mclacodeapprovedstairssignright";
  }
