...
public class BlockMCLACodeApprovedExitSignISASingleSided extends AbstractBlockRotatableNSEWUD {

  public BlockMCLACodeApprovedExitSignISASingleSided() {
    super(Material.ROCK, SoundType.STONE, "pickaxe", 1, 1F, 10F, 0.85F, 0);
  }
  ...
  public String getBlockRegistryName() {
    return "mclacodeapprovedexitsignisasinglesided";
  }
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(-0.187500, 0.250000, 0.800000, 1.187500, 1.062500, 1.000000);
    }
