...
public class BlockGreenManExitSignUpRightArrow extends AbstractBlockRotatableNSEWUD
{
    public BlockGreenManExitSignUpRightArrow() {
    ...
    public String getBlockRegistryName() {
        return "greenmanexitsignuprightarrow";
    }
