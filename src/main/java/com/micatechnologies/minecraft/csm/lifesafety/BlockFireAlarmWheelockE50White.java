...
public class BlockFireAlarmWheelockE50White extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocke50white";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockE50White( ElementsCitySuperMod instance ) {
        super( instance, 2053 );
    }
