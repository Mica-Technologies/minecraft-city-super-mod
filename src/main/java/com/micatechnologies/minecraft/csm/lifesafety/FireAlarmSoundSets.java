 ...
 * unit offers the same five tones, and a copy of the list per block class is a copy that can drift
 * out of step with the others. The Commander 3 and the Commander 5 both read this one.</p>
 */
