...
public class BlockFireAlarmWheelockE70ChimeRed extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelocke70chimered";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockE70ChimeRed( ElementsCitySuperMod instance ) {
        super( instance, 2042 );
    }
