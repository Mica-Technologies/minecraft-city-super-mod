...
public class BlockMCLACodeApprovedStairsSign extends AbstractBlockRotatableNSEWUD
{
    public BlockMCLACodeApprovedStairsSign() {
    ...
    public String getBlockRegistryName() {
        return "mclacodeapprovedstairssign";
    }
