...
public class BlockFireAlarmFireLiteBG12 extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmfirelitebg12";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmFireLiteBG12( ElementsCitySuperMod instance ) {
        super( instance, 2108 );
    }
