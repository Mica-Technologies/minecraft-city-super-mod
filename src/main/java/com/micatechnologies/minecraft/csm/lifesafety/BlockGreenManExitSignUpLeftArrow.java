...
public class BlockGreenManExitSignUpLeftArrow extends AbstractBlockRotatableNSEWUD {

  public BlockGreenManExitSignUpLeftArrow() {
  ...
  public String getBlockRegistryName() {
    return "greenmanexitsignupleftarrow";
  }
