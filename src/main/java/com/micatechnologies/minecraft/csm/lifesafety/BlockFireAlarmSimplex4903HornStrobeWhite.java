...
public class BlockFireAlarmSimplex4903HornStrobeWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsimplex4903hornstrobewhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSimplex4903HornStrobeWhite( ElementsCitySuperMod instance ) {
        super( instance, 2072 );
    }
