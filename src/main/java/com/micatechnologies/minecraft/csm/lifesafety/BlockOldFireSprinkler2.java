...
public class BlockOldFireSprinkler2 extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "oldfiresprinkler2";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockOldFireSprinkler2( ElementsCitySuperMod instance ) {
        super( instance, 2117 );
    }
