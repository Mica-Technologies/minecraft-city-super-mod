...
public class BlockOldFireSprinkler4 extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "oldfiresprinkler4";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockOldFireSprinkler4( ElementsCitySuperMod instance ) {
        super( instance, 2117 );
    }
