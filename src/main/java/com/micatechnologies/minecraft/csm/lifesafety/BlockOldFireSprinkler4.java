...
/**
 * Legacy fire sprinkler block (variant 4) that detects fire and lava in the area below,
...
public class BlockOldFireSprinkler4 extends AbstractBlockFireAlarmDetector {

  @Override
  public String getBlockRegistryName() {
    return "oldfiresprinkler4";
  }
  ...
  public void onFire(World world, BlockPos blockPos, IBlockState blockState) {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.312500, 0.500000, 0.312500, 0.687500, 1.000000, 0.687500);
    }
}
