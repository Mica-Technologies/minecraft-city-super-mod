...
public class BlockFireAlarmWheelockMTHornStrobeWhiteBlue extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmwheelockmthornstrobewhiteblue";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmWheelockMTHornStrobeWhiteBlue( ElementsCitySuperMod instance ) {
        super( instance, 2038 );
    }
