...
public class BlockFireAlarmSystemSensorLSeriesSpeakerWhite extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "firealarmsystemsensorlseriesspeakerwhite";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockFireAlarmSystemSensorLSeriesSpeakerWhite( ElementsCitySuperMod instance ) {
        super( instance, 2087 );
    }
