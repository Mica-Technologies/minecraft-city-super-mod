...
public class BlockOldFireSprinkler3 extends ElementsCitySuperMod.ModElement
{
    public static final String blockRegistryName = "oldfiresprinkler3";
    @GameRegistry.ObjectHolder( "csm:" + blockRegistryName )
    public static final Block  block             = null;

    public BlockOldFireSprinkler3( ElementsCitySuperMod instance ) {
        super( instance, 2117 );
    }
