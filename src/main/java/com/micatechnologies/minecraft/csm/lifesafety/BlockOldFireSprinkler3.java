...
/**
 * Legacy fire sprinkler block (variant 3) that detects fire and lava in the area below,
...
public class BlockOldFireSprinkler3 extends AbstractBlockFireAlarmDetector {

  @Override
  public String getBlockRegistryName() {
    return "oldfiresprinkler3";
  }
