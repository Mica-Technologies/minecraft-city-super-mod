...
/**
 * Red Wheelock ET24 fire alarm sounder/strobe block: a square plate carrying a tall frosted
 * strobe lens beside a sounder grille.
 *
 * <p>It offers the same two selectable tones as the Wheelock MT horn strobe, cycled by
 * sneak-right-clicking the block.</p>
 *
 * @author Mica Technologies
 * @since 2026.8.23
 */
public class BlockFireAlarmWheelockET24SounderStrobeRed extends AbstractBlockFireAlarmSounder
  ...
  public float[] getStrobeLensFrom() {
    return new float[]{7.54f, 3.17f, 12f};
  }

  @Override
  public float[] getStrobeLensTo() {
    return new float[]{10.94f, 13.69f, 14f};
  }
  ...
  public AxisAlignedBB getBlockBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
    return new AxisAlignedBB(0.093750, 0.093750, 0.750000, 0.906250, 0.906250, 1.000000);
  }

  @Override
  public String getBlockRegistryName() {
    return "firealarmwheelocket24sounderstrobered";
  }
