...
public class BlockMCLACodeApprovedExitSignLeftISA extends AbstractBlockRotatableNSEWUD {

  public BlockMCLACodeApprovedExitSignLeftISA() {
  ...
  public String getBlockRegistryName() {
    return "mclacodeapprovedexitsignleftisa";
  }
