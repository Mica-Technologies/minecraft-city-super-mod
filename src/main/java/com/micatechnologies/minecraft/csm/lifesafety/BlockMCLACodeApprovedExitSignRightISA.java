...
public class BlockMCLACodeApprovedExitSignRightISA extends AbstractBlockRotatableNSEWUD {

  public BlockMCLACodeApprovedExitSignRightISA() {
  ...
  public String getBlockRegistryName() {
    return "mclacodeapprovedexitsignrightisa";
  }
