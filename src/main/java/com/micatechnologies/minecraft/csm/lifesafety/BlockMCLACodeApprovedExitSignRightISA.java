...
public class BlockMCLACodeApprovedExitSignRightISA extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mclacodeapprovedexitsignrightisa")
	public static final Block block = null;
	public BlockMCLACodeApprovedExitSignRightISA( ElementsCitySuperMod instance) {
		super(instance, 9873);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mclacodeapprovedexitsignrightisa"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:mclacodeapprovedexitsignrightisa", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("mclacodeapprovedexitsignrightisa");
