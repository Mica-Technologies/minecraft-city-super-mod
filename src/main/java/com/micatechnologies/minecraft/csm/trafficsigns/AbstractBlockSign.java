...
public abstract class AbstractBlockSign extends AbstractBlockRotatableHZEight {
  ...
  public static final PropertyBool FRONTSIGNALPOLE = PropertyBool.create("frontsignalpole");
  ...
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, FACING, DOWNWARD, FRONTSIGNALPOLE);
  }
  ...
  public @NotNull IBlockState getActualState(IBlockState state,
    ...
    return state.withProperty(DOWNWARD, getBlockBelowIsSlab(worldIn, pos))
        .withProperty(FRONTSIGNALPOLE, getBlockIsInFrontOfSignalArm(worldIn, pos));
  }
}
