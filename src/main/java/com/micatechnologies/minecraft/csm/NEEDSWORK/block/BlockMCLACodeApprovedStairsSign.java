...
public class BlockMCLACodeApprovedStairsSign extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mclacodeapprovedstairssign")
	public static final Block block = null;
	public BlockMCLACodeApprovedStairsSign(ElementsCitySuperMod instance) {
		super(instance, 120);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mclacodeapprovedstairssign"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:mclacodeapprovedstairssign", "inventory"));
	}
