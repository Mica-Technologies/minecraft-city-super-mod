...
public class BlockMCLACodeApprovedExitSignRight extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mclacodeapprovedexitsignright")
	public static final Block block = null;
	public BlockMCLACodeApprovedExitSignRight(ElementsCitySuperMod instance) {
		super(instance, 118);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mclacodeapprovedexitsignright"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:mclacodeapprovedexitsignright", "inventory"));
	}
