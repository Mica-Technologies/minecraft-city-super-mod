...
public class BlockWHOV50Shaded extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:whov50shaded")
	public static final Block block = null;
	public BlockWHOV50Shaded(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:whov50shaded", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("whov50shaded");
			setUnlocalizedName("whov50shaded");
