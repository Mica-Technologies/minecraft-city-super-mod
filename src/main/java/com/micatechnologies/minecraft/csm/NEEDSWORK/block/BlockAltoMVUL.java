...
public class BlockAltoMVUL extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:altomvul")
	public static final Block block = null;
	public BlockAltoMVUL(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:altomvul", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("altomvul");
			setUnlocalizedName("altomvul");
