...
public class BlockAltoMVWLSlim extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:altomvwlslim")
	public static final Block block = null;
	public BlockAltoMVWLSlim(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:altomvwlslim", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("altomvwlslim");
			setUnlocalizedName("altomvwlslim");
