...
public class BlockGEForm109 extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:geform109")
	public static final Block block = null;
	public BlockGEForm109(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:geform109", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("geform109");
			setUnlocalizedName("geform109");
