...
public class BlockControlBoxSmallMetal extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:controlboxsmallmetal")
	public static final Block block = null;
	public BlockControlBoxSmallMetal(ElementsCitySuperMod instance) {
		super(instance, 1163);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("controlboxsmallmetal"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:controlboxsmallmetal", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("controlboxsmallmetal");
