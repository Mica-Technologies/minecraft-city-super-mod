...
public class BlockExitSignSingleSided extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:exitsignsinglesided")
	public static final Block block = null;
	public BlockExitSignSingleSided(ElementsCitySuperMod instance) {
		super(instance, 1125);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("exitsignsinglesided"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:exitsignsinglesided", "inventory"));
	}
