...
public class BlockCreeledwaysmall extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:creeledwaysmall")
	public static final Block block = null;
	public BlockCreeledwaysmall(ElementsCitySuperMod instance) {
		super(instance, 294);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:creeledwaysmall", "inventory"));
	}
