...
public class BlockWHOV50ShadedNP extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:whov50shadednp")
	public static final Block block = null;
	public BlockWHOV50ShadedNP(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:whov50shadednp", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("whov50shadednp");
			setUnlocalizedName("whov50shadednp");
