...
public class BlockAltoRLL extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:altorll")
	public static final Block block = null;
	public BlockAltoRLL(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:altorll", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("altorll");
			setUnlocalizedName("altorll");
