...
public class BlockMCLACodeApprovedStairsSignRight extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:mclacodeapprovedstairssignright")
	public static final Block block = null;
	public BlockMCLACodeApprovedStairsSignRight(ElementsCitySuperMod instance) {
		super(instance, 122);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mclacodeapprovedstairssignright"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:mclacodeapprovedstairssignright", "inventory"));
	}
