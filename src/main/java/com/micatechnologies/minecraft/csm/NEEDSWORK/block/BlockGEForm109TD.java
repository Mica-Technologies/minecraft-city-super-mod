...
public class BlockGEForm109TD extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:geform109td")
	public static final Block block = null;
	public BlockGEForm109TD(ElementsCitySuperMod instance) {
		super(instance, 349);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("csm:geform109td", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("geform109td");
			setUnlocalizedName("geform109td");
