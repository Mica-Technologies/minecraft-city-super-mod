...
public class BlockControlBoxSmallBlack extends ElementsCitySuperMod.ModElement {
	@GameRegistry.ObjectHolder("csm:controlboxsmallblack")
	public static final Block block = null;
	public BlockControlBoxSmallBlack(ElementsCitySuperMod instance) {
		super(instance, 1164);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("controlboxsmallblack"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("csm:controlboxsmallblack", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("controlboxsmallblack");
