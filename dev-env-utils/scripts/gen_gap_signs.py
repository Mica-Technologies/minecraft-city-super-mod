...
CATALOGUE = [
    ...
    ('signla2hourparking', ('2 Hour Parking 9AM-8PM Sign', 'Señal de Estacionamiento 2 Horas 9AM-8PM',
                            '2 Stunden Parken 9-20 Uhr Schild', '2 Timmars Parkering 9-20-Vägmärke'),
     'square', COMPOSED('square', 'LA_TWO_HOUR'), 'ladotnostopping'),
    ...
    # --- route marker directional arrow auxiliaries (M6): the white plaques a route marker
    # is posted over. The mod already had the M5 advance-turn arrows and the yellow warning
    # arrows; these are the 21 x 15 black-on-white ones, straight off the book's
    # DIRECTIONAL ARROW AUXILIARY pages. The book draws only the right-hand M6-1 and M6-2,
    # and the MUTCD reverses them for the other way, which is what mirror= does here.
    ('signroutearrowright', ('Route Directional Arrow Sign (Right)',
                             'Señal de Flecha Direccional de Ruta (Derecha)',
                             'Routenrichtungspfeil-Schild (Rechts)',
                             'Vägnummerpil-Vägmärke (Höger)'),
     'wide', SHS('wide', 'Guide', 20, 4), 'signjct'),
    ('signroutearrowleft', ('Route Directional Arrow Sign (Left)',
                            'Señal de Flecha Direccional de Ruta (Izquierda)',
                            'Routenrichtungspfeil-Schild (Links)',
                            'Vägnummerpil-Vägmärke (Vänster)'),
     'wide', SHS('wide', 'Guide', 20, 4, mirror=True), 'signroutearrowright'),
    ('signroutearrowdiagonalright', ('Route Directional Arrow Sign (Diagonal Right)',
                                     'Señal de Flecha Direccional de Ruta (Diagonal Derecha)',
                                     'Routenrichtungspfeil-Schild (Diagonal Rechts)',
                                     'Vägnummerpil-Vägmärke (Diagonal Höger)'),
     'wide', SHS('wide', 'Guide', 21, 0), 'signroutearrowleft'),
    ('signroutearrowdiagonalleft', ('Route Directional Arrow Sign (Diagonal Left)',
                                    'Señal de Flecha Direccional de Ruta (Diagonal Izquierda)',
                                    'Routenrichtungspfeil-Schild (Diagonal Links)',
                                    'Vägnummerpil-Vägmärke (Diagonal Vänster)'),
     'wide', SHS('wide', 'Guide', 21, 0, mirror=True), 'signroutearrowdiagonalright'),
    ('signroutearrowahead', ('Route Directional Arrow Sign (Straight Ahead)',
                             'Señal de Flecha Direccional de Ruta (Recto)',
                             'Routenrichtungspfeil-Schild (Geradeaus)',
                             'Vägnummerpil-Vägmärke (Rakt Fram)'),
     'wide', SHS('wide', 'Guide', 21, 2), 'signroutearrowdiagonalleft'),
    ('signroutearrowleftright', ('Route Directional Arrow Sign (Left/Right)',
                                 'Señal de Flecha Direccional de Ruta (Izquierda/Derecha)',
                                 'Routenrichtungspfeil-Schild (Links/Rechts)',
                                 'Vägnummerpil-Vägmärke (Vänster/Höger)'),
     'wide', SHS('wide', 'Guide', 21, 4), 'signroutearrowahead'),
# --- the rest of the M-series route marker auxiliaries, from the book's own pages.
# M5 is the advance turn arrow (one arrow that runs up and bends off), which is NOT the
# two-headed lane-use arrow the mod already had; M6 is the directional arrow a marker is
# posted over; M7 is the same family in green for a bicycle route. The book draws the
# right-hand member of a pair only and the MUTCD reverses it, which is what mirror= does.
# The green BEGIN / END / TO are set rather than lifted: the book's are 24 x 6, four times
# as wide as they are tall, and no plate in the mod is that shape -- squeezing the drawing
# onto the 2:1 plaque stretched the legend. M2-2 is deliberately absent: it is a 60 x 48
# composed panel carrying real route shields, which is what the dynamic guide sign builds.
    ('signrouteadvanceturnleft', ('Route Advance Turn Arrow Sign (Left)',
     'Señal de Flecha de Giro Anticipado de Ruta (Izquierda)',
     'Routen-Vorankündigungspfeil-Schild (Links)',
     'Vägnummer Förvarningspil-Vägmärke (Vänster)'),
     'wide', SHS('wide', 'Guide', 20, 0), 'signroutearrowleftright'),
    ('signrouteadvanceturnright', ('Route Advance Turn Arrow Sign (Right)',
     'Señal de Flecha de Giro Anticipado de Ruta (Derecha)',
     'Routen-Vorankündigungspfeil-Schild (Rechts)',
     'Vägnummer Förvarningspil-Vägmärke (Höger)'),
     'wide', SHS('wide', 'Guide', 20, 0, mirror=True), 'signrouteadvanceturnleft'),
    ('signrouteadvanceturndiagonalleft', ('Route Advance Turn Arrow Sign (Diagonal Left)',
     'Señal de Flecha de Giro Anticipado de Ruta (Diagonal Izquierda)',
     'Routen-Vorankündigungspfeil-Schild (Diagonal Links)',
     'Vägnummer Förvarningspil-Vägmärke (Diagonal Vänster)'),
     'wide', SHS('wide', 'Guide', 20, 2), 'signrouteadvanceturnright'),
    ('signrouteadvanceturndiagonalright', ('Route Advance Turn Arrow Sign (Diagonal Right)',
     'Señal de Flecha de Giro Anticipado de Ruta (Diagonal Derecha)',
     'Routen-Vorankündigungspfeil-Schild (Diagonal Rechts)',
     'Vägnummer Förvarningspil-Vägmärke (Diagonal Höger)'),
     'wide', SHS('wide', 'Guide', 20, 2, mirror=True), 'signrouteadvanceturndiagonalleft'),
    ('signroutearrowdiagonaltwoway', ('Route Directional Arrow Sign (Diagonal Two-Way)',
     'Señal de Flecha Direccional de Ruta (Diagonal de Doble Sentido)',
     'Routenrichtungspfeil-Schild (Diagonal Zweiseitig)',
     'Vägnummerpil-Vägmärke (Diagonal Dubbelriktad)'),
     'wide', SHS('wide', 'Guide', 22, 0), 'signrouteadvanceturndiagonalright'),
    ('signroutearrowaheadorright', ('Route Directional Arrow Sign (Ahead or Right)',
     'Señal de Flecha Direccional de Ruta (Recto o Derecha)',
     'Routenrichtungspfeil-Schild (Geradeaus oder Rechts)',
     'Vägnummerpil-Vägmärke (Rakt Fram eller Höger)'),
     'wide', SHS('wide', 'Guide', 22, 2), 'signroutearrowdiagonaltwoway'),
    ('signroutearrowaheadorleft', ('Route Directional Arrow Sign (Ahead or Left)',
     'Señal de Flecha Direccional de Ruta (Recto o Izquierda)',
     'Routenrichtungspfeil-Schild (Geradeaus oder Links)',
     'Vägnummerpil-Vägmärke (Rakt Fram eller Vänster)'),
     'wide', SHS('wide', 'Guide', 22, 2, mirror=True), 'signroutearrowaheadorright'),
    ('signroutearrowaheadordiagonalright', ('Route Directional Arrow Sign (Ahead or Diagonal Right)',
     'Señal de Flecha Direccional de Ruta (Recto o Diagonal Derecha)',
     'Routenrichtungspfeil-Schild (Geradeaus oder Diagonal Rechts)',
     'Vägnummerpil-Vägmärke (Rakt Fram eller Diagonal Höger)'),
     'wide', SHS('wide', 'Guide', 22, 4), 'signroutearrowaheadorleft'),
    ('signroutearrowaheadordiagonalleft', ('Route Directional Arrow Sign (Ahead or Diagonal Left)',
     'Señal de Flecha Direccional de Ruta (Recto o Diagonal Izquierda)',
     'Routenrichtungspfeil-Schild (Geradeaus oder Diagonal Links)',
     'Vägnummerpil-Vägmärke (Rakt Fram eller Diagonal Vänster)'),
     'wide', SHS('wide', 'Guide', 22, 4, mirror=True), 'signroutearrowaheadordiagonalright'),
    ('signroutearrowaheadandright', ('Route Directional Arrow Sign (Ahead and Right)',
     'Señal de Flecha Direccional de Ruta (Recto y Derecha)',
     'Routenrichtungspfeil-Schild (Geradeaus und Rechts)',
     'Vägnummerpil-Vägmärke (Rakt Fram och Höger)'),
     'square', SHS('square', 'Guide', 23, 0), 'signroutearrowaheadordiagonalleft'),
    ('signroutearrowaheadandleft', ('Route Directional Arrow Sign (Ahead and Left)',
     'Señal de Flecha Direccional de Ruta (Recto e Izquierda)',
     'Routenrichtungspfeil-Schild (Geradeaus und Links)',
     'Vägnummerpil-Vägmärke (Rakt Fram och Vänster)'),
     'square', SHS('square', 'Guide', 23, 0, mirror=True), 'signroutearrowaheadandright'),
    ('signroutearrowsplitleftright', ('Route Directional Arrow Sign (Left and Right)',
     'Señal de Flecha Direccional de Ruta (Izquierda y Derecha)',
     'Routenrichtungspfeil-Schild (Links und Rechts)',
     'Vägnummerpil-Vägmärke (Vänster och Höger)'),
     'wide', SHS('wide', 'Guide', 23, 1), 'signroutearrowaheadandleft'),
    ('signjctinterstate', ('JCT Sign (Interstate)',
     'Señal JCT (Interestatal)',
     'JCT-Schild (Interstate)',
     'JCT-Vägmärke (Interstate)'),
     'wide', SHS('wide', 'Guide', 12, 1), 'signroutearrowsplitleftright'),
    ('signtempplaque', ('Temp Sign (Plaque)',
     'Señal Temporal Abreviada (Placa)',
     'Temporär-Schild (Zusatzschild)',
     'Tillfälligt-Vägmärke (Tillfällig)'),
     'plaque', SHS('plaque', 'Guide', 17, 0), 'signjctinterstate'),
    ('signtointerstate', ('To Sign (Interstate)',
     'Señal «Hacia» (Interestatal)',
     'Nach Schild (Interstate)',
     'Till-Vägmärke (Interstate)'),
     'plaque', SHS('plaque', 'Guide', 16, 3), 'signtempplaque'),
    ('signbeginbikeroute', ('Begin Sign (Bike Route)',
     'Señal de Inicio (Ruta Ciclista)',
     'Beginn-Schild (Radroute)',
     'Börjar-Vägmärke (Cykelled)'),
     'plaque', T('plaque', ['BEGIN'], GREEN, WHITE), 'signtointerstate'),
    ('signendbikeroute', ('End Sign (Bike Route)',
     'Señal de Fin (Ruta Ciclista)',
     'Ende-Schild (Radroute)',
     'Slut-Vägmärke (Cykelled)'),
     'plaque', T('plaque', ['END'], GREEN, WHITE), 'signbeginbikeroute'),
    ('signtobikeroute', ('To Sign (Bike Route)',
     'Señal «Hacia» (Ruta Ciclista)',
     'Nach Schild (Radroute)',
     'Till-Vägmärke (Cykelled)'),
     'plaque', T('plaque', ['TO'], GREEN, WHITE), 'signendbikeroute'),
    ('signbikerouteright', ('Bike Route Directional Arrow Sign (Right)',
     'Señal de Flecha Direccional de Ruta Ciclista (Derecha)',
     'Radroutenrichtungspfeil-Schild (Rechts)',
     'Cykelledspil-Vägmärke (Höger)'),
     'landscape', SHS('landscape', 'Guide', 24, 0), 'signtobikeroute'),
    ('signbikerouteahead', ('Bike Route Directional Arrow Sign (Ahead)',
     'Señal de Flecha Direccional de Ruta Ciclista (Recto)',
     'Radroutenrichtungspfeil-Schild (Geradeaus)',
     'Cykelledspil-Vägmärke (Rakt Fram)'),
     'landscape', SHS('landscape', 'Guide', 24, 1), 'signbikerouteright'),
    ('signbikeroutediagonaltwoway', ('Bike Route Directional Arrow Sign (Diagonal Two-Way)',
     'Señal de Flecha Direccional de Ruta Ciclista (Diagonal de Doble Sentido)',
     'Radroutenrichtungspfeil-Schild (Diagonal Zweiseitig)',
     'Cykelledspil-Vägmärke (Diagonal Dubbelriktad)'),
     'landscape', SHS('landscape', 'Guide', 24, 2), 'signbikerouteahead'),
    ('signbikeroutediagonalright', ('Bike Route Directional Arrow Sign (Diagonal Right)',
     'Señal de Flecha Direccional de Ruta Ciclista (Diagonal Derecha)',
     'Radroutenrichtungspfeil-Schild (Diagonal Rechts)',
     'Cykelledspil-Vägmärke (Diagonal Höger)'),
     'landscape', SHS('landscape', 'Guide', 24, 3), 'signbikeroutediagonaltwoway'),
    ('signbikerouteleftright', ('Bike Route Directional Arrow Sign (Left and Right)',
     'Señal de Flecha Direccional de Ruta Ciclista (Izquierda y Derecha)',
     'Radroutenrichtungspfeil-Schild (Links und Rechts)',
     'Cykelledspil-Vägmärke (Vänster och Höger)'),
     'landscape', SHS('landscape', 'Guide', 25, 0), 'signbikeroutediagonalright'),
    ('signbikerouteaheadorright', ('Bike Route Directional Arrow Sign (Ahead or Right)',
     'Señal de Flecha Direccional de Ruta Ciclista (Recto o Derecha)',
     'Radroutenrichtungspfeil-Schild (Geradeaus oder Rechts)',
     'Cykelledspil-Vägmärke (Rakt Fram eller Höger)'),
     'landscape', SHS('landscape', 'Guide', 25, 1), 'signbikerouteleftright'),
    ('signbikerouteaheadordiagonalright', ('Bike Route Directional Arrow Sign (Ahead or Diagonal Right)',
     'Señal de Flecha Direccional de Ruta Ciclista (Recto o Diagonal Derecha)',
