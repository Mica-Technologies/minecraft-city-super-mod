...
/**
 * Fire alarm pull station block modeled after an FCI (Fire Control Instruments) pull station.
...
public class BlockFireAlarmFCIPull extends AbstractBlockFireAlarmActivator {
