...
public class CsmTabLifeSafety extends CsmTab {
  ...
  public void initTabElements(FMLPreInitializationEvent fmlPreInitializationEvent) {
    ...
    initTabBlock(new BlockFireAlarmSounderStrobeMetaSoundFactory("firealarmsimplex4903hornstrobered", new AxisAlignedBB(0.062500, 0.437500, 0.687500, 0.937500, 1.000000, 1.000000), new float[]{1.3f, 7.3f, 11f}, new float[]{4.7f, 15.8f, 14f}, FireAlarmSoundSets.SIMPLEX_4903, FireAlarmSoundSets.SIMPLEX_4903_NAMES));
    initTabBlock(new BlockFireAlarmSounderStrobeMetaSoundFactory("firealarmsimplex4903hornstrobewhite", new AxisAlignedBB(0.062500, 0.437500, 0.687500, 0.937500, 1.000000, 1.000000), new float[]{1.3f, 7.3f, 11f}, new float[]{4.7f, 15.8f, 14f}, FireAlarmSoundSets.SIMPLEX_4903, FireAlarmSoundSets.SIMPLEX_4903_NAMES));
    ...
    initTabBlock(new BlockFireAlarmSounderStrobeMetaSoundFactory("firealarmsimplex4903verticalhornstrobered", new AxisAlignedBB(0.209375, 0.125000, 0.687500, 0.790625, 1.000000, 1.000000), new float[]{3.92f, 11.31f, 11f}, new float[]{12.13f, 15.32f, 14f}, FireAlarmSoundSets.SIMPLEX_4903, FireAlarmSoundSets.SIMPLEX_4903_NAMES));
    initTabBlock(new BlockFireAlarmSounderStrobeMetaSoundFactory("firealarmsimplex4903verticalhornstrobewhite", new AxisAlignedBB(0.209375, 0.125000, 0.687500, 0.790625, 1.000000, 1.000000), new float[]{3.92f, 11.31f, 11f}, new float[]{12.13f, 15.32f, 14f}, FireAlarmSoundSets.SIMPLEX_4903, FireAlarmSoundSets.SIMPLEX_4903_NAMES));
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsimplex4903verticalspeakerstrobered", new AxisAlignedBB(0.209375, 0.125000, 0.687500, 0.790625, 1.000000, 1.000000), new float[]{3.92f, 11.31f, 11f}, new float[]{12.13f, 15.32f, 14f}));
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsimplex4903verticalspeakerstrobewhite", new AxisAlignedBB(0.209375, 0.125000, 0.687500, 0.790625, 1.000000, 1.000000), new float[]{3.92f, 11.31f, 11f}, new float[]{12.13f, 15.32f, 14f}));
    ...
    initTabBlock(new BlockFireAlarmSounderFactory("firealarmsimplextruealerthornred", "csm:stahorn", new AxisAlignedBB(0.125000, 0.218750, 0.875000, 0.875000, 1.000000, 1.000000)));
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsimplextruealerthornstrobered", "csm:stahorn", new AxisAlignedBB(0.100000, -0.200000, 0.806250, 0.900000, 1.000000, 1.000000), new float[]{2.18f, 0.22f, 12.9f}, new float[]{13.74f, 3.92f, 14f}));
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsimplextruealerthornstrobewhite", "csm:stahorn", new AxisAlignedBB(0.100000, -0.200000, 0.806250, 0.900000, 1.000000, 1.000000), new float[]{2.18f, 0.22f, 12.9f}, new float[]{13.74f, 3.92f, 14f}));
    initTabBlock(new BlockFireAlarmSounderFactory("firealarmsimplextruealerthornwhite", "csm:stahorn", new AxisAlignedBB(0.125000, 0.218750, 0.875000, 0.875000, 1.000000, 1.000000)));
    ...
    initTabBlock(new BlockFireAlarmVoiceEvacFactory("firealarmsimplextruealertspeakerred", new AxisAlignedBB(0.125000, 0.218750, 0.875000, 0.875000, 1.000000, 1.000000)));
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsimplextruealertspeakerstrobered", new AxisAlignedBB(0.100000, -0.200000, 0.806250, 0.900000, 1.000000, 1.000000), new float[]{2.18f, 0.22f, 12.9f}, new float[]{13.74f, 3.92f, 14f}));
    ...
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensorclassichornstrobered", "csm:spectralert_classic", new AxisAlignedBB(0.078125, 0.012500, 0.725000, 0.921875, 0.993750, 1.000000), new float[]{3.83f, 0.69f, 11.6f}, new float[]{12.42f, 7.44f, 14.5f}));
    ...
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensorlserieshornstrobered", "csm:spectralert", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.71f, 5.34f, 13f}, new float[]{10.38f, 9.7f, 14f}));
    initTabBlock(new BlockFireAlarmSounderStrobeFactory("firealarmsystemsensorlserieshornstrobewhite", "csm:spectralert", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.71f, 5.34f, 13f}, new float[]{10.38f, 9.7f, 14f}));
    ...
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsystemsensorlseriesledspeakerstrobered", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{6.38f, 9.4f, 13f}, new float[]{9.64f, 12.65f, 14f}, IStrobeBlock.StrobeLensShape.ROUND));
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsystemsensorlseriesledspeakerstrobewhite", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{6.38f, 9.4f, 13f}, new float[]{9.64f, 12.65f, 14f}, IStrobeBlock.StrobeLensShape.ROUND));
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsystemsensorlseriesledspeakerstrobeblack", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{6.38f, 9.4f, 13f}, new float[]{9.64f, 12.65f, 14f}, IStrobeBlock.StrobeLensShape.ROUND));
    ...
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsystemsensorlseriesspeakerstrobered", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.57f, 5.84f, 13f}, new float[]{10.03f, 10.11f, 14f}));
    initTabBlock(new BlockFireAlarmVoiceEvacStrobeFactory("firealarmsystemsensorlseriesspeakerstrobewhite", new AxisAlignedBB(0.187500, 0.187500, 0.812500, 0.812500, 1.000000, 1.000000), new float[]{5.57f, 5.84f, 13f}, new float[]{10.03f, 10.11f, 14f}));
