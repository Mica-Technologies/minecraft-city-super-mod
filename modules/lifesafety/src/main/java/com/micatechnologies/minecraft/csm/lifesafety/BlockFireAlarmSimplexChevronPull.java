...
/**
 * Fire alarm pull station block modeled after the Simplex chevron-style pull station.
...
public class BlockFireAlarmSimplexChevronPull extends AbstractBlockFireAlarmActivator {
  ...
  public String getBlockRegistryName() {
    return "firealarmsimplexchevronpull";
  }
