...
public class BlockTrafficPoleHorizontalMountDouble extends AbstractBlockRotatableNSEWUD implements
    ICsmRetiringBlock, ICsmNoSnowAccumulation {

  public BlockTrafficPoleHorizontalMountDouble() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizontalmountdouble";
  }
