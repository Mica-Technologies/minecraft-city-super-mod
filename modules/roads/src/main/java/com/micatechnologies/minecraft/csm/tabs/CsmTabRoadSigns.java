...
public class CsmTabRoadSigns extends CsmTab {
   ...
   *
   * <p>Registration order is display order: a creative tab renders its contents by walking
   * the item registry, and {@code CsmRegistry} keeps blocks in the order they were
   * registered. The signs below are therefore grouped into MUTCD categories -- hardware
   * first, then regulatory, warning, pedestrian/bike, school, work zone, guide, services,
   * recreational -- and sorted alphabetically by display name inside each group. Add a new
   * sign to the section it belongs to rather than to the end of the method, or it lands on
   * its own at the bottom of the tab.</p>
   *
  ...
  public void initTabElements(FMLPreInitializationEvent fmlPreInitializationEvent) {
    // --- Sign hardware and structure: poles, mounts, backing panels, blank faces ---
    ...
    // --- Regulatory signs: black-on-white and red: what road users must or must not do ---
    initTabBlock(new BlockTrafficSign("signpost4way"));
    initTabBlock(new BlockTrafficSign("carelesspersonsign"));
    ...
    initTabBlock(new BlockTrafficSign("bearcrossingsign"));
    initTabBlock(new BlockTrafficSign("beginfwysign"));
    initTabBlock(new BlockTrafficSign("beginhwysign"));
    initTabBlock(new BlockTrafficSign("beginpkwysign"));
    ...
    initTabBlock(new BlockTrafficSign("dangerbadwatersign"));
    initTabBlock(new BlockTrafficSign("dangerfallingmaterialsign"));
    initTabBlock(new BlockTrafficSign("generichvdangersign"));
    ...
    initTabBlock(new BlockTrafficSign("altodwphvdangersign"));
    ...
    initTabBlock(new BlockTrafficSign("forestryvehiclesonlysign"));
    ...
    initTabBlock(new BlockTrafficSign("kathieevanssign"));
    ...
    initTabBlock(new BlockTrafficSign("signpostkeepleft"));
    ...
    initTabBlock(new BlockTrafficSign("noforestparkingsign"));
    ...
    initTabBlock(new BlockTrafficSign("signnoleftoruturn"));
    initTabBlock(new BlockTrafficSign("signnomotorvehicles"));
    initTabBlock(new BlockTrafficSign("noovernightparkingsign"));
    ...
    initTabBlock(new BlockTrafficSign("onewaytlsignright"));
    initTabBlock(new BlockTrafficSign("onewaytlsignleft"));
    ...
    initTabBlock(new BlockTrafficSign("restrictedareasign"));
    initTabBlock(new BlockTrafficSign("signrightahead"));
    initTabBlock(new BlockTrafficSign("signrightmustturnright"));
    initTabBlock(new BlockTrafficSign("rightlanefreewayonlysign"));
    ...
    initTabBlock(new BlockTrafficSign("signroundaboutdirectional"));
    initTabBlock(new BlockTrafficSign("signroundaboutplaque"));
    ...
    initTabBlock(new BlockTrafficSign("snownotremovedsign"));
    initTabBlock(new BlockTrafficSign("signsouth"));
    initTabBlock(new BlockTrafficSign("signspeed0"));
    initTabBlock(new BlockTrafficSign("signspeed10"));
    ...
    initTabBlock(new BlockTrafficSign("signspeed70"));
    ...
    initTabBlock(new BlockTrafficSign("extremeheatdangersign"));
    ...
    initTabBlock(new BlockTrafficSign("doorsunlockedbiz"));
    ...
    initTabBlock(new BlockTrafficSign("shouldertravelongreenarrowsign"));
    ...
    initTabBlock(new BlockTrafficSign("utilityvehiclesonlysign"));
    initTabBlock(new BlockTrafficSign("signvehiclelugsprohibit"));
    initTabBlock(new BlockTrafficSign("signwalkleft"));
    initTabBlock(new BlockTrafficSign("deadlyforcesign"));
    initTabBlock(new BlockTrafficSign("fallhazzardsign"));
    initTabBlock(new BlockTrafficSign("verizondig"));
    ...
    initTabBlock(new BlockTrafficSign("sign500feet"));
    initTabBlock(new BlockTrafficSign("sign1000feet"));
    ...
    initTabBlock(new BlockTrafficSign("signadvisoryspeed10"));
    initTabBlock(new BlockTrafficSign("signadvisoryspeed15"));
    initTabBlock(new BlockTrafficSign("signadvisoryspeed20"));
    initTabBlock(new BlockTrafficSign("signadvisoryspeed25"));
    initTabBlock(new BlockTrafficSign("signadvisoryspeed30"));
    initTabBlock(new BlockTrafficSign("signadvisoryspeed35"));
    initTabBlock(new BlockTrafficSign("signadvisoryspeed40"));
    initTabBlock(new BlockTrafficSign("signadvisoryspeed45"));
    initTabBlock(new BlockTrafficSign("basestationradiosign"));
    initTabBlock(new BlockTrafficSign("signbepreparedtostop"));
    ...
    initTabBlock(new BlockTrafficSign("earprotectionsign"));
    initTabBlock(new BlockTrafficSign("switchequipmentwarningsign"));
    initTabBlock(new BlockTrafficSign("signcow"));
    initTabBlock(new BlockTrafficSign("signcrosstrafficdoesnotstop"));
    ...
    initTabBlock(new BlockTrafficSign("endcountymaintainedroadsign"));
    initTabBlock(new BlockTrafficSign("roadend"));
    initTabBlock(new BlockTrafficSign("signexit25"));
    initTabBlock(new BlockTrafficSign("signfallingrocks"));
    initTabBlock(new BlockTrafficSign("faweincidentsign"));
    initTabBlock(new BlockTrafficSign("signfiretruck"));
    initTabBlock(new BlockTrafficSign("fwyintersectionsign"));
    ...
    initTabBlock(new BlockTrafficSign("signhorse"));
    ...
    initTabBlock(new BlockTrafficSign("calaneendsignleft"));
    initTabBlock(new BlockTrafficSign("calaneendsignright"));
    ...
    initTabBlock(new BlockTrafficSign("signloosegravel"));
    initTabBlock(new BlockTrafficSign("massdotheavymergesign"));
    initTabBlock(new BlockTrafficSign("massdotsidestreettrafficsign"));
    initTabBlock(new BlockTrafficSign("signmergeleft"));
    initTabBlock(new BlockTrafficSign("signmergeright"));
    initTabBlock(new BlockTrafficSign("limitedmaintroadsign"));
    ...
    initTabBlock(new BlockTrafficSign("signnext2miles"));
    initTabBlock(new BlockTrafficSign("nofwyaccesssign"));
    initTabBlock(new BlockTrafficSign("noguardrailssign"));
    initTabBlock(new BlockTrafficSign("nohwyaccesssign"));
    initTabBlock(new BlockTrafficSign("signnooutlet"));
    initTabBlock(new BlockTrafficSign("signnopassingzone"));
    initTabBlock(new BlockTrafficSign("nopkwyaccesssign"));
    ...
    initTabBlock(new BlockTrafficSign("parkwayintersectionsign"));
    ...
    initTabBlock(new BlockTrafficSign("signreversecurveleft"));
    initTabBlock(new BlockTrafficSign("signreversecurveright"));
    initTabBlock(new BlockTrafficSign("signreverseturnleft"));
    initTabBlock(new BlockTrafficSign("signreverseturnright"));
    ...
    initTabBlock(new BlockTrafficSign("signroadnarrows"));
    initTabBlock(new BlockTrafficSign("notmaintainedroadsign"));
    initTabBlock(new BlockTrafficSign("signroadsplit"));
    initTabBlock(new BlockTrafficSign("signroughroad"));
    initTabBlock(new BlockTrafficSign("signroundabout"));
    initTabBlock(new BlockTrafficSign("signrunawaytruckramp"));
    initTabBlock(new BlockTrafficSign("rualintersectionsign"));
    initTabBlock(new BlockTrafficSign("ruralroadsign"));
    ...
    initTabBlock(new BlockTrafficSign("slowtruckssign"));
    ...
    initTabBlock(new BlockTrafficSign("truckturnaroundsign"));
    ...
    initTabBlock(new BlockTrafficSign("watchdownhillspeedsign"));
    ...
    initTabBlock(new BlockTrafficSign("campgroundcrossingsign"));
    ...
    initTabBlock(new BlockTrafficSign("hikersaheadsign"));
    initTabBlock(new BlockTrafficSign("signleftbikerightpark"));
    initTabBlock(new BlockTrafficSign("mivehiclessharecenterlanesign"));
    initTabBlock(new BlockTrafficSign("paytocrosssign"));
    initTabBlock(new BlockTrafficSign("signpedestrian"));
    initTabBlock(new BlockTrafficSign("signpedestrianflashingled"));
    ...
    // --- Temporary traffic control: orange work zone signs ---
    initTabBlock(new BlockTrafficSign("99onlypricesignold"));
    ...
    initTabBlock(new BlockTrafficSign("caltransduicheckpointaheadsign"));
    initTabBlock(new BlockTrafficSign("endlandworksign"));
    ...
    initTabBlock(new BlockTrafficSign("signrouteadvanceturnleft"));
    initTabBlock(new BlockTrafficSign("signrouteadvanceturnright"));
    initTabBlock(new BlockTrafficSign("signrouteadvanceturndiagonalleft"));
    initTabBlock(new BlockTrafficSign("signrouteadvanceturndiagonalright"));
    initTabBlock(new BlockTrafficSign("signroutearrowdiagonaltwoway"));
    initTabBlock(new BlockTrafficSign("signroutearrowaheadorright"));
    initTabBlock(new BlockTrafficSign("signroutearrowaheadorleft"));
    initTabBlock(new BlockTrafficSign("signroutearrowaheadordiagonalright"));
    initTabBlock(new BlockTrafficSign("signroutearrowaheadordiagonalleft"));
    initTabBlock(new BlockTrafficSign("signroutearrowaheadandright"));
    initTabBlock(new BlockTrafficSign("signroutearrowaheadandleft"));
    initTabBlock(new BlockTrafficSign("signroutearrowsplitleftright"));
    initTabBlock(new BlockTrafficSign("signjctinterstate"));
    initTabBlock(new BlockTrafficSign("signtempplaque"));
    initTabBlock(new BlockTrafficSign("signtointerstate"));
    ...
    initTabBlock(new BlockTrafficSign("signbikeroutediagonalright"));
    initTabBlock(new BlockTrafficSign("signbikerouteleftright"));
    initTabBlock(new BlockTrafficSign("signbikerouteaheadorright"));
    initTabBlock(new BlockTrafficSign("signbikerouteaheadordiagonalright"));
    ...
    initTabBlock(new BlockTrafficSign("pkwyentrancesign"));
    initTabBlock(new BlockTrafficSign("signpostca_pch"));
    initTabBlock(new BlockTrafficSign("respectuianatparkssign"));
    ...
    // --- Motorist services: blue: fuel, food, lodging, hospitals ---
    initTabBlock(new BlockTrafficSign("99onlypricesignnew"));
    initTabBlock(new BlockTrafficSign("altowelcomesyousign"));
    ...
    initTabBlock(new BlockTrafficSign("ladotsignalsync"));
    initTabBlock(new BlockTrafficSign("landareastudysign"));
    initTabBlock(new BlockTrafficSign("signlodging"));
    initTabBlock(new BlockTrafficSign("99onlypricesignnew2"));
    ...
    initTabBlock(new BlockTrafficSign("reportdrunkdriversign"));
    ...
    initTabBlock(new BlockTrafficSign("sheriffstation"));
    initTabBlock(new BlockTrafficSign("signsignalremovalstudy"));
    initTabBlock(new BlockTrafficSign("signphone"));
    initTabBlock(new BlockTrafficSign("uiawelcomesyousign"));

    // --- Recreational and cultural interest: brown ---
    ...
    initTabBlock(new BlockTrafficSign("altextremeheatdangersign"));
    ...
    initTabBlock(new BlockTrafficSign("hearbanjossign"));
    ...
    // --- Other and novelty signs: no MUTCD colour or shape to classify them by ---
    initTabBlock(new BlockTrafficSign("tolledbikelanesign"));
    initTabBlock(new BlockTrafficSign("steepedgesign"));
    initTabBlock(new BlockTrafficSign("signpostleftturnyieldgreen"));
    initTabBlock(new BlockTrafficSign("rightlanebussign"));
    initTabBlock(new BlockTrafficSign("signsharedpathway"));
    initTabBlock(new BlockTrafficSign("r1012uturn"));
