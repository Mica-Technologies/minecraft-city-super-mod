...
public class BlockTrafficPoleHorizontalSingleMountWhite extends AbstractBlockRotatableNSEWUD  implements
    ICsmRetiringBlock, ICsmNoSnowAccumulation {

  public BlockTrafficPoleHorizontalSingleMountWhite() {
  ...
  public String getBlockRegistryName() {
    return "trafficpolehorizontalsinglemountwhite";
  }
