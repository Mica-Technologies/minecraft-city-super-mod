...
/**
 * A legacy piece of the round concrete pole, from before the concrete poles joined the traffic pole
 * family. It retires into {@code trafficpoleverticalconcrete}, the one block that now draws the
 ...
 */
public class BlockRCPB extends AbstractBlockRotatableNSEWUD implements ICsmRetiringBlock {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.062500, 0.062500, 0.000000, 0.937500, 0.937500, 1.000000);
    }
  ...
  public String getReplacementBlockId() {
    return "trafficpoleverticalconcrete";
  }
}
