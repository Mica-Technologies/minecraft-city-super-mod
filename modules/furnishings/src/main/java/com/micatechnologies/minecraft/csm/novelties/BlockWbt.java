...
/**
 * Interactive water bubbler (tall variant) block. Right-clicking with a glass bottle fills it
...
public class BlockWbt extends AbstractBlockRotatableNSEWUD {
  ...
  public String getBlockRegistryName() {
    ...
    public AxisAlignedBB getBlockBoundingBox( IBlockState state, IBlockAccess source, BlockPos pos ) {
        return new AxisAlignedBB(0.000000, 0.000000, -0.062500, 1.000000, 1.000000, 1.000000);
    }
