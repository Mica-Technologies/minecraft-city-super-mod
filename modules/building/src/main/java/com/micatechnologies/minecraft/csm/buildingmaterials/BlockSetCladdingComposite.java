...
/**
 * Composite panel cladding: silver aluminium composite panels in stack bond with open reveal
 * joints, the storefront and office facade.
 *
 ...
 * @since 2026.9
 */
public class BlockSetCladdingComposite extends AbstractBlockSetBasic {

  /**
   * Constructs a {@link BlockSetCladdingComposite}.
   *
   * @since 1.0
   */
  public BlockSetCladdingComposite() {
    super(Material.IRON, SoundType.METAL, "pickaxe", 1, 3F, 10F, 0F, 255);
  }

  @Override
  public String getBlockRegistryName() {
    return "cladding_composite";
  }
