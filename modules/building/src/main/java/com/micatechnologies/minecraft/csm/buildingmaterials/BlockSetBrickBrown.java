...
/**
 * Brown brick: a darker, iron-rich clay fired longer, common on mid-century commercial and
 * apartment buildings.
 *
 ...
 * @since 2026.9
 */
public class BlockSetBrickBrown extends AbstractBlockSetBasic {

  /**
   * Constructs a {@link BlockSetBrickBrown}.
   *
   * @since 1.0
   */
  public BlockSetBrickBrown() {
