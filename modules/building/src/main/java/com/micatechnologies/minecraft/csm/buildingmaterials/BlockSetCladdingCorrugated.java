...
/**
 * Corrugated steel cladding: galvanized sheet with its ribs run plumb, the wall of every farm
 * shed, warehouse and site hoarding.
 *
 ...
 * @since 2026.9
 */
public class BlockSetCladdingCorrugated extends AbstractBlockSetBasic {

  /**
   * Constructs a {@link BlockSetCladdingCorrugated}.
   *
   * @since 1.0
   */
  public BlockSetCladdingCorrugated() {
    super(Material.IRON, SoundType.METAL, "pickaxe", 1, 3F, 10F, 0F, 255);
  }

  @Override
  public String getBlockRegistryName() {
    return "cladding_corrugated";
  }
