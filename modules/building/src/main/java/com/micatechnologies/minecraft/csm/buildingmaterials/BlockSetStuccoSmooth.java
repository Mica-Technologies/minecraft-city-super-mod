...
/**
 * Smooth stucco: a steel-troweled cement plaster coat, the flat, modern finish.
 *
 ...
 * @since 2026.9
 */
public class BlockSetStuccoSmooth extends AbstractBlockSetBasic {

  /**
   * Constructs a {@link BlockSetStuccoSmooth}.
   *
   * @since 1.0
   */
  public BlockSetStuccoSmooth() {
    super(Material.ROCK, SoundType.STONE, "pickaxe", 1, 2F, 10F, 0F, 255);
  }

  @Override
  public String getBlockRegistryName() {
    return "stucco_smooth";
  }
