...
/**
 * Oak hardwood: strip flooring on its top, the board edges on its sides.
 *
 * <p>A block, stairs, slab and fence set, for building a floor, a stair or a deck of it outright;
 * {@code floor_hardwood_oak} is the same boards as a one-pixel overlay on an existing floor. The
 * textures come from {@code dev-env-utils/scripts/gen_flooring.py}.</p>
 *
 * @version 1.0
 * @since 2026.9
 */
public class BlockSetHardwoodOak extends AbstractBlockSetBasic {

  /**
   * Constructs a {@link BlockSetHardwoodOak}.
   *
   * @since 1.0
   */
  public BlockSetHardwoodOak() {
