...
/**
 * Vinyl siding in a Dutch lap profile: the cove along the top of each course is what tells it
 * from lap siding at a distance.
 *
 ...
 * @since 2026.9
 */
public class BlockSetSidingVinyl extends AbstractBlockSetBasic {

  /**
   * Constructs a {@link BlockSetSidingVinyl}.
   *
   * @since 1.0
   */
  public BlockSetSidingVinyl() {
