...
/**
 * Knockdown stucco: splattered on and knocked flat with a trowel before it sets, leaving
 * raised flattened pads over a thinner coat.
 *
 ...
 * @since 2026.9
 */
public class BlockSetStuccoKnockdown extends AbstractBlockSetBasic {

  /**
   * Constructs a {@link BlockSetStuccoKnockdown}.
   *
   * @since 1.0
   */
  public BlockSetStuccoKnockdown() {
    super(Material.ROCK, SoundType.STONE, "pickaxe", 1, 2F, 10F, 0F, 255);
  }

  @Override
  public String getBlockRegistryName() {
    return "stucco_knockdown";
  }
