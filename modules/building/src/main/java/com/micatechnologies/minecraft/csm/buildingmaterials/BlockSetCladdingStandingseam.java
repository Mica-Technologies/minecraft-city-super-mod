...
/**
 * Standing seam cladding: charcoal steel pans between tall folded seams, the architectural
 * metal wall.
 *
 ...
 * @since 2026.9
 */
public class BlockSetCladdingStandingseam extends AbstractBlockSetBasic {

  /**
   * Constructs a {@link BlockSetCladdingStandingseam}.
   *
   * @since 1.0
   */
  public BlockSetCladdingStandingseam() {
    super(Material.IRON, SoundType.METAL, "pickaxe", 1, 3F, 10F, 0F, 255);
  }

  @Override
  public String getBlockRegistryName() {
    return "cladding_standingseam";
  }
