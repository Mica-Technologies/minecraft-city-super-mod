...
public class CsmTabPowerGrid extends CsmTab {
  ...
  public void initTabElements(FMLPreInitializationEvent fmlPreInitializationEvent) {
    ...
    initTabBlock(new BlockRotatableNSEWUDFactory.PoleFitted("scelightmount", Material.ROCK, SoundType.STONE, "pickaxe", 1, 1F, 10F, 0F, 0, new AxisAlignedBB(0.312500, 0.187500, -1.000000, 0.687500, 1.187500, 1.187500), false, true, false, BlockRenderLayer.SOLID, false, false));
    initTabBlock(new BlockRotatableNSEWUDFactory.PoleFitted("scelightmountsmall", Material.ROCK, SoundType.STONE, "pickaxe", 1, 1F, 10F, 0F, 0, new AxisAlignedBB(0.312500, 0.187500, 0.000000, 0.687500, 1.187500, 1.187500), false, true, false, BlockRenderLayer.SOLID, false, false));
