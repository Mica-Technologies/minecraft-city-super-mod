...
| Hornbeam Leaves | `csm:tree_leaves_hornbeam` | 0.2 | 1.0 |  | 0 |
| Hornbeam Log | `csm:tree_log_hornbeam_medium` | 2.0 | 5.0 | axe | 0 |
| Hornbeam Twig | `csm:tree_log_hornbeam_twig` | 2.0 | 5.0 | axe | 0 |
| Hydrangea | `csm:shrub_hydrangea` |  |  |  |  |
...
| Jacaranda Blossom | `csm:tree_leaves_jacaranda_blossom` | 0.2 | 1.0 |  | 0 |
| Jacaranda Leaves | `csm:tree_leaves_jacaranda` | 0.2 | 1.0 |  | 0 |
...
| Lombardy Poplar Leaves | `csm:tree_leaves_poplar` | 0.2 | 1.0 |  | 0 |
| Lombardy Poplar Log | `csm:tree_log_poplar_medium` | 2.0 | 5.0 | axe | 0 |
| Lombardy Poplar Twig | `csm:tree_log_poplar_twig` | 2.0 | 5.0 | axe | 0 |
...
| Pea Gravel | `csm:ground_pea_gravel` |  |  |  |  |
| Pepper Tree Leaves | `csm:tree_leaves_pepper` | 0.2 | 1.0 |  | 0 |
| Pepper Tree Log | `csm:tree_log_pepper_medium` | 2.0 | 5.0 | axe | 0 |
| Pepper Tree Twig | `csm:tree_log_pepper_twig` | 2.0 | 5.0 | axe | 0 |
...
| Raised Corten Steel Planting Bed | `csm:raised_bed_corten` |  |  |  |  |
| Red Flower Bed | `csm:flower_bed_red` |  |  |  |  |
| Round Tree Grate | `csm:tree_grate_round` |  |  |  |  |
